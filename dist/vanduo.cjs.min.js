...
`).length,o=document.createElement("div");o.className="vd-code-snippet-line-numbers",o.setAttribute("aria-hidden","true");for(let a=1;a<=s;a++){let r=document.createElement("span");r.textContent=a,o.appendChild(r)}let i=document.createElement("div");i.className="vd-code-snippet-code",i.appendChild(t.cloneNode(!0)),t.parentNode.removeChild(t),e.appendChild(o),e.appendChild(i)},expand:function(e){if(typeof e=="string"&&(e=document.querySelector(e)),!e)return;e.dataset.expanded="true";let t=e.querySelector(".vd-code-snippet-toggle"),n=e.querySelector(".vd-code-snippet-content");t&&t.setAttribute("aria-expanded","true"),n&&(n.dataset.visible="true")},collapse:function(e){if(typeof e=="string"&&(e=document.querySelector(e)),!e)return;e.dataset.expanded="false";let t=e.querySelector(".vd-code-snippet-toggle"),n=e.querySelector(".vd-code-snippet-content");t&&t.setAttribute("aria-expanded","false"),n&&(n.dataset.visible="false")},showLang:function(e,t){if(typeof e=="string"&&(e=document.querySelector(e)),!e)return;let n=e.querySelector(`.vd-code-snippet-tab[data-lang="${t}"]`),s=e.querySelectorAll(".vd-code-snippet-tab"),o=e.querySelectorAll(".vd-code-snippet-pane");n&&this.switchTab(e,n,s,o)},destroy:function(e){typeof e=="string"&&(e=document.querySelector(e)),e&&(e._codeSnippetCleanup&&(e._codeSnippetCleanup.forEach(t=>t()),delete e._codeSnippetCleanup),delete e.dataset.initialized)},destroyAll:function(){document.querySelectorAll('.vd-code-snippet[data-initialized="true"]').forEach(t=>this.destroy(t))}};typeof window.Vanduo<"u"&&window.Vanduo.register("codeSnippet",p),window.CodeSnippet=p})();(function(){"use strict";let p={instances:new Map,init:function(){document.querySelectorAll(".vd-collapsible, .accordion").forEach(t=>{this.instances.has(t)||this.initCollapsible(t)})},initCollapsible:function(e){let t=e.classList.contains("accordion"),n=e.querySelectorAll(".vd-collapsible-item, .accordion-item"),s=[];n.forEach(o=>{let i=o.querySelector(".vd-collapsible-header, .accordion-header"),a=o.querySelector(".vd-collapsible-body, .accordion-body"),r=o.querySelector(".vd-collapsible-trigger, .accordion-trigger")||i;if(!i||!a)return;o.classList.contains("is-open")?this.openItem(o,a,!1):this.closeItem(o,a,!1);let c=l=>{l.preventDefault(),this.toggleItem(o,a,e,t)};r.addEventListener("click",c),s.push(()=>r.removeEventListener("click",c))}),this.instances.set(e,{cleanup:s})},toggleItem:function(e,t,n,s){e.classList.contains("is-open")?this.closeItem(e,t):(s&&n.querySelectorAll(".vd-collapsible-item.is-open, .accordion-item.is-open").forEach(a=>{if(a!==e){let r=a.querySelector(".vd-collapsible-body, .accordion-body");this.closeItem(a,r)}}),this.openItem(e,t))},openItem:function(e,t,n=!0){n||(t.style.transition="none"),e.classList.add("is-open"),e.setAttribute("aria-expanded","true");let s=t.scrollHeight;t.style.maxHeight=`${s}px`,n||setTimeout(()=>{t.style.transition=""},0),e.dispatchEvent(new CustomEvent("collapsible:open",{bubbles:!0}))},closeItem:function(e,t,n=!0){n||(t.style.transition="none"),e.classList.remove("is-open"),e.setAttribute("aria-expanded","false"),t.style.maxHeight="0",n||setTimeout(()=>{t.style.transition=""},0),e.dispatchEvent(new CustomEvent("collapsible:close",{bubbles:!0}))},open:function(e){let t=typeof e=="string"?document.querySelector(e):e;if(t){let n=t.querySelector(".vd-collapsible-body, .accordion-body");n&&this.openItem(t,n)}},close:function(e){let t=typeof e=="string"?document.querySelector(e):e;if(t){let n=t.querySelector(".vd-collapsible-body, .accordion-body");n&&this.closeItem(t,n)}},toggle:function(e){let t=typeof e=="string"?document.querySelector(e):e;if(t){let n=t.querySelector(".vd-collapsible-body, .accordion-body"),s=t.closest(".vd-collapsible, .accordion"),o=s&&s.classList.contains("accordion");n&&this.toggleItem(t,n,s,o)}},destroy:function(e){let t=this.instances.get(e);t&&(t.cleanup.forEach(n=>n()),this.instances.delete(e))},destroyAll:function(){this.instances.forEach((e,t)=>{this.destroy(t)})}};typeof window.Vanduo<"u"&&window.Vanduo.register("collapsible",p),window.VanduoCollapsible=p})();(function(){"use strict";let p={instances:new Map,init:function(){document.querySelectorAll(".vd-dropdown").forEach(t=>{this.instances.has(t)||this.initDropdown(t)})},initDropdown:function(e){let t=e.querySelector(".vd-dropdown-toggle"),n=e.querySelector(".vd-dropdown-menu");if(!t||!n)return;let s=[];t.setAttribute("aria-haspopup","true"),t.setAttribute("aria-expanded","false"),n.setAttribute("role","menu"),n.setAttribute("aria-hidden","true");let o=c=>{c.preventDefault(),c.stopPropagation(),this.toggleDropdown(e,t,n)};t.addEventListener("click",o),s.push(()=>t.removeEventListener("click",o));let i=c=>{!e.contains(c.target)&&n.classList.contains("is-open")&&this.closeDropdown(e,t,n)};document.addEventListener("click",i),s.push(()=>document.removeEventListener("click",i));let a=c=>{this.handleKeydown(c,e,t,n)};t.addEventListener("keydown",a),s.push(()=>t.removeEventListener("keydown",a)),n.querySelectorAll(".vd-dropdown-item:not(.disabled):not(.is-disabled)").forEach(c=>{let l=f=>{f.preventDefault(),this.selectItem(c,e,t,n)};c.addEventListener("click",l),s.push(()=>c.removeEventListener("click",l));let h=f=>{(f.key==="Enter"||f.key===" ")&&(f.preventDefault(),this.selectItem(c,e,t,n))};c.addEventListener("keydown",h),s.push(()=>c.removeEventListener("keydown",h))}),this.instances.set(e,{toggle:t,menu:n,cleanup:s,typeaheadBuffer:"",typeaheadTimer:null})},toggleDropdown:function(e,t,n){n.classList.contains("is-open")?this.closeDropdown(e,t,n):this.openDropdown(e,t,n)},openDropdown:function(e,t,n){document.querySelectorAll(".vd-dropdown-menu.is-open").forEach(i=>{if(i!==n){let a=i.closest(".vd-dropdown"),r=a.querySelector(".vd-dropdown-toggle");this.closeDropdown(a,r,i)}}),e.classList.add("is-open"),n.classList.add("is-open"),t.setAttribute("aria-expanded","true"),n.setAttribute("aria-hidden","false"),this.positionMenu(e,n);let o=n.querySelector(".vd-dropdown-item:not(.disabled):not(.is-disabled)");o&&setTimeout(()=>o.focus(),0)},closeDropdown:function(e,t,n){e.classList.remove("is-open"),n.classList.remove("is-open"),t.setAttribute("aria-expanded","false"),n.setAttribute("aria-hidden","true"),t.focus()},positionMenu:function(e,t){let n=e.getBoundingClientRect(),s=t.getBoundingClientRect(),o=window.innerWidth,i=window.innerHeight,a=8;n.left+s.width>o-a&&(t.classList.add("vd-dropdown-menu-end"),t.classList.remove("vd-dropdown-menu-start")),t.classList.contains("dropdown-menu-top")?n.top-s.height<a&&t.classList.remove("vd-dropdown-menu-top"):n.bottom+s.height>i-a&&t.classList.add("vd-dropdown-menu-top")},handleKeydown:function(e,t,n,s){let o=s.classList.contains("is-open"),i=Array.from(s.querySelectorAll(".vd-dropdown-item:not(.disabled):not(.is-disabled)")),a=i.findIndex(r=>r===document.activeElement);switch(e.key){case"Enter":case" ":case"ArrowDown":if(e.preventDefault(),!o)this.openDropdown(t,n,s);else if(e.key==="ArrowDown"){let r=a<i.length-1?a+1:0;i[r].focus()}break;case"ArrowUp":if(o){e.preventDefault();let r=a>0?a-1:i.length-1;i[r].focus()}break;case"Escape":o&&(e.preventDefault(),this.closeDropdown(t,n,s));break;case"Home":o&&(e.preventDefault(),i[0].focus());break;case"End":o&&(e.preventDefault(),i[i.length-1].focus());break;default:if(o&&e.key.length===1&&!e.ctrlKey&&!e.metaKey&&!e.altKey){let r=this.instances.get(t);if(!r)break;clearTimeout(r.typeaheadTimer),r.typeaheadBuffer+=e.key.toLowerCase();let c=i.find(l=>l.textContent.trim().toLowerCase().startsWith(r.typeaheadBuffer));c&&c.focus(),r.typeaheadTimer=setTimeout(()=>{r.typeaheadBuffer=""},500)}break}},selectItem:function(e,t,n,s){s.querySelectorAll(".vd-dropdown-item").forEach(o=>{o.classList.remove("active","is-active")}),e.classList.add("active","is-active"),(n.tagName==="BUTTON"||n.classList.contains("btn"))&&(n.textContent=e.textContent.trim()),this.closeDropdown(t,n,s),e.dispatchEvent(new CustomEvent("dropdown:select",{bubbles:!0,detail:{item:e,value:e.dataset.value||e.textContent}}))},open:function(e){let t=typeof e=="string"?document.querySelector(e):e;if(t){let n=t.querySelector(".vd-dropdown-toggle"),s=t.querySelector(".vd-dropdown-menu");n&&s&&this.openDropdown(t,n,s)}},close:function(e){let t=typeof e=="string"?document.querySelector(e):e;if(t){let n=t.querySelector(".vd-dropdown-toggle"),s=t.querySelector(".vd-dropdown-menu");n&&s&&this.closeDropdown(t,n,s)}},destroy:function(e){let t=this.instances.get(e);t&&(t.cleanup.forEach(n=>n()),this.instances.delete(e))},destroyAll:function(){this.instances.forEach((e,t)=>{this.destroy(t)})}};typeof window.Vanduo<"u"&&window.Vanduo.register("dropdown",p),window.VanduoDropdown=p})();(function(){"use strict";let p={STORAGE_KEY:"vanduo-font-preference",isInitialized:!1,fonts:{system:{name:"System Default",family:null},inter:{name:"Inter",family:"'Inter', sans-serif"},"source-sans":{name:"Source Sans 3",family:"'Source Sans 3', sans-serif"},"fira-sans":{name:"Fira Sans",family:"'Fira Sans', sans-serif"},"ibm-plex":{name:"IBM Plex Sans",family:"'IBM Plex Sans', sans-serif"},"jetbrains-mono":{name:"JetBrains Mono",family:"'JetBrains Mono', monospace"},ubuntu:{name:"Ubuntu",family:"'Ubuntu', sans-serif",category:"sans-serif",description:"Friendly, humanist sans-serif"},"open-sans":{name:"Open Sans",family:"'Open Sans', sans-serif",category:"sans-serif",description:"Neutral, highly readable"},rubik:{name:"Rubik",family:"'Rubik', sans-serif",category:"sans-serif",description:"Modern, geometric"},"titillium-web":{name:"Titillium Web",family:"'Titillium Web', sans-serif",category:"sans-serif",description:"Technical, elegant"}},init:function(){if(this.state={preference:this.getPreference()},this.isInitialized){this.applyFont(),this.renderUI(),this.updateUI();return}this.isInitialized=!0,this.applyFont(),this.renderUI(),console.log("Vanduo Font Switcher initialized")},getPreference:function(){return this.getStorageValue(this.STORAGE_KEY,"ubuntu")},setPreference:function(e){if(!this.fonts[e]){console.warn("Unknown font:",e);return}this.state.preference=e,this.setStorageValue(this.STORAGE_KEY,e),this.applyFont(),this.updateUI();let t=new CustomEvent("font:change",{bubbles:!0,detail:{font:e,fontData:this.fonts[e]}});document.dispatchEvent(t)},applyFont:function(){let e=this.state.preference;e==="system"?document.documentElement.removeAttribute("data-font"):document.documentElement.setAttribute("data-font",e)},renderUI:function(){document.querySelectorAll('[data-toggle="font"]').forEach(t=>{if(t.getAttribute("data-font-initialized")==="true"){t.tagName==="SELECT"&&(t.value=this.state.preference);return}if(t.tagName==="SELECT"){t.value=this.state.preference;let n=s=>{this.setPreference(s.target.value)};t.addEventListener("change",n),t._fontToggleHandler=n}else{let n=()=>{let s=Object.keys(this.fonts),i=(s.indexOf(this.state.preference)+1)%s.length;this.setPreference(s[i])};t.addEventListener("click",n),t._fontToggleHandler=n}t.setAttribute("data-font-initialized","true")})},updateUI:function(){document.querySelectorAll('[data-toggle="font"]').forEach(t=>{if(t.tagName==="SELECT")t.value=this.state.preference;else{let n=t.querySelector(".font-current-label");n&&(n.textContent=this.fonts[this.state.preference].name)}})},getCurrentFont:function(){return this.state.preference},getFontData:function(e){return this.fonts[e]||null},destroyAll:function(){document.querySelectorAll('[data-toggle="font"][data-font-initialized="true"]').forEach(t=>{if(t._fontToggleHandler){let n=t.tagName==="SELECT"?"change":"click";t.removeEventListener(n,t._fontToggleHandler),delete t._fontToggleHandler}t.removeAttribute("data-font-initialized")}),this.isInitialized=!1},getStorageValue:function(e,t){if(typeof window.safeStorageGet=="function")return window.safeStorageGet(e,t);try{let n=localStorage.getItem(e);return n!==null?n:t}catch{return t}},setStorageValue:function(e,t){if(typeof window.safeStorageSet=="function")return window.safeStorageSet(e,t);try{return localStorage.setItem(e,t),!0}catch{return!1}}};window.Vanduo&&window.Vanduo.register("fontSwitcher",p),window.FontSwitcher=p})();(function(){"use strict";let p=(function(){try{return CSS.supports("selector(:has(*))")}catch{return!1}})(),e={instances:new Map,init:function(){document.querySelectorAll("[data-layout-mode]").forEach(function(n){this.instances.has(n)||this.initContainer(n)}.bind(this)),this.initToggleButtons()},initContainer:function(t){let n=t.getAttribute("data-layout-mode")||"standard",s=[];this.applyMode(t,n),t.setAttribute("role","region"),t.setAttribute("aria-label","Grid layout: "+n+" mode"),this.instances.set(t,{cleanup:s,mode:n})},initToggleButtons:function(){document.querySelectorAll("[data-grid-toggle]").forEach(function(n){if(n.getAttribute("data-grid-initialized")==="true")return;let s=function(o){o.preventDefault();let i=n.getAttribute("data-grid-toggle"),a;i?a=document.querySelector(i):a=n.closest("[data-layout-mode]"),a&&this.toggle(a)}.bind(this);n.addEventListener("click",s),n.setAttribute("data-grid-initialized","true"),n.setAttribute("aria-pressed","false"),n._gridCleanup=function(){n.removeEventListener("click",s),n.removeAttribute("data-grid-initialized"),n.removeAttribute("aria-pressed")}}.bind(this))},applyFibFallback:function(t){if(p)return;t.querySelectorAll(".vd-row, .row").forEach(function(s){let i=s.querySelectorAll(':scope > [class*="vd-col-"], :scope > [class*="col-"]').length;i===1?s.style.gridTemplateColumns="1fr":i===2?s.style.gridTemplateColumns="1fr 1.618fr":i===3?s.style.gridTemplateColumns="2fr 3fr 5fr":i===4?s.style.gridTemplateColumns="1fr 2fr 3fr 5fr":s.style.gridTemplateColumns="repeat("+i+", 1fr)"})},removeFibFallback:function(t){t.querySelectorAll(".vd-row, .row").forEach(function(s){s.style.gridTemplateColumns=""})},applyMode:function(t,n){t.classList.remove("vd-grid-standard","vd-grid-fibonacci"),n==="fibonacci"?(t.classList.add("vd-grid-fibonacci"),this.applyFibFallback(t)):(t.classList.add("vd-grid-standard"),this.removeFibFallback(t)),t.setAttribute("data-layout-mode",n),t.setAttribute("aria-label","Grid layout: "+n+" mode"),document.querySelectorAll("[data-grid-toggle]").forEach(function(a){let r=a.getAttribute("data-grid-toggle");if(r&&t.matches(r)){let c=n==="fibonacci";c?a.classList.add("is-active"):a.classList.remove("is-active"),a.setAttribute("aria-pressed",c?"true":"false")}});let o=this.instances.get(t);o&&(o.mode=n);let i;try{i=new CustomEvent("grid:modechange",{bubbles:!0,detail:{container:t,mode:n}})}catch{i=document.createEvent("CustomEvent"),i.initCustomEvent("grid:modechange",!0,!0,{container:t,mode:n})}t.dispatchEvent(i)},toggle:function(t){if(typeof t=="string"&&(t=document.querySelector(t)),!t)return;let s=(t.getAttribute("data-layout-mode")||"standard")==="fibonacci"?"standard":"fibonacci";this.applyMode(t,s)},setMode:function(t,n){typeof t=="string"&&(t=document.querySelector(t)),t&&(n!=="fibonacci"&&n!=="standard"||this.applyMode(t,n))},getMode:function(t){return typeof t=="string"&&(t=document.querySelector(t)),t?t.getAttribute("data-layout-mode")||"standard":null},destroy:function(t){let n=this.instances.get(t);n&&(n.cleanup.forEach(function(s){s()}),t.classList.remove("vd-grid-standard","vd-grid-fibonacci"),t.removeAttribute("aria-label"),this.removeFibFallback(t),this.instances.delete(t))},destroyAll:function(){this.instances.forEach(function(n,s){this.destroy(s)}.bind(this)),document.querySelectorAll('[data-grid-initialized="true"]').forEach(function(n){n._gridCleanup&&(n._gridCleanup(),delete n._gridCleanup)})}};typeof window.Vanduo<"u"&&window.Vanduo.register("gridLayout",e),window.VanduoGridLayout=e})();(function(){"use strict";let p={backdrop:null,container:null,img:null,closeBtn:null,caption:null,currentTrigger:null,scrollThreshold:50,initialScrollY:0,isOpen:!1,_cleanupFunctions:[],init:function(){this.createBackdrop(),this.bindTriggers()},createBackdrop:function(){if(this.backdrop||document.querySelector(".vd-image-box-backdrop")){this.backdrop||(this.backdrop=document.querySelector(".vd-image-box-backdrop"),this.container=this.backdrop.querySelector(".vd-image-box-container"),this.img=this.backdrop.querySelector(".vd-image-box-img"),this.closeBtn=this.backdrop.querySelector(".vd-image-box-close"),this.caption=this.backdrop.querySelector(".vd-image-box-caption"),this.bindBackdropEvents());return}this.backdrop=document.createElement("div"),this.backdrop.className="vd-image-box-backdrop",this.backdrop.setAttribute("role","dialog"),this.backdrop.setAttribute("aria-modal","true"),this.backdrop.setAttribute("aria-label","Image viewer"),this.backdrop.setAttribute("tabindex","-1"),this.container=document.createElement("div"),this.container.className="vd-image-box-container",this.img=document.createElement("img"),this.img.className="vd-image-box-img",this.img.alt="",this.closeBtn=document.createElement("button"),this.closeBtn.className="vd-image-box-close",this.closeBtn.setAttribute("aria-label","Close image viewer"),this.closeBtn.innerHTML="&times;",this.caption=document.createElement("div"),this.caption.className="vd-image-box-caption",this.container.appendChild(this.img),this.backdrop.appendChild(this.closeBtn),this.backdrop.appendChild(this.container),this.backdrop.appendChild(this.caption),document.body.appendChild(this.backdrop),this.bindBackdropEvents()},bindBackdropEvents:function(){let e=this,t=function(a){(a.target===e.backdrop||a.target===e.container)&&e.close()};this.backdrop.addEventListener("click",t),this._cleanupFunctions.push(()=>this.backdrop.removeEventListener("click",t));let n=function(){e.close()};this.img.addEventListener("click",n),this._cleanupFunctions.push(()=>this.img.removeEventListener("click",n));let s=function(){e.close()};this.closeBtn.addEventListener("click",s),this._cleanupFunctions.push(()=>this.closeBtn.removeEventListener("click",s));let o=function(a){a.key==="Escape"&&e.isOpen&&e.close()};document.addEventListener("keydown",o),this._cleanupFunctions.push(()=>document.removeEventListener("keydown",o));let i=function(){if(!e.isOpen)return;let a=window.scrollY;Math.abs(a-e.initialScrollY)>e.scrollThreshold&&e.close()};window.addEventListener("scroll",i,{passive:!0}),this._cleanupFunctions.push(()=>window.removeEventListener("scroll",i))},bindTriggers:function(){let e=this;document.querySelectorAll("[data-image-box]").forEach(function(n){if(n.dataset.imageBoxInitialized)return;if(n.dataset.imageBoxInitialized="true",n.classList.add("vd-image-box-trigger"),n.tagName==="IMG"){n.complete&&n.naturalWidth===0&&n.classList.add("is-broken");let o=function(){n.classList.add("is-broken")};n.addEventListener("error",o);let i=function(){n.classList.remove("is-broken")};n.addEventListener("load",i)}let s=function(o){o.preventDefault(),e.open(n)};if(n.addEventListener("click",s),n._imageBoxCleanup=()=>n.removeEventListener("click",s),n.tagName!=="BUTTON"&&n.tagName!=="A"){n.setAttribute("role","button"),n.setAttribute("tabindex","0"),n.setAttribute("aria-label","View enlarged image");let o=function(a){(a.key==="Enter"||a.key===" ")&&(a.preventDefault(),e.open(n))};n.addEventListener("keydown",o);let i=n._imageBoxCleanup;n._imageBoxCleanup=()=>{i(),n.removeEventListener("keydown",o)}}})},open:function(e){if(this.isOpen)return;this.currentTrigger=e,this.isOpen=!0,this.initialScrollY=window.scrollY;let t=e.dataset.imageBoxFullSrc||e.dataset.imageBoxSrc||e.src||e.href;if(!t){console.warn("[Vanduo ImageBox] No image source found for trigger:",e);return}let n=e.dataset.imageBoxCaption||e.alt||"";this.img.src=t,this.img.alt=e.alt||"",n?(this.caption.textContent=n,this.caption.style.display="block"):this.caption.style.display="none";let s=window.innerWidth-document.documentElement.clientWidth;document.body.style.setProperty("--scrollbar-width",`${s}px`),document.body.classList.add("body-image-box-open"),this.backdrop.classList.add("is-visible"),this.backdrop.focus(),e.dispatchEvent(new CustomEvent("imageBox:open",{bubbles:!0,detail:{src:t}})),this.img.complete||(this.img.style.opacity="0",this._imgLoadHandler=()=>{this.img.style.opacity=""},this.img.addEventListener("load",this._imgLoadHandler,{once:!0}))},close:function(){this.isOpen&&(this.isOpen=!1,this.backdrop.classList.remove("is-visible"),document.body.classList.remove("body-image-box-open"),document.body.style.removeProperty("--scrollbar-width"),this.currentTrigger&&(this.currentTrigger.focus(),this.currentTrigger.dispatchEvent(new CustomEvent("imageBox:close",{bubbles:!0})),this.currentTrigger=null),setTimeout(()=>{this.isOpen||(this._imgLoadHandler&&(this.img.removeEventListener("load",this._imgLoadHandler),this._imgLoadHandler=null),this.img.src="",this.img.alt="")},300))},reinit:function(){this.bindTriggers()},destroy:function(){this.isOpen&&this.close(),this.backdrop&&this.backdrop.parentNode&&this.backdrop.parentNode.removeChild(this.backdrop),this._cleanupFunctions.forEach(t=>t()),this._cleanupFunctions=[],document.querySelectorAll("[data-image-box-initialized]").forEach(t=>{t.classList.remove("vd-image-box-trigger"),t._imageBoxCleanup&&(t._imageBoxCleanup(),delete t._imageBoxCleanup),delete t.dataset.imageBoxInitialized}),this.backdrop=null,this.container=null,this.img=null,this.closeBtn=null,this.caption=null,this.currentTrigger=null,this.isOpen=!1},destroyAll:function(){this.destroy()}};typeof window.Vanduo<"u"&&window.Vanduo.register("imageBox",p),window.VanduoImageBox=p})();(function(){"use strict";let p={modals:new Map,openModals:[],zIndexCounter:1050,_triggerCleanups:[],_sharedEscHandler:null,init:function(){document.querySelectorAll(".vd-modal").forEach(n=>{this.modals.has(n)||this.initModal(n)}),document.querySelectorAll("[data-modal]").forEach(n=>{if(n.dataset.modalTriggerInitialized)return;n.dataset.modalTriggerInitialized="true";let s=o=>{o.preventDefault();let i=n.dataset.modal,a=document.querySelector(i);a&&this.open(a)};n.addEventListener("click",s),this._triggerCleanups.push(()=>n.removeEventListener("click",s))})},initModal:function(e){let t=this.createBackdrop(e),n=e.querySelectorAll('.vd-modal-close, [data-dismiss="modal"]'),s=e.querySelector(".vd-modal-dialog");if(!s)return;let o=[];e.setAttribute("role","dialog"),e.setAttribute("aria-modal","true"),e.setAttribute("aria-hidden","true"),e.id||(e.id="modal-"+Math.random().toString(36).substr(2,9));let i=e.querySelector(".vd-modal-title");i&&!i.id&&(i.id=e.id+"-title",e.setAttribute("aria-labelledby",i.id)),n.forEach(r=>{let c=()=>{this.close(e)};r.addEventListener("click",c),o.push(()=>r.removeEventListener("click",c))});let a=r=>{r.target===t&&e.dataset.backdrop!=="static"&&this.close(e)};t.addEventListener("click",a),o.push(()=>t.removeEventListener("click",a)),this._sharedEscHandler||(this._sharedEscHandler=r=>{if(r.key==="Escape"&&this.openModals.length>0){let c=this.openModals[this.openModals.length-1];c.dataset.keyboard!=="false"&&this.close(c)}},document.addEventListener("keydown",this._sharedEscHandler)),this.modals.set(e,{backdrop:t,dialog:s,trapHandler:null,cleanup:o})},createBackdrop:function(e){let t=e.querySelector(".vd-modal-backdrop");return t||(t=document.createElement("div"),t.className="vd-modal-backdrop",document.body.appendChild(t)),t},open:function(e){let t=typeof e=="string"?document.querySelector(e):e;if(!t){console.warn("[Vanduo Modals] Modal element not found:",e);return}if(!this.modals.has(t)){console.warn("[Vanduo Modals] Modal not initialized:",t);return}let n=this.modals.get(t),{backdrop:s,dialog:o}=n;if(this.zIndexCounter+=10,t.style.zIndex=this.zIndexCounter,s.style.zIndex=this.zIndexCounter-1,this.openModals.push(t),s.classList.add("is-visible"),t.classList.add("is-open"),t.setAttribute("aria-hidden","false"),this.openModals.length===1){document.body.classList.add("body-modal-open");let a=window.innerWidth-document.documentElement.clientWidth;a>0&&(document.body.style.paddingRight=`${a}px`)}let i=this.trapFocus(t);n.trapHandler=i,setTimeout(()=>{let a=this.getFocusableElements(t)[0];a&&a.focus()},100),t.dispatchEvent(new CustomEvent("modal:open",{bubbles:!0}))},close:function(e){let t=typeof e=="string"?document.querySelector(e):e;if(!t){console.warn("[Vanduo Modals] Modal element not found:",e);return}if(!this.modals.has(t)){console.warn("[Vanduo Modals] Modal not initialized:",t);return}let n=this.modals.get(t),{backdrop:s,trapHandler:o}=n;o&&(t.removeEventListener("keydown",o),n.trapHandler=null);let i=this.openModals.indexOf(t);if(i>-1&&this.openModals.splice(i,1),t.classList.remove("is-open"),t.setAttribute("aria-hidden","true"),this.openModals.length===0)s.classList.remove("is-visible"),document.body.classList.remove("body-modal-open"),document.body.style.paddingRight="",this.zIndexCounter=1050;else{let r=this.openModals[this.openModals.length-1];this.modals.get(r).backdrop.classList.add("is-visible")}let a=document.querySelector(`[data-modal="#${t.id}"]`);a&&a.focus(),t.dispatchEvent(new CustomEvent("modal:close",{bubbles:!0}))},trapFocus:function(e){let t=this,n=function(s){if(s.key!=="Tab")return;let o=t.getFocusableElements(e),i=o[0],a=o[o.length-1];s.shiftKey?document.activeElement===i&&(s.preventDefault(),a.focus()):document.activeElement===a&&(s.preventDefault(),i.focus())};return e.addEventListener("keydown",n),n},getFocusableElements:function(e){return Array.from(e.querySelectorAll('a[href], button:not([disabled]), textarea:not([disabled]), input:not([disabled]), select:not([disabled]), [tabindex]:not([tabindex="-1"])')).filter(n=>!n.hasAttribute("disabled")&&n.offsetWidth>0&&n.offsetHeight>0)},toggle:function(e){let t=typeof e=="string"?document.querySelector(e):e;t&&(t.classList.contains("is-open")?this.close(t):this.open(t))},destroy:function(e){let t=this.modals.get(e);t&&(e.classList.contains("is-open")&&this.close(e),t.cleanup&&t.cleanup.forEach(n=>n()),t.backdrop&&t.backdrop.parentNode&&t.backdrop.parentNode.removeChild(t.backdrop),this.modals.delete(e))},destroyAll:function(){this.modals.forEach((e,t)=>{this.destroy(t)}),this._triggerCleanups.forEach(e=>e()),this._triggerCleanups=[],this._sharedEscHandler&&(document.removeEventListener("keydown",this._sharedEscHandler),this._sharedEscHandler=null)}};typeof window.Vanduo<"u"&&window.Vanduo.register("modals",p),window.VanduoModals=p})();(function(){"use strict";let p={instances:new Map,getBreakpoint:function(){let t=getComputedStyle(document.documentElement).getPropertyValue("--breakpoint-lg").trim(),n=parseInt(t,10);return isNaN(n)?992:n},init:function(){document.querySelectorAll(".vd-navbar").forEach(t=>{this.instances.has(t)||this.initNavbar(t)})},initScrollWatcher:function(e){let t=e.classList.contains("vd-navbar-glass"),n=e.classList.contains("vd-navbar-transparent");if(!t&&!n)return null;let s=()=>{let i=parseInt(e.dataset.scrollThreshold,10);return isNaN(i)?e.offsetHeight||60:i},o=()=>{let i=window.scrollY>s();e.classList.toggle("vd-navbar-scrolled",i)};return o(),window.addEventListener("scroll",o,{passive:!0}),()=>window.removeEventListener("scroll",o)},initNavbar:function(e){let t=e.querySelector(".vd-navbar-toggle, .vd-navbar-burger"),n=e.querySelector(".vd-navbar-menu"),s=e.querySelector(".vd-navbar-overlay")||this.createOverlay(e),o=[],i=this.initScrollWatcher(e);if(i&&o.push(i),!t||!n){o.length&&this.instances.set(e,{toggle:null,menu:null,overlay:null,cleanup:o});return}let a=d=>{d.preventDefault(),d.stopPropagation(),this.toggleMenu(e,t,n,s)};if(t.addEventListener("click",a),o.push(()=>t.removeEventListener("click",a)),s){let d=()=>{this.closeMenu(e,t,n,s)};s.addEventListener("click",d),o.push(()=>s.removeEventListener("click",d))}let r=d=>{d.key==="Escape"&&n.classList.contains("is-open")&&this.closeMenu(e,t,n,s)};document.addEventListener("keydown",r),o.push(()=>document.removeEventListener("keydown",r));let c,l=()=>{clearTimeout(c),c=setTimeout(()=>{let d=this.getBreakpoint();window.innerWidth>=d&&n.classList.contains("is-open")&&this.closeMenu(e,t,n,s)},250)};window.addEventListener("resize",l),o.push(()=>{clearTimeout(c),window.removeEventListener("resize",l)});let h=d=>{n.classList.contains("is-open")&&!e.contains(d.target)&&!n.contains(d.target)&&this.closeMenu(e,t,n,s)};document.addEventListener("click",h),o.push(()=>document.removeEventListener("click",h)),n.querySelectorAll(".vd-navbar-dropdown > .vd-nav-link, .vd-navbar-dropdown > .nav-link").forEach(d=>{let u=m=>{let y=this.getBreakpoint();if(window.innerWidth<y){m.preventDefault();let S=d.parentElement.querySelector(".vd-navbar-dropdown-menu");S&&S.classList.toggle("is-open")}};d.addEventListener("click",u),o.push(()=>d.removeEventListener("click",u))}),this.instances.set(e,{toggle:t,menu:n,overlay:s,cleanup:o})},destroy:function(e){let t=this.instances.get(e);t&&(t.cleanup.forEach(n=>n()),t.overlay&&t.overlay.parentNode&&t.overlay.parentNode.removeChild(t.overlay),this.instances.delete(e))},destroyAll:function(){this.instances.forEach((e,t)=>{this.destroy(t)})},toggleMenu:function(e,t,n,s){n.classList.contains("is-open")?this.closeMenu(e,t,n,s):this.openMenu(e,t,n,s)},openMenu:function(e,t,n,s){n.classList.add("is-open"),t.classList.add("is-active"),s&&s.classList.add("is-active"),document.body.classList.add("body-navbar-open"),t.setAttribute("aria-expanded","true"),n.setAttribute("aria-hidden","false")},closeMenu:function(e,t,n,s){n.classList.remove("is-open"),t.classList.remove("is-active"),s&&s.classList.remove("is-active"),document.body.classList.remove("body-navbar-open"),n.querySelectorAll(".vd-navbar-dropdown-menu.is-open").forEach(i=>{i.classList.remove("is-open")}),t.setAttribute("aria-expanded","false"),n.setAttribute("aria-hidden","true")},createOverlay:function(e){let t=document.createElement("div");return t.className="vd-navbar-overlay",document.body.appendChild(t),t}};typeof window.Vanduo<"u"&&window.Vanduo.register("navbar",p),window.VanduoNavbar=p})();(function(){"use strict";let p={instances:new Map,init:function(){document.querySelectorAll(".vd-pagination[data-pagination]").forEach(t=>{this.instances.has(t)||this.initPagination(t)})},initPagination:function(e){let t=parseInt(e.dataset.totalPages)||1,n=parseInt(e.dataset.currentPage)||1,s=parseInt(e.dataset.maxVisible)||7;this.render(e,{totalPages:t,currentPage:n,maxVisible:s});let o=i=>{let a=i.target.closest(".vd-pagination-link");if(!a||a.closest(".vd-pagination-item.disabled")||a.closest(".vd-pagination-item.active"))return;i.preventDefault();let r=a.closest(".vd-pagination-item"),c=r.dataset.page;c?this.goToPage(e,parseInt(c)):r.classList.contains("pagination-prev")?this.prevPage(e):r.classList.contains("pagination-next")&&this.nextPage(e)};e.addEventListener("click",o),this.instances.set(e,{cleanup:[()=>e.removeEventListener("click",o)]})},render:function(e,t){let{totalPages:n,currentPage:s,maxVisible:o}=t;if(n<=1){e.innerHTML="";return}let i="";i+=`<li class="vd-pagination-item vd-pagination-prev pagination-item pagination-prev ${s===1?"disabled":""}">`,i+='<a class="vd-pagination-link pagination-link" href="#" aria-label="Previous">Previous</a>',i+="</li>";let a=this.calculatePages(s,n,o),r=0;a.forEach(c=>{if(c==="ellipsis")i+='<li class="vd-pagination-item pagination-item"><span class="vd-pagination-ellipsis pagination-ellipsis">\u2026</span></li>';else{c!==r+1&&r>0&&(i+='<li class="vd-pagination-item pagination-item"><span class="vd-pagination-ellipsis pagination-ellipsis">\u2026</span></li>');let l=Number(c);i+=`<li class="vd-pagination-item pagination-item ${l===s?"active":""}" data-page="${l}">`,i+=`<a class="vd-pagination-link pagination-link" href="#" aria-label="Page ${l}">${l}</a>`,i+="</li>",r=c}}),i+=`<li class="vd-pagination-item vd-pagination-next pagination-item pagination-next ${s===n?"disabled":""}">`,i+='<a class="vd-pagination-link pagination-link" href="#" aria-label="Next">Next</a>',i+="</li>",e.innerHTML=i,e.dataset.currentPage=s},calculatePages:function(e,t,n){let s=[],o=Math.floor(n/2);if(t<=n)for(let i=1;i<=t;i++)s.push(i);else{s.push(1);let i=Math.max(2,e-o),a=Math.min(t-1,e+o);e<=o+1&&(a=Math.min(t-1,n-1)),e>=t-o&&(i=Math.max(2,t-n+2)),i>2&&s.push("ellipsis");for(let r=i;r<=a;r++)s.push(r);a<t-1&&s.push("ellipsis"),t>1&&s.push(t)}return s},goToPage:function(e,t){let n=parseInt(e.dataset.totalPages)||1,s=parseInt(e.dataset.maxVisible)||7;t<1||t>n||(this.render(e,{totalPages:n,currentPage:t,maxVisible:s}),e.dispatchEvent(new CustomEvent("pagination:change",{bubbles:!0,detail:{page:t,totalPages:n}})))},prevPage:function(e){let t=parseInt(e.dataset.currentPage)||1;t>1&&this.goToPage(e,t-1)},nextPage:function(e){let t=parseInt(e.dataset.currentPage)||1,n=parseInt(e.dataset.totalPages)||1;t<n&&this.goToPage(e,t+1)},update:function(e,t){let n=typeof e=="string"?document.querySelector(e):e;n&&(t.totalPages!==void 0&&(n.dataset.totalPages=t.totalPages),t.currentPage!==void 0&&(n.dataset.currentPage=t.currentPage),t.maxVisible!==void 0&&(n.dataset.maxVisible=t.maxVisible),this.render(n,{totalPages:parseInt(n.dataset.totalPages)||1,currentPage:parseInt(n.dataset.currentPage)||1,maxVisible:parseInt(n.dataset.maxVisible)||7}))},destroy:function(e){let t=this.instances.get(e);t&&(t.cleanup.forEach(n=>n()),this.instances.delete(e))},destroyAll:function(){this.instances.forEach((e,t)=>{this.destroy(t)})}};typeof window.Vanduo<"u"&&window.Vanduo.register("pagination",p),window.VanduoPagination=p})();(function(){"use strict";let p={parallaxElements:new Map,ticking:!1,isMobile:window.innerWidth<768,reducedMotion:window.matchMedia("(prefers-reduced-motion: reduce)").matches,isInitialized:!1,_onScroll:null,_onResize:null,init:function(){if(this.isInitialized){this.refresh();return}if(this.isInitialized=!0,this.reducedMotion)return;document.querySelectorAll(".vd-parallax").forEach(t=>{t.dataset.parallaxInitialized||this.initParallax(t)}),this.handleScroll(),this._onScroll=()=>{this.handleScroll()},window.addEventListener("scroll",this._onScroll,{passive:!0}),this._onResize=()=>{this.isMobile=window.innerWidth<768,this.updateAll()},window.addEventListener("resize",this._onResize)},initParallax:function(e){e.dataset.parallaxInitialized="true";let t=e.classList.contains("parallax-disable-mobile");if(t&&this.isMobile)return;let n=e.querySelectorAll(".vd-parallax-layer, .vd-parallax-bg"),s=this.getSpeed(e),o=e.classList.contains("parallax-horizontal")?"horizontal":"vertical";this.parallaxElements.set(e,{layers:Array.from(n),speed:s,direction:o,disableMobile:t}),this.updateParallax(e)},getSpeed:function(e){return e.classList.contains("parallax-slow")?.5:e.classList.contains("parallax-fast")?1.5:1},handleScroll:function(){this.ticking||(window.requestAnimationFrame(()=>{this.updateAll(),this.ticking=!1}),this.ticking=!0)},updateAll:function(){this.parallaxElements.forEach((e,t)=>{e.disableMobile&&this.isMobile||this.updateParallax(t)})},updateParallax:function(e){let t=this.parallaxElements.get(e);if(!t)return;let n=e.getBoundingClientRect(),s=window.innerHeight,o=n.top,i=n.height,r=(Math.max(0,Math.min(1,(s-o)/(s+i)))-.5)*t.speed*100;t.layers.forEach((c,l)=>{let h=c.dataset.parallaxSpeed?parseFloat(c.dataset.parallaxSpeed):1,f=r*h;t.direction==="horizontal"?c.style.transform=`translateX(${f}px)`:c.style.transform=`translateY(${f}px)`})},destroy:function(e){let t=typeof e=="string"?document.querySelector(e):e;t&&this.parallaxElements.has(t)&&(this.parallaxElements.get(t).layers.forEach(s=>{s.style.transform=""}),this.parallaxElements.delete(t))},refresh:function(){this.updateAll()},destroyAll:function(){this.parallaxElements.forEach((e,t)=>{this.destroy(t)}),this.parallaxElements.clear(),this._onScroll&&(window.removeEventListener("scroll",this._onScroll),this._onScroll=null),this._onResize&&(window.removeEventListener("resize",this._onResize),this._onResize=null),this.isInitialized=!1}};typeof window.Vanduo<"u"&&window.Vanduo.register("parallax",p),window.VanduoParallax=p})();(function(){"use strict";let p={init:function(){document.querySelectorAll(".progress-bar[data-progress]").forEach(t=>{t.dataset.progressInitialized||this.initProgressBar(t)})},initProgressBar:function(e){e.dataset.progressInitialized="true";let t=parseInt(e.dataset.progress)||0;this.setProgress(e,t,!1)},setProgress:function(e,t,n=!0){let s=typeof e=="string"?document.querySelector(e):e;if(!s)return;t=Math.max(0,Math.min(100,t)),n?s.style.transition="width var(--transition-duration-slow) var(--transition-ease)":(s.style.transition="none",setTimeout(()=>{s.style.transition=""},0)),s.style.width=t+"%",s.setAttribute("aria-valuenow",t),s.setAttribute("aria-valuemin",0),s.setAttribute("aria-valuemax",100);let o=s.querySelector(".progress-text");o&&(o.textContent=t+"%"),s.dispatchEvent(new CustomEvent("progress:update",{bubbles:!0,detail:{value:t,max:100}})),t>=100&&s.dispatchEvent(new CustomEvent("progress:complete",{bubbles:!0,detail:{value:t,max:100}}))},animateProgress:function(e,t,n=1e3){let s=typeof e=="string"?document.querySelector(e):e;if(!s)return;let o=parseInt(s.style.width)||0,i=t-o,a=performance.now(),r=c=>{let l=c-a,h=Math.min(l/n,1),f=1-Math.pow(1-h,3),d=o+i*f;this.setProgress(s,d,!1),h<1&&requestAnimationFrame(r)};requestAnimationFrame(r)},show:function(e){let t=typeof e=="string"?document.querySelector(e):e;t&&(t.style.display="inline-block",t.setAttribute("aria-hidden","false"))},hide:function(e){let t=typeof e=="string"?document.querySelector(e):e;t&&(t.style.display="none",t.setAttribute("aria-hidden","true"))},toggle:function(e){let t=typeof e=="string"?document.querySelector(e):e;t&&(t.style.display==="none"||t.getAttribute("aria-hidden")==="true"?this.show(t):this.hide(t))},destroyAll:function(){document.querySelectorAll('.progress-bar[data-progress-initialized="true"]').forEach(t=>{delete t.dataset.progressInitialized})}};typeof window.Vanduo<"u"&&window.Vanduo.register("preloader",p),window.VanduoPreloader=p})();(function(){"use strict";let p={instances:new Map,init:function(){document.querySelectorAll("select.vd-custom-select-input, select[data-custom-select]").forEach(t=>{this.instances.has(t)||this.initSelect(t)})},initSelect:function(e){if(e.closest(".vd-custom-select-wrapper"))return;let t=[],n=document.createElement("div");n.className="custom-select-wrapper",e.parentNode.insertBefore(n,e),n.appendChild(e);let s=document.createElement("button");s.type="button",s.className="custom-select-button",s.setAttribute("aria-haspopup","listbox"),s.setAttribute("aria-expanded","false"),s.setAttribute("aria-labelledby",e.id||this.generateId(e));let o=document.createElement("div");if(o.className="custom-select-dropdown",o.setAttribute("role","listbox"),e.dataset.searchable==="true"){let l=document.createElement("div");l.className="custom-select-search";let h=document.createElement("input");h.type="text",h.className="input input-sm",h.placeholder="Search...",h.setAttribute("aria-label","Search options"),l.appendChild(h),o.appendChild(l);let f=u=>{this.filterOptions(o,u.target.value)},d=typeof debounce=="function"?debounce(f,150):f;h.addEventListener("input",d),t.push(()=>h.removeEventListener("input",d))}this.buildOptions(e,o,s),n.appendChild(s),n.appendChild(o),this.updateButtonText(e,s);let i=l=>{l.preventDefault(),l.stopPropagation(),this.toggleDropdown(s,o)};s.addEventListener("click",i),t.push(()=>s.removeEventListener("click",i));let a=l=>{!n.contains(l.target)&&o.classList.contains("is-open")&&this.closeDropdown(s,o)};document.addEventListener("click",a),t.push(()=>document.removeEventListener("click",a));let r=l=>{this.handleKeydown(l,e,s,o)};s.addEventListener("keydown",r),t.push(()=>s.removeEventListener("keydown",r));let c=()=>{this.updateButtonText(e,s),this.updateSelectedOptions(e,o)};e.addEventListener("change",c),t.push(()=>e.removeEventListener("change",c)),this.instances.set(e,{wrapper:n,button:s,dropdown:o,cleanup:t,typeaheadBuffer:"",typeaheadTimer:null})},buildOptions:function(e,t,n){let s=e.querySelectorAll("option"),o=document.createDocumentFragment();s.forEach((i,a)=>{if(i.parentElement.tagName==="OPTGROUP"){let c=i.parentElement;if(!t.querySelector(`[data-group="${c.label}"]`)){let l=document.createElement("div");l.className="custom-select-option-group",l.textContent=c.label,l.dataset.group=c.label,o.appendChild(l)}}if(i.value===""&&!i.textContent.trim())return;let r=document.createElement("div");r.className="custom-select-option",r.textContent=i.textContent,r.setAttribute("role","option"),r.setAttribute("data-value",i.value),r.setAttribute("data-index",a),i.selected&&(r.classList.add("is-selected"),r.setAttribute("aria-selected","true")),i.disabled&&(r.classList.add("is-disabled"),r.setAttribute("aria-disabled","true")),r.addEventListener("click",c=>{i.disabled||this.selectOption(e,i,r,n,t)}),o.appendChild(r)}),t.appendChild(o)},selectOption:function(e,t,n,s,o){e.multiple?(t.selected=!t.selected,n.classList.toggle("is-selected"),n.setAttribute("aria-selected",t.selected)):(e.value=t.value,e.dispatchEvent(new Event("change",{bubbles:!0})),this.closeDropdown(s,o)),this.updateButtonText(e,s)},updateButtonText:function(e,t){if(e.multiple){let n=Array.from(e.selectedOptions);n.length===0?t.textContent=e.dataset.placeholder||"Select options...":n.length===1?t.textContent=n[0].textContent:t.textContent=`${n.length} selected`}else{let n=e.options[e.selectedIndex];t.textContent=n?n.textContent:e.dataset.placeholder||"Select..."}},updateSelectedOptions:function(e,t){let n=t.querySelectorAll(".custom-select-option"),s=Array.from(e.selectedOptions).map(o=>o.value);n.forEach(o=>{let i=o.dataset.value;s.includes(i)?(o.classList.add("is-selected"),o.setAttribute("aria-selected","true")):(o.classList.remove("is-selected"),o.setAttribute("aria-selected","false"))})},toggleDropdown:function(e,t){t.classList.contains("is-open")?this.closeDropdown(e,t):this.openDropdown(e,t)},openDropdown:function(e,t){t.classList.add("is-open"),e.setAttribute("aria-expanded","true");let n=t.querySelector(".custom-select-option:not(.is-disabled)");n&&n.focus()},closeDropdown:function(e,t){t.classList.remove("is-open"),e.setAttribute("aria-expanded","false")},handleKeydown:function(e,t,n,s){let o=s.classList.contains("is-open"),i=Array.from(s.querySelectorAll(".custom-select-option:not(.is-disabled)")),a=i.findIndex(r=>r===document.activeElement);switch(e.key){case"Enter":case" ":if(e.preventDefault(),o&&a>=0){let r=i[a],c=t.options[parseInt(r.dataset.index)];this.selectOption(t,c,r,n,s)}else this.openDropdown(n,s);break;case"Escape":o&&(e.preventDefault(),this.closeDropdown(n,s),n.focus());break;case"ArrowDown":if(e.preventDefault(),!o)this.openDropdown(n,s);else{let r=a<i.length-1?a+1:0;i[r].focus()}break;case"ArrowUp":if(e.preventDefault(),o){let r=a>0?a-1:i.length-1;i[r].focus()}break;case"Home":o&&(e.preventDefault(),i[0].focus());break;case"End":o&&(e.preventDefault(),i[i.length-1].focus());break;default:if(o&&e.key.length===1&&!e.ctrlKey&&!e.metaKey&&!e.altKey){let r=this.instances.get(t);if(!r)break;clearTimeout(r.typeaheadTimer),r.typeaheadBuffer+=e.key.toLowerCase();let c=i.find(l=>l.textContent.trim().toLowerCase().startsWith(r.typeaheadBuffer));c&&c.focus(),r.typeaheadTimer=setTimeout(()=>{r.typeaheadBuffer=""},500)}break}},filterOptions:function(e,t){let n=e.querySelectorAll(".vd-custom-select-option"),s=t.toLowerCase();n.forEach(o=>{o.textContent.toLowerCase().includes(s)?o.style.display="block":o.style.display="none"})},generateId:function(e){if(e.id)return e.id;let t="select-"+Math.random().toString(36).substr(2,9);return e.id=t,t},destroy:function(e){let t=this.instances.get(e);t&&(t.cleanup.forEach(n=>n()),t.wrapper&&t.wrapper.parentNode&&(t.wrapper.parentNode.insertBefore(e,t.wrapper),t.wrapper.parentNode.removeChild(t.wrapper)),this.instances.delete(e))},destroyAll:function(){this.instances.forEach((e,t)=>{this.destroy(t)})}};typeof window.Vanduo<"u"&&window.Vanduo.register("select",p)})();(function(){"use strict";let p={sidenavs:new Map,breakpoint:992,_globalCleanups:[],isFixedVariant:function(e){return e.classList.contains("vd-sidenav-fixed")||e.classList.contains("sidenav-fixed")},isPushVariant:function(e){return e.classList.contains("vd-sidenav-push")||e.classList.contains("sidenav-push")},isRightVariant:function(e){return e.classList.contains("vd-sidenav-right")||e.classList.contains("sidenav-right")},init:function(){document.querySelectorAll(".vd-sidenav, .vd-offcanvas").forEach(s=>{this.sidenavs.has(s)||this.initSidenav(s)}),document.querySelectorAll("[data-sidenav-toggle]").forEach(s=>{if(s.dataset.sidenavToggleInitialized)return;s.dataset.sidenavToggleInitialized="true";let o=i=>{i.preventDefault();let a=s.dataset.sidenavToggle,r=document.querySelector(a);r&&this.toggle(r)};s.addEventListener("click",o),this._globalCleanups.push(()=>s.removeEventListener("click",o))}),this.handleResize();let n=()=>{this.handleResize()};window.addEventListener("resize",n),this._globalCleanups.push(()=>window.removeEventListener("resize",n))},initSidenav:function(e){let t=e.getAttribute("data-vd-position");if(t){let r=e.classList.contains("vd-offcanvas")?"vd-offcanvas":"vd-sidenav";e.classList.add(r+"-"+t)}let n=this.createOverlay(e),s=e.querySelector(".vd-sidenav-close, .vd-offcanvas-close"),o=[];if(e.setAttribute("role","navigation"),e.setAttribute("aria-hidden","true"),s){let r=()=>{this.close(e)};s.addEventListener("click",r),o.push(()=>s.removeEventListener("click",r))}let i=()=>{e.dataset.backdrop!=="static"&&this.close(e)};n.addEventListener("click",i),o.push(()=>n.removeEventListener("click",i));let a=r=>{r.key==="Escape"&&e.classList.contains("is-open")&&e.dataset.keyboard!=="false"&&this.close(e)};document.addEventListener("keydown",a),o.push(()=>document.removeEventListener("keydown",a)),this.sidenavs.set(e,{overlay:n,cleanup:o})},createOverlay:function(e){let t=e.querySelector(".vd-sidenav-overlay");return t||(t=document.createElement("div"),t.className="vd-sidenav-overlay",document.body.appendChild(t)),t},open:function(e){let t=typeof e=="string"?document.querySelector(e):e;if(!t||!this.sidenavs.has(t))return;let{overlay:n}=this.sidenavs.get(t);this.isFixedVariant(t)||n.classList.add("is-visible"),t.classList.add("is-open"),t.setAttribute("aria-hidden","false"),document.body.classList.add("body-sidenav-open"),this.isPushVariant(t)&&this.handlePushVariant(t,!0),t.dispatchEvent(new CustomEvent("sidenav:open",{bubbles:!0}))},close:function(e){let t=typeof e=="string"?document.querySelector(e):e;if(!t||!this.sidenavs.has(t))return;let{overlay:n}=this.sidenavs.get(t);n.classList.remove("is-visible"),t.classList.remove("is-open"),t.setAttribute("aria-hidden","true"),document.body.classList.remove("body-sidenav-open"),this.isPushVariant(t)&&this.handlePushVariant(t,!1),t.dispatchEvent(new CustomEvent("sidenav:close",{bubbles:!0}))},toggle:function(e){let t=typeof e=="string"?document.querySelector(e):e;t&&(t.classList.contains("is-open")?this.close(t):this.open(t))},handlePushVariant:function(e,t){let n=document.querySelector('main, .main-content, .content, [role="main"]')||document.body;t?window.innerWidth>=this.breakpoint&&(this.isRightVariant(e)?n.style.marginRight=e.offsetWidth+"px":n.style.marginLeft=e.offsetWidth+"px"):(n.style.marginLeft="",n.style.marginRight="")},handleResize:function(){this.sidenavs.forEach(({overlay:e},t)=>{window.innerWidth>=this.breakpoint?this.isFixedVariant(t)&&!t.classList.contains("is-open")&&(t.classList.add("is-open"),t.setAttribute("aria-hidden","false"),e.classList.remove("is-visible")):this.isFixedVariant(t)&&t.classList.contains("is-open")&&this.close(t)})},destroy:function(e){let t=this.sidenavs.get(e);t&&(e.classList.contains("is-open")&&this.close(e),t.cleanup.forEach(n=>n()),t.overlay&&t.overlay.parentNode&&t.overlay.parentNode.removeChild(t.overlay),this.sidenavs.delete(e))},destroyAll:function(){this.sidenavs.forEach((e,t)=>{this.destroy(t)}),this._globalCleanups.forEach(e=>e()),this._globalCleanups=[]}};typeof window.Vanduo<"u"&&window.Vanduo.register("sidenav",p),window.VanduoSidenav=p})();(function(){"use strict";let p={instances:new Map,init:function(){document.querySelectorAll(".vd-tabs, [data-tabs]").forEach(t=>{this.instances.has(t)||this.initTabs(t)})},initTabs:function(e){let t=e.querySelector('.vd-tab-list, [role="tablist"]'),n=e.querySelectorAll(".vd-tab-link, [data-tab]"),s=e.querySelectorAll(".vd-tab-pane, [data-tab-pane]");if(!t||n.length===0)return;let o=[];t.setAttribute("role","tablist"),n.forEach((a,r)=>{let c=a.dataset.tab||a.getAttribute("href")?.replace("#","")||`tab-${r}`,l=this.findPane(e,c,s);a.setAttribute("role","tab"),a.setAttribute("aria-selected",a.classList.contains("is-active")?"true":"false"),a.setAttribute("tabindex",a.classList.contains("is-active")?"0":"-1"),a.id||(a.id=`tab-btn-${c}`),l&&(l.setAttribute("role","tabpanel"),l.setAttribute("aria-labelledby",a.id),l.id||(l.id=`tab-pane-${c}`),a.setAttribute("aria-controls",l.id));let h=d=>{d.preventDefault(),!a.classList.contains("disabled")&&!a.disabled&&this.activateTab(e,a,n,s)};a.addEventListener("click",h),o.push(()=>a.removeEventListener("click",h));let f=d=>{this.handleKeydown(d,e,a,n,s)};a.addEventListener("keydown",f),o.push(()=>a.removeEventListener("keydown",f))}),!e.querySelector(".vd-tab-link.is-active, [data-tab].is-active")&&n.length>0&&this.activateTab(e,n[0],n,s),this.instances.set(e,{cleanup:o})},findPane:function(e,t,n){let s=e.querySelector(`[data-tab-pane="${t}"]`);return s||(s=e.querySelector(`#${t}`)),s||e.querySelectorAll(".vd-tab-link, [data-tab]").forEach((i,a)=>{(i.dataset.tab||i.getAttribute("href")?.replace("#",""))===t&&n[a]&&(s=n[a])}),s},activateTab:function(e,t,n,s){let o=t.dataset.tab||t.getAttribute("href")?.replace("#","")||t.id;n.forEach(r=>{r.classList.remove("is-active"),r.setAttribute("aria-selected","false"),r.setAttribute("tabindex","-1"),r.parentElement&&r.parentElement.classList.contains("tab-item")&&r.parentElement.classList.remove("is-active")}),s.forEach(r=>{r.classList.remove("is-active")}),t.classList.add("is-active"),t.setAttribute("aria-selected","true"),t.setAttribute("tabindex","0"),t.parentElement&&t.parentElement.classList.contains("tab-item")&&t.parentElement.classList.add("is-active");let i=this.findPane(e,o,s);i&&i.classList.add("is-active");let a=new CustomEvent("tab:change",{bubbles:!0,detail:{tab:t,pane:i,tabId:o}});e.dispatchEvent(a)},handleKeydown:function(e,t,n,s,o){let i=t.classList.contains("tabs-vertical"),a=Array.from(s).filter(l=>!l.classList.contains("disabled")&&!l.disabled),r=a.indexOf(n),c=r;switch(e.key){case"ArrowLeft":i||(e.preventDefault(),c=r>0?r-1:a.length-1);break;case"ArrowRight":i||(e.preventDefault(),c=r<a.length-1?r+1:0);break;case"ArrowUp":i&&(e.preventDefault(),c=r>0?r-1:a.length-1);break;case"ArrowDown":i&&(e.preventDefault(),c=r<a.length-1?r+1:0);break;case"Home":e.preventDefault(),c=0;break;case"End":e.preventDefault(),c=a.length-1;break;case"Enter":case" ":e.preventDefault(),this.activateTab(t,n,s,o);return;default:return}c!==r&&(a[c].focus(),this.activateTab(t,a[c],s,o))},show:function(e){let t;if(typeof e=="string"?t=document.querySelector(`[data-tab="${e}"], [href="#${e}"]`):t=e,!t)return;let n=t.closest(".vd-tabs, [data-tabs]");if(!n)return;let s=n.querySelectorAll(".vd-tab-link, [data-tab]"),o=n.querySelectorAll(".vd-tab-pane, [data-tab-pane]");this.activateTab(n,t,s,o)},destroy:function(e){let t=this.instances.get(e);t&&(t.cleanup.forEach(n=>n()),this.instances.delete(e))},destroyAll:function(){this.instances.forEach((e,t)=>{this.destroy(t)})}};typeof window.Vanduo<"u"&&window.Vanduo.register("tabs",p)})();(function(){"use strict";let p={STORAGE_KEYS:{PRIMARY:"vanduo-primary-color",NEUTRAL:"vanduo-neutral-color",RADIUS:"vanduo-radius",FONT:"vanduo-font-preference",THEME:"vanduo-theme-preference"},DEFAULTS:{PRIMARY_LIGHT:"black",PRIMARY_DARK:"amber",NEUTRAL:"neutral",RADIUS:"0.5",FONT:"ubuntu",THEME:"system"},PRIMARY_COLORS:{black:{name:"Black",color:"#000000"},red:{name:"Red",color:"#fa5252"},orange:{name:"Orange",color:"#fd7e14"},amber:{name:"Amber",color:"#f59f00"},yellow:{name:"Yellow",color:"#fcc419"},lime:{name:"Lime",color:"#82c91e"},green:{name:"Green",color:"#40c057"},emerald:{name:"Emerald",color:"#20c997"},teal:{name:"Teal",color:"#12b886"},cyan:{name:"Cyan",color:"#22b8cf"},sky:{name:"Sky",color:"#3bc9db"},blue:{name:"Blue",color:"#228be6"},indigo:{name:"Indigo",color:"#4c6ef5"},violet:{name:"Violet",color:"#7950f2"},purple:{name:"Purple",color:"#be4bdb"},fuchsia:{name:"Fuchsia",color:"#f06595"},pink:{name:"Pink",color:"#e64980"},rose:{name:"Rose",color:"#ff8787"}},NEUTRAL_COLORS:{slate:{name:"Slate",color:"#64748b"},gray:{name:"Gray",color:"#6b7280"},zinc:{name:"Zinc",color:"#71717a"},neutral:{name:"Neutral",color:"#737373"},stone:{name:"Stone",color:"#78716c"}},RADIUS_OPTIONS:["0","0.125","0.25","0.375","0.5"],FONT_OPTIONS:{"jetbrains-mono":{name:"JetBrains Mono",family:"'JetBrains Mono', monospace"},inter:{name:"Inter",family:"'Inter', sans-serif"},"source-sans":{name:"Source Sans 3",family:"'Source Sans 3', sans-serif"},"fira-sans":{name:"Fira Sans",family:"'Fira Sans', sans-serif"},"ibm-plex":{name:"IBM Plex Sans",family:"'IBM Plex Sans', sans-serif"},system:{name:"System Default",family:null},ubuntu:{name:"Ubuntu",family:"'Ubuntu', sans-serif"},"open-sans":{name:"Open Sans",family:"'Open Sans', sans-serif"},rubik:{name:"Rubik",family:"'Rubik', sans-serif"},"titillium-web":{name:"Titillium Web",family:"'Titillium Web', sans-serif"}},THEME_MODES:["system","dark","light"],state:{primary:null,neutral:null,radius:null,font:null,theme:null,isOpen:!1},isInitialized:!1,_cleanup:[],elements:{customizer:null,trigger:null,panel:null,overlay:null},init:function(){if(this.isInitialized){this.bindExistingElements(),this.bindPanelEvents(),this.updateUI();return}this.isInitialized=!0,this._cleanup=[],this.loadPreferences(),this.applyAllPreferences(),this.bindExistingElements(),this.bindEvents(),console.log("Vanduo Theme Customizer initialized")},addListener:function(e,t,n,s){e&&(e.addEventListener(t,n,s),this._cleanup.push(()=>e.removeEventListener(t,n,s)))},getDefaultPrimary:function(e){return e==="system"?window.matchMedia&&window.matchMedia("(prefers-color-scheme: dark)").matches?this.DEFAULTS.PRIMARY_DARK:this.DEFAULTS.PRIMARY_LIGHT:e==="dark"?this.DEFAULTS.PRIMARY_DARK:this.DEFAULTS.PRIMARY_LIGHT},loadPreferences:function(){this.state.theme=this.getStorageValue(this.STORAGE_KEYS.THEME,this.DEFAULTS.THEME),this.state.primary=this.getStorageValue(this.STORAGE_KEYS.PRIMARY,this.getDefaultPrimary(this.state.theme)),this._normalizeDefaultPrimaryIfStaleWithStoredTheme(),this.state.neutral=this.getStorageValue(this.STORAGE_KEYS.NEUTRAL,this.DEFAULTS.NEUTRAL),this.state.radius=this.getStorageValue(this.STORAGE_KEYS.RADIUS,this.DEFAULTS.RADIUS),this.state.font=this.getStorageValue(this.STORAGE_KEYS.FONT,this.DEFAULTS.FONT)},savePreference:function(e,t){this.setStorageValue(e,t)},applyAllPreferences:function(){this.applyPrimary(this.state.primary),this.applyNeutral(this.state.neutral),this.applyRadius(this.state.radius),this.applyFont(this.state.font),this.applyTheme(this.state.theme)},applyPrimary:function(e){this.PRIMARY_COLORS[e]||(e=this.getDefaultPrimary(this.state.theme)),this.state.primary=e,document.documentElement.setAttribute("data-primary",e),this.savePreference(this.STORAGE_KEYS.PRIMARY,e),this.dispatchEvent("primary-change",{color:e})},applyNeutral:function(e){this.NEUTRAL_COLORS[e]||(e=this.DEFAULTS.NEUTRAL),this.state.neutral=e,document.documentElement.setAttribute("data-neutral",e),this.savePreference(this.STORAGE_KEYS.NEUTRAL,e),this.dispatchEvent("neutral-change",{neutral:e})},applyRadius:function(e){this.RADIUS_OPTIONS.includes(e)||(e=this.DEFAULTS.RADIUS),this.state.radius=e,document.documentElement.setAttribute("data-radius",e),document.documentElement.style.setProperty("--radius-scale",e),this.savePreference(this.STORAGE_KEYS.RADIUS,e),this.dispatchEvent("radius-change",{radius:e})},applyFont:function(e){this.FONT_OPTIONS[e]||(e=this.DEFAULTS.FONT),this.state.font=e,e==="system"?document.documentElement.removeAttribute("data-font"):document.documentElement.setAttribute("data-font",e),this.savePreference(this.STORAGE_KEYS.FONT,e),window.FontSwitcher&&window.FontSwitcher.setPreference&&(window.FontSwitcher.state.preference=e,window.FontSwitcher.applyFont()),this.dispatchEvent("font-change",{font:e})},applyTheme:function(e){if(this.THEME_MODES.includes(e)||(e=this.DEFAULTS.THEME),this._isApplying=!0,this.isUsingDefaultPrimary()){let t=this.getDefaultPrimary(e);this.state.primary!==t&&this.applyPrimary(t)}if(this.state.theme=e,e==="system"?document.documentElement.removeAttribute("data-theme"):document.documentElement.setAttribute("data-theme",e),this.savePreference(this.STORAGE_KEYS.THEME,e),window.Vanduo&&window.Vanduo.components.themeSwitcher){let t=window.Vanduo.components.themeSwitcher;t.state&&t.state.preference!==e&&(t.state.preference=e,typeof t.setStorageValue=="function"&&t.setStorageValue(t.STORAGE_KEY,e),typeof t.updateUI=="function"&&t.updateUI())}this._isApplying=!1,this.dispatchEvent("mode-change",{mode:e})},dispatchEvent:function(e,t){let n=new CustomEvent("theme:"+e,{bubbles:!0,detail:t});document.dispatchEvent(n);let s=new CustomEvent("theme:change",{bubbles:!0,detail:{type:e,value:t[Object.keys(t)[0]],state:{...this.state}}});document.dispatchEvent(s)},bindExistingElements:function(){if(this.elements.customizer=document.querySelector(".vd-theme-customizer"),this.elements.customizer)this.elements.trigger=this.elements.customizer.querySelector(".vd-theme-customizer-trigger"),this.elements.panel=this.elements.customizer.querySelector(".vd-theme-customizer-panel"),this.elements.overlay=this.elements.customizer.querySelector(".vd-theme-customizer-overlay");else{let e=document.querySelector("[data-theme-customizer-trigger]");e&&this.createDynamicPanel(e)}this.updateUI()},createDynamicPanel:function(e){let t=document.createElement("div");t.className="vd-theme-customizer",this.elements.trigger=e;let n=document.createElement("div");n.className="vd-theme-customizer-overlay";let s=document.createElement("div");s.className="vd-theme-customizer-panel",s.innerHTML=this.getPanelHTML(),document.body.appendChild(n),document.body.appendChild(s),this.elements.panel=s,this.elements.overlay=n,this.elements.customizer={contains:o=>s.contains(o)||e.contains(o)},this.positionPanel(),this.bindPanelEvents(),this.addListener(window,"resize",()=>this.positionPanel())},positionPanel:function(){if(!this.elements.panel||!this.elements.trigger)return;if(window.innerWidth<768)this.elements.panel.style.top="",this.elements.panel.style.right="",this.elements.panel.style.left="",this.elements.panel.style.height="",this.elements.panel.style.maxHeight="";else{let t=this.elements.trigger.getBoundingClientRect(),n=320,s=t.bottom+8,o=window.innerWidth,i=o-t.right;o-i-n<8&&(i=o-n-8),this.elements.panel.style.top=s+"px",this.elements.panel.style.right=i+"px",this.elements.panel.style.left="",this.elements.panel.style.height="auto",this.elements.panel.style.maxHeight="calc(100vh - "+s+"px)"}},bindPanelEvents:function(){if(!this.elements.panel||this.elements.panel.getAttribute("data-customizer-initialized")==="true")return;this.elements.panel.setAttribute("data-customizer-initialized","true"),this.elements.panel.querySelectorAll("[data-color]").forEach(s=>{this.addListener(s,"click",()=>{this.applyPrimary(s.dataset.color),this.updateUI()})}),this.elements.panel.querySelectorAll("[data-neutral]").forEach(s=>{this.addListener(s,"click",()=>{this.applyNeutral(s.dataset.neutral),this.updateUI()})}),this.elements.panel.querySelectorAll("[data-radius]").forEach(s=>{this.addListener(s,"click",()=>{this.applyRadius(s.dataset.radius),this.updateUI()})});let e=this.elements.panel.querySelector("[data-customizer-font]");e&&this.addListener(e,"change",s=>{this.applyFont(s.target.value),this.updateUI()});let t=this.elements.panel.querySelector(".customizer-reset");t&&this.addListener(t,"click",()=>{this.reset()});let n=this.elements.panel.querySelector(".customizer-mobile-close");n&&this.addListener(n,"click",()=>{this.close()}),this.elements.overlay&&this.addListener(this.elements.overlay,"click",()=>{this.close()})},getPanelHTML:function(){let e=typeof escapeHtml=="function"?escapeHtml:function(a){let r=document.createElement("div");return r.textContent=String(a??""),r.innerHTML},t=function(a){let r=String(a??"").trim();return/^(#[0-9a-fA-F]{3,8}|rgb[a]?\([^)]{1,60}\)|hsl[a]?\([^)]{1,60}\)|var\(--[a-zA-Z0-9_-]{1,40}\))$/.test(r)?r:"#000000"},n="";for(let[a,r]of Object.entries(this.PRIMARY_COLORS))n+=`<button class="tc-color-swatch${a===this.state.primary?" is-active":""}" data-color="${e(a)}" style="--swatch-color: ${t(r.color)}" title="${e(r.name)}"></button>`;let s="";for(let[a,r]of Object.entries(this.NEUTRAL_COLORS))s+=`<button class="tc-neutral-swatch${a===this.state.neutral?" is-active":""}" data-neutral="${e(a)}" style="--swatch-color: ${t(r.color)}" title="${e(r.name)}"><span>${e(r.name)}</span></button>`;let o="";this.RADIUS_OPTIONS.forEach(a=>{o+=`<button class="tc-radius-btn${a===this.state.radius?" is-active":""}" data-radius="${e(a)}">${e(a)}</button>`});let i="";for(let[a,r]of Object.entries(this.FONT_OPTIONS))i+=`<option value="${e(a)}"${a===this.state.font?" selected":""}>${e(r.name)}</option>`;return`
      ...
      `},isUsingDefaultPrimary:function(){return this.state.primary===this.DEFAULTS.PRIMARY_LIGHT||this.state.primary===this.DEFAULTS.PRIMARY_DARK},_normalizeDefaultPrimaryIfStaleWithStoredTheme:function(){if(!this.isUsingDefaultPrimary())return;let e=this.getDefaultPrimary(this.state.theme);this.state.primary!==e&&(this.state.primary=e)},bindEvents:function(){if(this.elements.trigger&&this.addListener(this.elements.trigger,"click",e=>{e.preventDefault(),e.stopPropagation(),this.toggle()}),this.bindPanelEvents(),window.matchMedia){let e=window.matchMedia("(prefers-color-scheme: dark)"),t=()=>{if(this.state.theme==="system"&&this.isUsingDefaultPrimary()){let n=this.getDefaultPrimary("system");n!==this.state.primary&&(this.applyPrimary(n),this.updateUI())}};e.addEventListener("change",t),this._cleanup.push(()=>e.removeEventListener("change",t))}this.addListener(document,"click",e=>{this.state.isOpen&&this.elements.customizer&&!this.elements.customizer.contains(e.target)&&this.close()}),this.addListener(document,"keydown",e=>{e.key==="Escape"&&this.state.isOpen&&this.close()})},toggle:function(){this.state.isOpen?this.close():this.open()},open:function(){this.state.isOpen=!0,this.positionPanel(),this.elements.panel&&this.elements.panel.classList.add("is-open"),this.elements.trigger&&this.elements.trigger.setAttribute("aria-expanded","true"),this.elements.overlay&&this.elements.overlay.classList.add("is-active"),this.dispatchEvent("panel-open",{isOpen:!0})},close:function(){this.state.isOpen=!1,this.elements.panel&&this.elements.panel.classList.remove("is-open"),this.elements.trigger&&this.elements.trigger.setAttribute("aria-expanded","false"),this.elements.overlay&&this.elements.overlay.classList.remove("is-active"),this.dispatchEvent("panel-close",{isOpen:!1})},updateUI:function(){if(!this.elements.panel)return;this.elements.panel.querySelectorAll("[data-color]").forEach(t=>{t.classList.toggle("is-active",t.dataset.color===this.state.primary)}),this.elements.panel.querySelectorAll("[data-neutral]").forEach(t=>{t.classList.toggle("is-active",t.dataset.neutral===this.state.neutral)}),this.elements.panel.querySelectorAll("[data-radius]").forEach(t=>{t.classList.toggle("is-active",t.dataset.radius===this.state.radius)});let e=this.elements.panel.querySelector("[data-customizer-font]");e&&(e.value=this.state.font)},reset:function(){this.applyTheme(this.DEFAULTS.THEME),this.applyPrimary(this.getDefaultPrimary(this.DEFAULTS.THEME)),this.applyNeutral(this.DEFAULTS.NEUTRAL),this.applyRadius(this.DEFAULTS.RADIUS),this.applyFont(this.DEFAULTS.FONT),this.updateUI(),this.dispatchEvent("reset",{state:{...this.state}})},getState:function(){return{...this.state}},setPreferences:function(e){e.primary&&this.applyPrimary(e.primary),e.neutral&&this.applyNeutral(e.neutral),e.radius&&this.applyRadius(e.radius),e.font&&this.applyFont(e.font),e.theme&&this.applyTheme(e.theme),this.updateUI()},getStorageValue:function(e,t){if(typeof window.safeStorageGet=="function")return window.safeStorageGet(e,t);try{let n=localStorage.getItem(e);return n!==null?n:t}catch{return t}},setStorageValue:function(e,t){if(typeof window.safeStorageSet=="function")return window.safeStorageSet(e,t);try{return localStorage.setItem(e,t),!0}catch{return!1}},destroyAll:function(){this._cleanup.forEach(e=>e()),this._cleanup=[],this.elements.panel&&this.elements.panel.removeAttribute("data-customizer-initialized"),this.close(),this.isInitialized=!1}};window.Vanduo&&window.Vanduo.register("themeCustomizer",p),window.ThemeCustomizer=p})();(function(){"use strict";let p={isInitialized:!1,_mediaQuery:null,_onMediaChange:null,init:function(){if(this.STORAGE_KEY="vanduo-theme-preference",this.state={preference:this.getPreference()},this.isInitialized){this.applyTheme(),this.renderUI(),this.updateUI();return}this.isInitialized=!0,this.applyTheme(),this.listenForSystemChanges(),this.renderUI(),console.log("Vanduo Theme Switcher initialized")},getPreference:function(){return this.getStorageValue(this.STORAGE_KEY,"system")},setPreference:function(e){this.state.preference=e,this.setStorageValue(this.STORAGE_KEY,e),this.applyTheme(),window.ThemeCustomizer&&window.ThemeCustomizer.applyTheme&&!window.ThemeCustomizer._isApplying&&window.ThemeCustomizer.applyTheme(e),this.updateUI()},getStorageValue:function(e,t){if(typeof window.safeStorageGet=="function")return window.safeStorageGet(e,t);try{let n=localStorage.getItem(e);return n!==null?n:t}catch{return t}},setStorageValue:function(e,t){if(typeof window.safeStorageSet=="function")return window.safeStorageSet(e,t);try{return localStorage.setItem(e,t),!0}catch{return!1}},applyTheme:function(){let e=this.state.preference;e==="system"?document.documentElement.removeAttribute("data-theme"):document.documentElement.setAttribute("data-theme",e)},listenForSystemChanges:function(){this._mediaQuery&&this._onMediaChange||(this._mediaQuery=window.matchMedia("(prefers-color-scheme: dark)"),this._onMediaChange=e=>{this.state.preference==="system"&&(this.applyTheme(),window.ThemeCustomizer&&typeof window.ThemeCustomizer.applyTheme=="function"&&!window.ThemeCustomizer._isApplying&&window.ThemeCustomizer.applyTheme("system"))},this._mediaQuery.addEventListener("change",this._onMediaChange))},renderUI:function(){document.querySelectorAll('[data-toggle="theme"]').forEach(t=>{if(t.getAttribute("data-theme-initialized")==="true"){t.tagName==="SELECT"&&(t.value=this.state.preference);return}if(t.tagName==="SELECT"){t.value=this.state.preference;let n=s=>{this.setPreference(s.target.value)};t.addEventListener("change",n),t._themeToggleHandler=n}else{let n=()=>{let s=["system","light","dark"],o=(s.indexOf(this.state.preference)+1)%s.length;this.setPreference(s[o])};t.addEventListener("click",n),t._themeToggleHandler=n}t.setAttribute("data-theme-initialized","true")})},updateUI:function(){document.querySelectorAll('[data-toggle="theme"]').forEach(t=>{if(t.tagName==="SELECT")t.value=this.state.preference;else{let n=t.querySelector(".theme-current-label");n&&(n.textContent=this.state.preference.charAt(0).toUpperCase()+this.state.preference.slice(1))}})},destroyAll:function(){document.querySelectorAll('[data-toggle="theme"][data-theme-initialized="true"]').forEach(t=>{if(t._themeToggleHandler){let n=t.tagName==="SELECT"?"change":"click";t.removeEventListener(n,t._themeToggleHandler),delete t._themeToggleHandler}t.removeAttribute("data-theme-initialized")}),this._mediaQuery&&this._onMediaChange&&this._mediaQuery.removeEventListener("change",this._onMediaChange),this._mediaQuery=null,this._onMediaChange=null,this.isInitialized=!1}};window.Vanduo&&window.Vanduo.register("themeSwitcher",p)})();(function(){"use strict";let p={defaults:{position:"top-right",duration:5e3,dismissible:!0,showProgress:!0,pauseOnHover:!0},containers:{},getContainer:function(e){if(this.containers[e])return this.containers[e];let t=document.createElement("div");return t.className=`vd-toast-container vd-toast-container-${e}`,t.setAttribute("role","status"),t.setAttribute("aria-live","polite"),t.setAttribute("aria-atomic","false"),document.body.appendChild(t),this.containers[e]=t,t},show:function(e,t,n){typeof e=="string"&&(e={message:e,type:t,duration:n});let s=Object.assign({},this.defaults,e),o=this.getContainer(s.position),i=document.createElement("div");i.className="vd-toast",s.type&&i.classList.add(`vd-toast-${s.type}`),s.solid&&i.classList.add("vd-toast-solid"),s.showProgress&&s.duration>0&&i.classList.add("vd-toast-with-progress");let a="";if(s.icon){let m=typeof sanitizeHtml=="function"?sanitizeHtml(s.icon):escapeHtml(s.icon);a+=`<span class="vd-toast-icon">${m}</span>`}else s.type&&(a+=`<span class="vd-toast-icon">${this.getDefaultIcon(s.type)}</span>`);let r=typeof escapeHtml=="function"?escapeHtml:function(m){let y=document.createElement("div");return y.appendChild(document.createTextNode(m)),y.innerHTML};if(a+='<div class="vd-toast-content">',s.title&&(a+=`<div class="vd-toast-title">${r(String(s.title))}</div>`),s.message&&(a+=`<div class="vd-toast-message">${r(String(s.message))}</div>`),a+="</div>",s.dismissible&&(a+='<button type="button" class="vd-toast-close" aria-label="Close"></button>'),s.showProgress&&s.duration>0){let m=parseInt(s.duration,10)||0;a+=`<div class="vd-toast-progress" style="animation-duration: ${m}ms"></div>`}if(i.innerHTML=a,o.appendChild(i),i._toastCleanup=[],s.dismissible){let m=i.querySelector(".vd-toast-close"),y=()=>{this.dismiss(i)};m.addEventListener("click",y),i._toastCleanup.push(()=>m.removeEventListener("click",y))}let c=null,l=s.duration,h=null,f=()=>{if(s.duration>0){h=Date.now(),c=setTimeout(()=>{this.dismiss(i)},l),i._toastTimeoutId=c;let m=i.querySelector(".vd-toast-progress");m&&(m.style.animationPlayState="running")}},d=()=>{if(c){clearTimeout(c),c=null,i._toastTimeoutId=null,l-=Date.now()-h;let m=i.querySelector(".vd-toast-progress");m&&(m.style.animationPlayState="paused")}};s.pauseOnHover&&(i.addEventListener("mouseenter",d),i.addEventListener("mouseleave",f),i._toastCleanup.push(()=>i.removeEventListener("mouseenter",d),()=>i.removeEventListener("mouseleave",f))),requestAnimationFrame(()=>{i.classList.add("is-visible"),f()}),i._toastConfig=s;let u=new CustomEvent("toast:show",{bubbles:!0,detail:{toast:i,config:s}});return i.dispatchEvent(u),i},dismiss:function(e){if(!e||e.classList.contains("is-exiting"))return;e._toastTimeoutId&&(clearTimeout(e._toastTimeoutId),e._toastTimeoutId=null),e.classList.remove("is-visible"),e.classList.add("is-exiting");let t=new CustomEvent("toast:dismiss",{bubbles:!0,detail:{toast:e}});e.dispatchEvent(t);let n=()=>{e.removeEventListener("transitionend",n),e._toastCleanup&&(e._toastCleanup.forEach(s=>s()),delete e._toastCleanup),e.parentElement&&e.parentElement.removeChild(e)};e.addEventListener("transitionend",n),setTimeout(()=>{e._toastCleanup&&(e._toastCleanup.forEach(s=>s()),delete e._toastCleanup),e.parentElement&&e.parentElement.removeChild(e)},400)},destroyAll:function(){Object.keys(this.containers).forEach(e=>{let t=this.containers[e];if(!t)return;t.querySelectorAll(".vd-toast").forEach(s=>{s._toastTimeoutId&&clearTimeout(s._toastTimeoutId),s._toastCleanup&&(s._toastCleanup.forEach(o=>o()),delete s._toastCleanup),s.parentElement&&s.parentElement.removeChild(s)}),t.parentElement&&t.parentElement.removeChild(t)}),this.containers={}},dismissAll:function(e){e&&this.containers[e]?this.containers[e].querySelectorAll(".vd-toast").forEach(n=>this.dismiss(n)):Object.values(this.containers).forEach(t=>{t.querySelectorAll(".vd-toast").forEach(s=>this.dismiss(s))})},getDefaultIcon:function(e){return{success:'<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M22 11.08V12a10 10 0 1 1-5.93-9.14"></path><polyline points="22 4 12 14.01 9 11.01"></polyline></svg>',error:'<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"></circle><line x1="15" y1="9" x2="9" y2="15"></line><line x1="9" y1="9" x2="15" y2="15"></line></svg>',warning:'<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M10.29 3.86L1.82 18a2 2 0 0 0 1.71 3h16.94a2 2 0 0 0 1.71-3L13.71 3.86a2 2 0 0 0-3.42 0z"></path><line x1="12" y1="9" x2="12" y2="13"></line><line x1="12" y1="17" x2="12.01" y2="17"></line></svg>',info:'<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"></circle><line x1="12" y1="16" x2="12" y2="12"></line><line x1="12" y1="8" x2="12.01" y2="8"></line></svg>'}[e]||""},success:function(e,t){return this.show(Object.assign({message:e,type:"success"},t))},error:function(e,t){return this.show(Object.assign({message:e,type:"error"},t))},warning:function(e,t){return this.show(Object.assign({message:e,type:"warning"},t))},info:function(e,t){return this.show(Object.assign({message:e,type:"info"},t))}};typeof window.Vanduo<"u"&&window.Vanduo.register("toast",p),window.Toast=p})();(function(){"use strict";let p={tooltips:new Map,delayTimers:new Map,sanitizeHtml:function(e){if(typeof sanitizeHtml=="function")return sanitizeHtml(e);let t=document.createElement("div");return t.textContent=e||"",t.innerHTML},init:function(){document.querySelectorAll("[data-tooltip], [data-tooltip-html]").forEach(t=>{this.tooltips.has(t)||this.initTooltip(t)})},initTooltip:function(e){let t=this.createTooltip(e),n=[],s=()=>{this.showTooltip(e,t)},o=()=>{this.hideTooltip(e,t)},i=()=>{this.showTooltip(e,t)},a=()=>{this.hideTooltip(e,t)};e.addEventListener("mouseenter",s),e.addEventListener("mouseleave",o),e.addEventListener("focus",i),e.addEventListener("blur",a),n.push(()=>e.removeEventListener("mouseenter",s),()=>e.removeEventListener("mouseleave",o),()=>e.removeEventListener("focus",i),()=>e.removeEventListener("blur",a)),this.tooltips.set(e,{tooltip:t,cleanup:n})},createTooltip:function(e){let t=document.createElement("div");t.className="vd-tooltip",t.setAttribute("role","tooltip"),t.setAttribute("aria-hidden","true");let n="tooltip-"+Math.random().toString(36).substr(2,9);t.id=n,e.setAttribute("aria-describedby",n);let s=e.dataset.tooltipHtml,o=e.dataset.tooltip;s?(t.innerHTML=this.sanitizeHtml(s),t.classList.add("vd-tooltip-html")):o&&(t.textContent=o);let i=e.dataset.tooltipPlacement||e.dataset.placement||"top";t.setAttribute("data-placement",i),t.classList.add(`vd-tooltip-${i}`),e.dataset.tooltipVariant&&t.classList.add(`vd-tooltip-${e.dataset.tooltipVariant}`),e.dataset.tooltipSize&&t.classList.add(`vd-tooltip-${e.dataset.tooltipSize}`);let a=parseInt(e.dataset.tooltipDelay)||0;return t.dataset.delay=a,document.body.appendChild(t),t},showTooltip:function(e,t){let n=parseInt(t.dataset.delay)||0;if(n>0){let s=setTimeout(()=>{this.positionTooltip(e,t),t.classList.add("is-visible"),t.setAttribute("aria-hidden","false")},n);this.delayTimers.set(e,s)}else this.positionTooltip(e,t),t.classList.add("is-visible"),t.setAttribute("aria-hidden","false")},hideTooltip:function(e,t){let n=this.delayTimers.get(e);n&&(clearTimeout(n),this.delayTimers.delete(e)),t.classList.remove("is-visible"),t.setAttribute("aria-hidden","true")},positionTooltip:function(e,t){let n=t.dataset.placement||"top",s=e.getBoundingClientRect(),o=t.getBoundingClientRect(),i=window.pageYOffset||document.documentElement.scrollTop,a=window.pageXOffset||document.documentElement.scrollLeft,r=0,c=0;switch(n){case"top":r=s.top+i-o.height-8,c=s.left+a+s.width/2-o.width/2;break;case"bottom":r=s.bottom+i+8,c=s.left+a+s.width/2-o.width/2;break;case"left":r=s.top+i+s.height/2-o.height/2,c=s.left+a-o.width-8;break;case"right":r=s.top+i+s.height/2-o.height/2,c=s.right+a+8;break}let l=window.innerWidth,h=window.innerHeight,f=8;c<f?c=f:c+o.width>l-f&&(c=l-o.width-f),r<i+f?r=i+f:r+o.height>i+h-f&&(r=i+h-o.height-f),t.style.cssText=`position: absolute; top: 0; left: 0; transform: translate(${c}px, ${r}px);`},show:function(e){let t=typeof e=="string"?document.querySelector(e):e;if(t&&this.tooltips.has(t)){let{tooltip:n}=this.tooltips.get(t);this.showTooltip(t,n)}},hide:function(e){let t=typeof e=="string"?document.querySelector(e):e;if(t&&this.tooltips.has(t)){let{tooltip:n}=this.tooltips.get(t);this.hideTooltip(t,n)}},update:function(e,t,n=!1){let s=typeof e=="string"?document.querySelector(e):e;if(s&&this.tooltips.has(s)){let{tooltip:o}=this.tooltips.get(s);n?(o.innerHTML=this.sanitizeHtml(t),o.classList.add("vd-tooltip-html")):(o.textContent=t,o.classList.remove("vd-tooltip-html"))}},destroy:function(e){let t=this.tooltips.get(e);if(!t)return;let n=this.delayTimers.get(e);n&&(clearTimeout(n),this.delayTimers.delete(e)),t.cleanup.forEach(s=>s()),t.tooltip&&t.tooltip.parentNode&&t.tooltip.parentNode.removeChild(t.tooltip),this.tooltips.delete(e)},destroyAll:function(){this.tooltips.forEach((e,t)=>{this.destroy(t)})}};typeof window.Vanduo<"u"&&window.Vanduo.register("tooltips",p),window.VanduoTooltips=p})();(function(){"use strict";let p={minQueryLength:2,maxResults:10,debounceMs:150,highlightTag:"mark",keyboardShortcut:!0,containerSelector:".vd-doc-search",inputSelector:".vd-doc-search-input",resultsSelector:".vd-doc-search-results",contentSelector:".doc-content section[id]",titleSelector:".demo-title, h2, h3",navSelector:".doc-nav-link",sectionSelector:".doc-nav-section",excludeFromContent:"pre, code, script, style",maxContentLength:500,data:null,categoryIcons:{"getting-started":"ph-rocket-launch",core:"ph-cube",components:"ph-puzzle-piece",interactive:"ph-cursor-click","data-display":"ph-table",feedback:"ph-bell",meta:"ph-info",default:"ph-file-text"},onSelect:null,onSearch:null,onOpen:null,onClose:null,emptyTitle:"No results found",emptyText:"Try different keywords or check spelling",placeholder:"Search..."};function e(n){let s=Object.assign({},p,n||{}),o={initialized:!1,index:[],results:[],activeIndex:-1,isOpen:!1,query:"",container:null,input:null,resultsContainer:null,debounceTimer:null,boundHandlers:{}};function i(x,_,...M){try{_(...M)}catch(H){console.warn('[Vanduo Search] Callback error in "'+x+'":',H)}}function a(x){if(o.resultsContainer)try{o.resultsContainer.innerHTML=x}catch(_){console.warn("[Vanduo Search] Failed to render results:",_)}}function r(){return o.initialized?Z:(o.container=document.querySelector(s.containerSelector),!o.container||(o.input=o.container.querySelector(s.inputSelector),o.resultsContainer=o.container.querySelector(s.resultsSelector),!o.input||!o.resultsContainer)?(o.initialized=!1,null):(s.placeholder&&o.input.setAttribute("placeholder",s.placeholder),c(),m(),T(),o.initialized=!0,Z))}function c(){if(o.index=[],s.data&&Array.isArray(s.data)){s.data.forEach(function(M){o.index.push({id:M.id||u(M.title),title:M.title||"",category:M.category||"",categorySlug:u(M.category||""),content:M.content||"",keywords:M.keywords||d(M.title+" "+M.content),url:M.url||"#"+(M.id||u(M.title)),icon:M.icon||""})});return}let x=document.querySelectorAll(s.contentSelector),_=l();x.forEach(function(M){let H=M.id;if(!H)return;let z=M.querySelector(s.titleSelector),L=z?z.textContent.replace(/v[\d.]+/g,"").trim():H,I=_[H]||"Documentation",C=h(M),k=f(M,L),q=z?z.querySelector("i.ph"):null,B="";if(q&&q.classList){for(let U=0;U<q.classList.length;U++)if(q.classList[U].indexOf("ph-")===0){B=q.classList[U];break}}o.index.push({id:H,title:L,category:I,categorySlug:u(I),content:C,keywords:k,url:"#"+H,icon:B})})}function l(){let x={},_="Documentation";return document.querySelectorAll(s.navSelector+", "+s.sectionSelector).forEach(function(H){if(H.classList.contains("doc-nav-section"))_=H.textContent.trim();else{let z=H.getAttribute("href");if(z&&z.startsWith("#")){let L=z.substring(1);x[L]=_}}}),x}function h(x){let _=x.cloneNode(!0);_.querySelectorAll(s.excludeFromContent).forEach(function(z){z.remove()});let H=_.textContent||"";return H=H.replace(/\s+/g," ").trim(),H.substring(0,s.maxContentLength)}function f(x,_){let M=[];return _.toLowerCase().split(/\s+/).forEach(function(L){L.length>2&&M.push(L)}),x.querySelectorAll("code").forEach(function(L){let C=(L.textContent||"").match(/\.([\w-]+)/g);C&&C.forEach(function(k){M.push(k.substring(1).toLowerCase())})}),x.querySelectorAll("[data-tooltip], [data-modal]").forEach(function(L){L.getAttributeNames().filter(function(C){return C.startsWith("data-")}).forEach(function(C){M.push(C.replace("data-",""))})}),Array.from(new Set(M))}function d(x){return x.toLowerCase().split(/\s+/).filter(function(M){return M.length>2})}function u(x){return x.toLowerCase().replace(/\s+/g,"-").replace(/[^a-z0-9-]/g,"")}function m(){o.boundHandlers.handleInput=function(x){S(x)},o.boundHandlers.handleFocus=function(){o.query.length>=s.minQueryLength&&G()},o.boundHandlers.handleKeydown=function(x){w(x)},o.boundHandlers.handleOutsideClick=function(x){o.container.contains(x.target)||K()},o.boundHandlers.handleGlobalKeydown=function(x){s.keyboardShortcut&&(x.metaKey||x.ctrlKey)&&x.key==="k"&&(x.preventDefault(),o.input.focus(),o.input.select())},o.boundHandlers.handleResultClick=function(x){let _=x.target.closest(".vd-doc-search-result");if(_){let M=parseInt(_.dataset.index,10);O(M)}},o.input.addEventListener("input",o.boundHandlers.handleInput),o.input.addEventListener("focus",o.boundHandlers.handleFocus),o.input.addEventListener("keydown",o.boundHandlers.handleKeydown),document.addEventListener("click",o.boundHandlers.handleOutsideClick),document.addEventListener("keydown",o.boundHandlers.handleGlobalKeydown),o.resultsContainer.addEventListener("click",o.boundHandlers.handleResultClick)}function y(){o.input&&(o.input.removeEventListener("input",o.boundHandlers.handleInput),o.input.removeEventListener("focus",o.boundHandlers.handleFocus),o.input.removeEventListener("keydown",o.boundHandlers.handleKeydown)),document.removeEventListener("click",o.boundHandlers.handleOutsideClick),document.removeEventListener("keydown",o.boundHandlers.handleGlobalKeydown),o.resultsContainer&&o.resultsContainer.removeEventListener("click",o.boundHandlers.handleResultClick)}function T(){let x=o.resultsContainer.id||"search-results-"+Math.random().toString(36).substr(2,9);o.resultsContainer.id=x,o.input.setAttribute("role","combobox"),o.input.setAttribute("aria-autocomplete","list"),o.input.setAttribute("aria-controls",x),o.input.setAttribute("aria-expanded","false"),o.resultsContainer.setAttribute("role","listbox"),o.resultsContainer.setAttribute("aria-label","Search results")}function S(x){let _=x.target.value.trim();o.debounceTimer&&clearTimeout(o.debounceTimer),o.debounceTimer=setTimeout(function(){if(o.query=_,_.length<s.minQueryLength){K();return}o.results=P(_),o.activeIndex=-1,g(),G(),typeof s.onSearch=="function"&&i("onSearch",s.onSearch,_,o.results)},s.debounceMs)}function w(x){if(!o.isOpen){x.key==="ArrowDown"&&o.query.length>=s.minQueryLength&&(x.preventDefault(),o.results=P(o.query),g(),G());return}switch(x.key){case"ArrowDown":x.preventDefault(),b(1);break;case"ArrowUp":x.preventDefault(),b(-1);break;case"Enter":x.preventDefault(),o.activeIndex>=0?O(o.activeIndex):o.results.length>0&&O(0);break;case"Escape":x.preventDefault(),K();break;case"Tab":K();break}}function P(x){let _=x.toLowerCase().split(/\s+/).filter(function(H){return H.length>0}),M=[];return o.index.forEach(function(H){let z=0,L=H.title.toLowerCase(),I=H.category.toLowerCase(),C=H.content.toLowerCase();_.forEach(function(k){L.includes(k)&&(z+=100,L===k?z+=50:L.startsWith(k)&&(z+=25)),I.includes(k)&&(z+=50),H.keywords.some(function(B){return B.includes(k)})&&(z+=30),C.includes(k)&&(z+=10)}),z>0&&M.push({id:H.id,title:H.title,category:H.category,categorySlug:H.categorySlug,content:H.content,url:H.url,icon:H.icon,score:z})}),M.sort(function(H,z){return z.score-H.score}),M.slice(0,s.maxResults)}function g(){if(o.results.length===0){a(E());return}let x='<ul class="vd-doc-search-results-list" role="listbox">';o.results.forEach(function(_,M){let H=M===o.activeIndex,z=_.icon||A(_.categorySlug),L=D(_.content,o.query);x+='<li class="vd-doc-search-result'+(H?" is-active":"")+'" role="option" id="vd-doc-search-result-'+M+'" data-index="'+M+'" data-category="'+V(_.categorySlug)+'" aria-selected="'+H+'"><div class="vd-doc-search-result-icon"><i class="ph '+V(z)+'"></i></div><div class="vd-doc-search-result-content"><div class="vd-doc-search-result-title">'+R(_.title,o.query)+'</div><div class="vd-doc-search-result-category">'+V(_.category)+'</div><div class="vd-doc-search-result-excerpt">'+R(L,o.query)+"</div></div></li>"}),x+="</ul>",x+=v(),a(x)}function E(){return'<div class="vd-doc-search-empty"><div class="vd-doc-search-empty-icon"><i class="ph ph-magnifying-glass"></i></div><div class="vd-doc-search-empty-title">'+V(s.emptyTitle)+'</div><div class="vd-doc-search-empty-text">'+V(s.emptyText)+"</div></div>"}function v(){return'<div class="vd-doc-search-footer"><span class="vd-doc-search-footer-item"><kbd>\u2191</kbd><kbd>\u2193</kbd> to navigate</span><span class="vd-doc-search-footer-item"><kbd>\u21B5</kbd> to select</span><span class="vd-doc-search-footer-item"><kbd>esc</kbd> to close</span></div>'}function A(x){return s.categoryIcons[x]||s.categoryIcons.default||"ph-file-text"}function D(x,_){let M=_.toLowerCase().split(/\s+/),H=x.toLowerCase(),z=100,L=-1;for(let q=0;q<M.length;q++){let B=H.indexOf(M[q]);B!==-1&&(L===-1||B<L)&&(L=B)}if(L===-1)return x.substring(0,z)+"...";let I=Math.max(0,L-30),C=Math.min(x.length,L+z),k=x.substring(I,C);return I>0&&(k="..."+k),C<x.length&&(k=k+"..."),k}function R(x,_){if(!_)return V(x);let M=_.toLowerCase().split(/\s+/).filter(function(z){return z.length>0}),H=V(x);return M.forEach(function(z){if(z.length>50)return;let L=new RegExp("("+z.replace(/[.*+?^${}()|[\]\\]/g,"\\$&")+")","gi");H=H.replace(L,"<"+s.highlightTag+">$1</"+s.highlightTag+">")}),H}function V(x){let _=document.createElement("div");return _.textContent=x,_.innerHTML}function b(x){let _=o.activeIndex+x;_<0?_=o.results.length-1:_>=o.results.length&&(_=0),N(_)}function N(x){let _=o.resultsContainer.querySelector(".vd-doc-search-result.is-active");_&&(_.classList.remove("is-active"),_.setAttribute("aria-selected","false")),o.activeIndex=x;let M=o.resultsContainer.querySelector('[data-index="'+x+'"]');M&&(M.classList.add("is-active"),M.setAttribute("aria-selected","true"),o.input.setAttribute("aria-activedescendant","vd-doc-search-result-"+x),M.scrollIntoView({block:"nearest"}))}function O(x){let _=o.results[x];if(!_)return;if(K(),o.input.value="",o.query="",typeof s.onSelect=="function"){i("onSelect",s.onSelect,_);return}let M=document.querySelector(_.url);M&&(M.scrollIntoView({behavior:"smooth",block:"start"}),window.history.pushState(null,"",_.url),F(_.id))}function F(x){document.querySelectorAll(s.navSelector).forEach(function(M){M.classList.remove("active"),M.getAttribute("href")==="#"+x&&M.classList.add("active")})}function G(){o.isOpen||(o.isOpen=!0,o.resultsContainer.classList.add("is-open"),o.input.setAttribute("aria-expanded","true"),typeof s.onOpen=="function"&&i("onOpen",s.onOpen))}function K(){o.isOpen&&(o.isOpen=!1,o.activeIndex=-1,o.resultsContainer.classList.remove("is-open"),o.input.setAttribute("aria-expanded","false"),o.input.removeAttribute("aria-activedescendant"),typeof s.onClose=="function"&&i("onClose",s.onClose))}function ae(){y(),o.initialized=!1,o.index=[],o.results=[],o.isOpen=!1,o.query="",o.debounceTimer&&clearTimeout(o.debounceTimer),o.resultsContainer&&a("")}function te(){c()}function oe(x){Object.assign(s,x)}function re(){return Object.assign({},s)}function j(){return o.index.slice()}let Z={init:r,destroy:ae,rebuild:te,search:P,open:G,close:K,setConfig:oe,getConfig:re,getIndex:j};return Z}let t={create:function(n){let s=e(n);return s&&s.init(),s||null},_instance:null,config:Object.assign({},p),init:function(n){return this._instance&&this._instance.destroy(),n&&Object.assign(this.config,n),this._instance=e(this.config),this._instance?this._instance.init():null},destroy:function(){this._instance&&(this._instance.destroy(),this._instance=null)},destroyAll:function(){this.destroy()},rebuild:function(){this._instance&&this._instance.rebuild()},search:function(n){return this._instance?this._instance.search(n):[]},open:function(){this._instance&&this._instance.open()},close:function(){this._instance&&this._instance.close()}};typeof window.Vanduo<"u"&&window.Vanduo.register("docSearch",t),window.Search=t,window.DocSearch=t,window.VanduoDocSearch=t})();(function(){"use strict";let p={instances:new Map,currentDrag:null,touchState:null,feedbackElement:null,containerSelector:".vd-draggable-container, .vd-draggable-container-vertical",init:function(){document.querySelectorAll(".vd-draggable, [data-draggable]").forEach(s=>{this.instances.has(s)||this.initDraggable(s)}),document.querySelectorAll(this.containerSelector).forEach(s=>{this.instances.has(s)||this.initContainer(s)}),document.querySelectorAll(".vd-drop-zone").forEach(s=>{this.instances.has(s)||this.initDropZone(s)}),this.createFeedbackElement()},initDraggable:function(e){let t=[];e.hasAttribute("draggable")||e.setAttribute("draggable","true"),e.hasAttribute("tabindex")||e.setAttribute("tabindex","0"),e.setAttribute("role","option"),e.setAttribute("aria-roledescription","draggable item"),e.setAttribute("aria-grabbed","false");let n=h=>{this.handleDragStart(h,e)};e.addEventListener("dragstart",n),t.push(()=>e.removeEventListener("dragstart",n));let s=h=>{this.handleDrag(h,e)};e.addEventListener("drag",s),t.push(()=>e.removeEventListener("drag",s));let o=h=>{this.handleDragEnd(h,e)};e.addEventListener("dragend",o),t.push(()=>e.removeEventListener("dragend",o));let i=h=>{this.handleTouchStart(h,e)};e.addEventListener("touchstart",i),t.push(()=>e.removeEventListener("touchstart",i));let a=h=>{this.handleTouchMove(h,e)};e.addEventListener("touchmove",a,{passive:!1}),t.push(()=>e.removeEventListener("touchmove",a));let r=h=>{this.handleTouchEnd(h,e)};e.addEventListener("touchend",r,{passive:!1}),t.push(()=>e.removeEventListener("touchend",r));let c=h=>{this.handleTouchEnd(h,e)};e.addEventListener("touchcancel",c),t.push(()=>e.removeEventListener("touchcancel",c));let l=h=>{this.handleKeydown(h,e)};e.addEventListener("keydown",l),t.push(()=>e.removeEventListener("keydown",l)),this.instances.set(e,{cleanup:t})},initContainer:function(e){e.setAttribute("role","listbox"),e.setAttribute("aria-label",e.getAttribute("aria-label")||"Draggable items"),e.querySelectorAll(".vd-draggable-item").forEach(a=>{this.instances.has(a)||this.initDraggable(a)});let n=[],s=a=>{a.preventDefault(),a.dataTransfer.dropEffect="move"},o=a=>{if(a.preventDefault(),a.dataTransfer.dropEffect="move",!this.currentDrag)return;let r=this.currentDrag.element;e.contains(r)&&(a.clientX===0&&a.clientY===0||this.handleReorder(e,r,a.clientX,a.clientY))},i=a=>{a.preventDefault()};e.addEventListener("dragenter",s),e.addEventListener("dragover",o),e.addEventListener("drop",i),n.push(()=>{e.removeEventListener("dragenter",s),e.removeEventListener("dragover",o),e.removeEventListener("drop",i)}),this.instances.set(e,{cleanup:n})},initDropZone:function(e){let t=[];e.setAttribute("role","region"),e.setAttribute("aria-dropeffect","move"),e.hasAttribute("aria-label")||e.setAttribute("aria-label","Drop zone");let n=a=>{a.preventDefault(),this.handleDragOver(a,e)};e.addEventListener("dragover",n),t.push(()=>e.removeEventListener("dragover",n));let s=a=>{a.preventDefault(),this.handleDragEnter(a,e)};e.addEventListener("dragenter",s),t.push(()=>e.removeEventListener("dragenter",s));let o=a=>{this.handleDragLeave(a,e)};e.addEventListener("dragleave",o),t.push(()=>e.removeEventListener("dragleave",o));let i=a=>{a.preventDefault(),this.handleDrop(a,e)};e.addEventListener("drop",i),t.push(()=>e.removeEventListener("drop",i)),this.instances.set(e,{cleanup:t})},createFeedbackElement:function(){if(!this.feedbackElement){let e=document.querySelector(".vd-drag-feedback");if(e){this.feedbackElement=e;return}this.feedbackElement=document.createElement("div"),this.feedbackElement.className="vd-drag-feedback hidden",this.feedbackElement.setAttribute("role","presentation"),document.body.appendChild(this.feedbackElement)}},handleDragStart:function(e,t){t.classList.add("is-dragging"),t.setAttribute("aria-grabbed","true"),this.currentDrag={element:t,initialPosition:{x:e.clientX,y:e.clientY},initialBounds:t.getBoundingClientRect(),data:this.getData(t)},e.dataTransfer.effectAllowed="move",e.dataTransfer.setData("text/plain",this.currentDrag.data),t.dispatchEvent(new CustomEvent("draggable:start",{bubbles:!0,detail:{element:t,data:this.currentDrag.data,position:{x:e.clientX,y:e.clientY}}}))},handleDrag:function(e,t){this.currentDrag&&t.dispatchEvent(new CustomEvent("draggable:drag",{bubbles:!0,detail:{element:t,data:this.currentDrag.data,position:{x:e.clientX,y:e.clientY},delta:{x:e.clientX-this.currentDrag.initialPosition.x,y:e.clientY-this.currentDrag.initialPosition.y}}}))},handleDragEnd:function(e,t){t.classList.remove("is-dragging"),t.classList.add("is-dropped"),setTimeout(()=>t.classList.remove("is-dropped"),300),t.setAttribute("aria-grabbed","false"),this.feedbackElement&&this.feedbackElement.classList.add("hidden");let n=this.currentDrag?.data||this.getData(t),s=this.currentDrag?.initialPosition||{x:0,y:0};t.dispatchEvent(new CustomEvent("draggable:end",{bubbles:!0,detail:{element:t,data:n,position:{x:e.clientX,y:e.clientY},delta:{x:e.clientX-s.x,y:e.clientY-s.y}}})),this.currentDrag=null},handleTouchStart:function(e,t){let n=e.touches[0],s=t.getBoundingClientRect();this.touchState={element:t,startX:n.clientX,startY:n.clientY,lastX:n.clientX,lastY:n.clientY,offsetX:n.clientX-s.left,offsetY:n.clientY-s.top,startTime:Date.now(),isDragging:!1}},handleTouchMove:function(e,t){if(!this.touchState)return;let n=e.touches[0];this.touchState.lastX=n.clientX,this.touchState.lastY=n.clientY;let s=n.clientX-this.touchState.startX,o=n.clientY-this.touchState.startY;if((Math.abs(s)>10||Math.abs(o)>10)&&(e.cancelable&&e.preventDefault(),this.touchState.isDragging||(this.touchState.isDragging=!0,t.classList.add("is-dragging"),t.setAttribute("aria-grabbed","true"),this.currentDrag={element:t,initialPosition:{x:this.touchState.startX,y:this.touchState.startY},initialBounds:t.getBoundingClientRect(),data:this.getData(t),offsetX:this.touchState.offsetX,offsetY:this.touchState.offsetY},t.dispatchEvent(new CustomEvent("draggable:start",{bubbles:!0,detail:{element:t,data:this.currentDrag.data,position:{x:n.clientX,y:n.clientY}}}))),this.updateFeedback(n.clientX,n.clientY),this.currentDrag)){t.dispatchEvent(new CustomEvent("draggable:drag",{bubbles:!0,detail:{element:t,data:this.currentDrag.data,position:{x:n.clientX,y:n.clientY},delta:{x:s,y:o}}})),this.updateTouchDropZone(n.clientX,n.clientY);let i=t.closest(this.containerSelector);i&&i.contains(t)&&this.handleReorder(i,t,n.clientX,n.clientY)}},handleTouchEnd:function(e,t){if(this.touchState&&this.touchState.isDragging){e.cancelable&&e.preventDefault();let n=e.changedTouches?.[0],s={x:n?.clientX??this.touchState.lastX??this.touchState.startX,y:n?.clientY??this.touchState.lastY??this.touchState.startY},o=this.resolveDropZoneAtPoint(s.x,s.y)||this.touchState.overZone;o?this.dispatchDrop(o,s):this.touchState.overZone&&this.touchState.overZone.classList.remove("is-drag-over"),t.classList.remove("is-dragging"),t.classList.add("is-dropped"),t.setAttribute("aria-grabbed","false"),setTimeout(()=>t.classList.remove("is-dropped"),300),this.feedbackElement&&this.feedbackElement.classList.add("hidden");let i=this.currentDrag?.data||this.getData(t),a=this.touchState?.startX||0,r=this.touchState?.startY||0;t.dispatchEvent(new CustomEvent("draggable:end",{bubbles:!0,detail:{element:t,data:i,position:s,delta:{x:s.x-a,y:s.y-r}}}))}this.touchState=null,this.currentDrag=null},handleDragOver:function(e,t){e.preventDefault(),e.dataTransfer.dropEffect="move"},handleDragEnter:function(e,t){e.preventDefault(),t.classList.add("is-drag-over")},handleDragLeave:function(e,t){t.classList.remove("is-drag-over")},handleDrop:function(e,t){e.preventDefault(),this.dispatchDrop(t,{x:e.clientX,y:e.clientY})},resolveDropZoneAtPoint:function(e,t){if(!Number.isFinite(e)||!Number.isFinite(t))return null;if(typeof document.elementsFromPoint=="function"){let i=document.elementsFromPoint(e,t);for(let a of i){let r=a.closest(".vd-drop-zone");if(r)return r}}let n=document.elementFromPoint(e,t),s=n?n.closest(".vd-drop-zone"):null;if(s)return s;let o=document.querySelectorAll(".vd-drop-zone");for(let i of o){let a=i.getBoundingClientRect();if(e>=a.left&&e<=a.right&&t>=a.top&&t<=a.bottom)return i}return null},updateTouchDropZone:function(e,t){if(!this.touchState)return;let n=this.resolveDropZoneAtPoint(e,t),s=this.touchState.overZone||null;s&&s!==n&&s.classList.remove("is-drag-over"),n&&n!==s&&n.classList.add("is-drag-over"),this.touchState.overZone=n||null},dispatchDrop:function(e,t){e.classList.remove("is-drag-over"),e.dispatchEvent(new CustomEvent("draggable:drop",{bubbles:!0,detail:{zone:e,element:this.currentDrag?.element,data:this.currentDrag?.data,position:t}}))},handleReorder:function(e,t,n,s){let o=e.classList.contains("vd-draggable-container-vertical"),a=[...e.querySelectorAll(".vd-draggable-item:not(.is-dragging), .vd-draggable:not(.is-dragging)")].reduce((r,c)=>{let l=c.getBoundingClientRect(),h=o?s-l.top-l.height/2:n-l.left-l.width/2;return h<0&&h>r.offset?{offset:h,element:c}:r},{offset:Number.NEGATIVE_INFINITY}).element;a==null?e.appendChild(t):e.insertBefore(t,a)},handleKeydown:function(e,t){switch(e.key){case"Enter":case" ":e.preventDefault(),t.click();break;case"Escape":t.classList.contains("is-dragging")&&(t.classList.remove("is-dragging"),t.setAttribute("aria-grabbed","false"),this.feedbackElement&&this.feedbackElement.classList.add("hidden"),this.currentDrag=null);break;case"ArrowUp":case"ArrowLeft":{e.preventDefault();let n=t.previousElementSibling;n&&(n.classList.contains("vd-draggable")||n.classList.contains("vd-draggable-item"))&&(t.parentNode.insertBefore(t,n),t.focus(),t.dispatchEvent(new CustomEvent("draggable:reorder",{bubbles:!0,detail:{element:t,direction:"up"}})));break}case"ArrowDown":case"ArrowRight":{e.preventDefault();let n=t.nextElementSibling;n&&(n.classList.contains("vd-draggable")||n.classList.contains("vd-draggable-item"))&&(t.parentNode.insertBefore(n,t),t.focus(),t.dispatchEvent(new CustomEvent("draggable:reorder",{bubbles:!0,detail:{element:t,direction:"down"}})));break}}},getData:function(e){return e.dataset.draggable||e.textContent.trim()},updateFeedback:function(e,t){if(!this.currentDrag)return;this.feedbackElement.classList.remove("hidden");let n=this.currentDrag.initialBounds;this.feedbackElement.innerHTML="";let s=this.currentDrag.element.cloneNode(!0);this.feedbackElement.appendChild(s);let o=this.currentDrag.offsetX??20,i=this.currentDrag.offsetY??20;Object.assign(this.feedbackElement.style,{left:e-o+"px",top:t-i+"px",width:n.width+"px",height:n.height+"px"})},makeDraggable:function(e,t={}){let n=typeof e=="string"?document.querySelector(e):e;n&&!this.instances.has(n)&&(n.classList.add("vd-draggable"),n.setAttribute("draggable","true"),t.data&&(n.dataset.draggable=t.data),this.initDraggable(n))},removeDraggable:function(e){let t=typeof e=="string"?document.querySelector(e):e;t&&this.instances.has(t)&&(this.instances.get(t).cleanup.forEach(s=>s()),this.instances.delete(t),t.classList.remove("vd-draggable"),t.removeAttribute("draggable"),t.removeAttribute("data-draggable"))},destroy:function(e){this.removeDraggable(e)},destroyAll:function(){Array.from(this.instances.keys()).forEach(t=>this.destroy(t))}};typeof window.Vanduo<"u"&&window.Vanduo.register("draggable",p),window.VanduoDraggable=p})();(function(){"use strict";let p=new Map;function e(r){try{return new URL(r,window.location.href).origin===window.location.origin}catch{return!1}}function t(r,c){let h=new DOMParser().parseFromString(c.trim(),"text/html"),f=["SCRIPT","IFRAME","OBJECT","EMBED","FORM","BASE","LINK","META","STYLE"];for(let m of f){let y=h.querySelectorAll(m);for(let T=y.length-1;T>=0;T--)y[T].parentNode.removeChild(y[T])}function d(m){if(m.nodeType===Node.ELEMENT_NODE){let y=m.attributes;for(let S=y.length-1;S>=0;S--){let w=y[S].name.toLowerCase(),g=y[S].value.toLowerCase().trim();(w.startsWith("on")||g.startsWith("javascript:")||g.startsWith("data:")||g.startsWith("vbscript:"))&&m.removeAttribute(y[S].name)}let T=m.childNodes;for(let S=0;S<T.length;S++)d(T[S])}}d(h.body);let u=Array.from(h.body.childNodes);for(;r.firstChild;)r.removeChild(r.firstChild);u.forEach(function(m){r.appendChild(document.adoptNode(m))})}function n(){return'<div class="vd-skeleton-card" style="position:relative;min-height:200px;padding:2rem;overflow:hidden;"><div class="vd-skeleton vd-skeleton-heading-lg" style="margin-bottom:1.5rem;"></div><div class="vd-skeleton vd-skeleton-paragraph"><div class="vd-skeleton vd-skeleton-text"></div><div class="vd-skeleton vd-skeleton-text"></div><div class="vd-skeleton vd-skeleton-text"></div></div><div class="vd-dynamic-loader" style="position:absolute;inset:0;"><div class="vd-dynamic-loader-grid"><div class="vd-spinner vd-spinner-sm vd-spinner-success" style="animation-delay:0s;"></div><div class="vd-spinner vd-spinner-sm vd-spinner-warning" style="animation-delay:-0.15s;"></div><div class="vd-spinner vd-spinner-sm vd-spinner-error" style="animation-delay:-0.3s;"></div><div class="vd-spinner vd-spinner-sm vd-spinner-info" style="animation-delay:-0.45s;"></div></div><span class="vd-dynamic-loader-text">Loading\u2026</span></div></div>'}function s(){return'<div class="vd-dynamic-loader" style="min-height:180px;display:flex;align-items:center;justify-content:center;"><div class="vd-dynamic-loader-grid"><div class="vd-spinner vd-spinner-sm vd-spinner-success" style="animation-delay:0s;"></div><div class="vd-spinner vd-spinner-sm vd-spinner-warning" style="animation-delay:-0.15s;"></div><div class="vd-spinner vd-spinner-sm vd-spinner-error" style="animation-delay:-0.3s;"></div><div class="vd-spinner vd-spinner-sm vd-spinner-info" style="animation-delay:-0.45s;"></div></div><span class="vd-dynamic-loader-text">Loading\u2026</span></div>'}function o(r){return!r||r==="skeleton"?n():r==="spinner"?s():r}function i(r,c,l){r.dispatchEvent(new CustomEvent(c,{bubbles:!0,detail:l||{}}))}let a={observe:function(r,c,l){if(!(r instanceof Element)){console.warn("[VanduoLazyLoad] observe() requires a DOM Element.");return}if(typeof c!="function"){console.warn("[VanduoLazyLoad] observe() requires a callback function.");return}if(p.has(r))return;let h=l&&l.threshold!=null?l.threshold:0,f=l&&l.rootMargin?l.rootMargin:"0px",d=new IntersectionObserver(function(u,m){u.forEach(function(y){if(y.isIntersecting){m.unobserve(y.target),p.delete(y.target);try{c(y.target)}catch(T){console.error("[VanduoLazyLoad] Callback threw:",T)}}})},{threshold:h,rootMargin:f});p.set(r,d),d.observe(r)},unobserve:function(r){let c=p.get(r);c&&(c.unobserve(r),p.delete(r))},unobserveAll:function(){p.forEach(function(r,c){r.unobserve(c)}),p.clear()},loadSection:function(r,c,l){if(typeof r!="string"||!r){console.warn("[VanduoLazyLoad] loadSection() requires a non-empty URL string.");return}if(!(c instanceof Element)){console.warn("[VanduoLazyLoad] loadSection() requires a DOM Element as containerEl.");return}if(!e(r)){console.error("[VanduoLazyLoad] loadSection() blocked cross-origin URL:",r);return}let h=l||{},f=o(h.placeholder);t(c,f),i(c,"lazysection:loading",{url:r}),this.observe(c,function(){let d=new window.AbortController,u=setTimeout(function(){d.abort()},1e4);window.fetch(r,{signal:d.signal}).then(function(m){if(clearTimeout(u),!m.ok)throw new Error("HTTP "+m.status);return m.text()}).then(function(m){t(c,m),i(c,"lazysection:loaded",{url:r}),typeof window.Vanduo<"u"&&window.Vanduo.init(),typeof h.onLoaded=="function"&&h.onLoaded(c)}).catch(function(m){let y=document.createElement("div");y.className="vd-alert vd-alert-error",y.setAttribute("role","alert");let T=document.createElement("span");T.textContent="Failed to load content. ";let S=document.createElement("small");for(S.style.opacity="0.7",S.textContent=m.message,y.appendChild(T),y.appendChild(S);c.firstChild;)c.removeChild(c.firstChild);c.appendChild(y),i(c,"lazysection:error",{url:r,error:m}),console.error("[VanduoLazyLoad] loadSection failed:",m),typeof h.onError=="function"&&h.onError(m)})},{threshold:h.threshold,rootMargin:h.rootMargin})},init:function(){let r=this;document.querySelectorAll("[data-vd-lazy]").forEach(function(l){if(p.has(l)||l.dataset.vdLazyState==="loading"||l.dataset.vdLazyState==="loaded")return;let h=l.getAttribute("data-vd-lazy");if(!h)return;l.dataset.vdLazyState="loading";let f=l.getAttribute("data-vd-lazy-placeholder")||"skeleton";r.loadSection(h,l,{placeholder:f,onLoaded:function(){l.dataset.vdLazyState="loaded"},onError:function(){l.dataset.vdLazyState="error"}})})}};typeof window.Vanduo<"u"&&window.Vanduo.register("LazyLoad",a),window.VanduoLazyLoad=a})();(function(){"use strict";let p={observers:new Map,init:function(){document.querySelectorAll("[data-glass-scroll]").forEach(e=>{this.observers.has(e)||this.initElement(e)})},initElement:function(e){let t=e.dataset.glassSentinel,n;if(t&&(n=document.querySelector(t)),n||(n=e.previousElementSibling),!n){e.classList.add("is-glass-active");return}let s=new IntersectionObserver(o=>{o.forEach(i=>{e.classList.toggle("is-glass-active",!i.isIntersecting)})},{threshold:0,rootMargin:"0px"});s.observe(n),this.observers.set(e,s)},destroy:function(e){let t=this.observers.get(e);t&&(t.disconnect(),this.observers.delete(e))},destroyAll:function(){this.observers.forEach((e,t)=>this.destroy(t))}};typeof window.Vanduo<"u"&&window.Vanduo.register("glassScroll",p),window.VanduoGlassScroll=p})();(function(){"use strict";let e={instances:new Map,init:function(){document.querySelectorAll(".vd-morph, [data-vd-morph]").forEach(function(n){e.instances.has(n)||n.getAttribute("data-vd-morph")!=="manual"&&e.initInstance(n)})},initInstance:function(t){e._ensureLayers(t);let n=[],s=!1,o=function(i){s||(e._runMorph(t,i,function(){s=!1}),s=!0)};t.addEventListener("click",o),n.push(function(){t.removeEventListener("click",o)}),this.instances.set(t,{cleanup:n})},morph:function(t){t&&(this.instances.has(t)||this.initInstance(t),this._runMorph(t,null,null))},destroy:function(t){let n=this.instances.get(t);n&&(n.cleanup.forEach(function(s){s()}),this.instances.delete(t))},destroyAll:function(){this.instances.forEach(function(t,n){e.destroy(n)})},_ensureLayers:function(t){if(!t.querySelector(".vd-morph-wave")){let n=document.createElement("span");n.className="vd-morph-wave",n.setAttribute("aria-hidden","true"),t.insertBefore(n,t.firstChild)}if(!t.querySelector(".vd-morph-shine")){let n=document.createElement("span");n.className="vd-morph-shine",n.setAttribute("aria-hidden","true");let s=t.querySelector(".vd-morph-wave");s&&s.nextSibling?t.insertBefore(n,s.nextSibling):t.insertBefore(n,t.firstChild)}},_runMorph:function(t,n,s){let o=t.querySelector(".vd-morph-wave");if(o){let r=t.getBoundingClientRect(),c=r.left+r.width/2,l=r.top+r.height/2,h=n&&n.clientX||c,f=n&&n.clientY||l;o.style.left=h-r.left+"px",o.style.top=f-r.top+"px"}t.classList.add("is-morphing");let i=750,a=getComputedStyle(t).getPropertyValue("--morph-duration");if(a){let r=parseFloat(a);isNaN(r)||(i=r*(a.indexOf("ms")!==-1?1:1e3))}setTimeout(function(){t.classList.remove("is-morphing");let r=t.querySelector(".vd-morph-current"),c=t.querySelector(".vd-morph-next");r&&c&&(r.classList.remove("vd-morph-current"),r.classList.add("vd-morph-next"),c.classList.remove("vd-morph-next"),c.classList.add("vd-morph-current")),typeof s=="function"&&s()},i)}};typeof window.Vanduo<"u"&&window.Vanduo.register("morph",e),window.VanduoMorph=e})();(function(){"use strict";let p={instances:new Map,init:function(){document.querySelectorAll(".vd-expanding-cards").forEach(function(e){e.getAttribute("data-vd-expanding-cards")!=="manual"&&(p.instances.has(e)||p.initContainer(e))})},initContainer:function(e){let t=[],n=function(){return Array.prototype.slice.call(e.querySelectorAll(".vd-expanding-card"))},s=function(c){let l=n();!c||l.indexOf(c)===-1||(l.forEach(function(h){h.classList.toggle("is-active",h===c)}),c.focus({preventScroll:!0}))},o=function(c){let l=c.target,h=l.closest?l.closest(".vd-expanding-card"):null;!h||!e.contains(h)||s(h)},i=function(c){if(c.key!=="ArrowLeft"&&c.key!=="ArrowRight"&&c.key!=="Home"&&c.key!=="End")return;let l=n().filter(function(d){return d.offsetParent!==null||d.getClientRects().length>0});if(!l.length)return;let h=document.activeElement,f=l.indexOf(h);f<0&&(f=l.findIndex(function(d){return d.classList.contains("is-active")})),f<0&&(f=0),c.key==="ArrowLeft"?(c.preventDefault(),s(l[Math.max(0,f-1)])):c.key==="ArrowRight"?(c.preventDefault(),s(l[Math.min(l.length-1,f+1)])):c.key==="Home"?(c.preventDefault(),s(l[0])):c.key==="End"&&(c.preventDefault(),s(l[l.length-1]))};e.addEventListener("click",o),t.push(function(){e.removeEventListener("click",o)}),e.addEventListener("keydown",i),t.push(function(){e.removeEventListener("keydown",i)}),n().forEach(function(c){c.hasAttribute("tabindex")||c.setAttribute("tabindex","0"),c.setAttribute("role","button"),c.hasAttribute("aria-pressed")||c.setAttribute("aria-pressed",c.classList.contains("is-active")?"true":"false")});let a=function(){n().forEach(function(c){c.setAttribute("aria-pressed",c.classList.contains("is-active")?"true":"false")})},r=new MutationObserver(a);r.observe(e,{attributes:!0,subtree:!0,attributeFilter:["class"]}),t.push(function(){r.disconnect()}),a(),p.instances.set(e,{cleanup:t})},destroy:function(e){let t=this.instances.get(e);t&&(t.cleanup.forEach(function(n){n()}),this.instances.delete(e))},destroyAll:function(){this.instances.forEach(function(e,t){p.destroy(t)})}};typeof window.Vanduo<"u"&&window.Vanduo.register("expandingCards",p),window.VanduoExpandingCards=p})();(function(){"use strict";function n(a){let r=0;for(let c=0;c<a.length&&a[c].classList.contains("is-revealed");c++)r++;return r}function s(a){return a.parentElement||document.body}function o(a,r,c){r.forEach(function(E){E.classList.remove("is-revealed")});let l=s(a),h=l.querySelector("[data-vd-timeline-prev]"),f=l.querySelector("[data-vd-timeline-next]"),d=l.querySelector("[data-vd-timeline-play]"),u=l.querySelector("[data-vd-timeline-pause]"),m=null;function y(){let E=n(r),v=r.length;if(h){let A=E===0;h.disabled=A,h.setAttribute("aria-disabled",A?"true":"false")}if(f){let A=E>=v;f.disabled=A,f.setAttribute("aria-disabled",A?"true":"false")}d&&d.setAttribute("aria-pressed",m?"true":"false"),u&&(u.disabled=!m)}function T(){let E=n(r);E<r.length&&r[E].classList.add("is-revealed"),y()}function S(){let E=n(r);E>0&&r[E-1].classList.remove("is-revealed"),y()}function w(){m||(m=setInterval(function(){if(n(r)>=r.length){P();return}T()},800),y())}function P(){m&&(clearInterval(m),m=null),y()}function g(E,v){if(!E)return;let A=function(D){D.preventDefault(),v()};E.addEventListener("click",A),c.push(function(){E.removeEventListener("click",A)})}return g(h,S),g(f,T),g(d,w),g(u,P),c.push(function(){P()}),y(),{stepNext:T,stepPrev:S,play:w,pause:P}}let i={instances:new Map,init:function(){document.querySelectorAll(".vd-timeline.vd-timeline-animated").forEach(function(a){i.instances.has(a)||i.initInstance(a)})},reinit:function(){i.destroyAll(),i.init()},initInstance:function(a){let r=[],c=Array.prototype.filter.call(a.children,function(d){return d.classList&&d.classList.contains("vd-timeline-item")});if(c.forEach(function(d,u){let m=Math.min(u,7);d.style.setProperty("--vd-timeline-reveal-delay",m*140+"ms")}),typeof window.matchMedia=="function"&&window.matchMedia("(prefers-reduced-motion: reduce)").matches){c.forEach(function(d){d.classList.add("is-revealed")}),i.instances.set(a,{cleanup:r});return}if(a.classList&&a.classList.contains("vd-timeline-playback")){let d=o(a,c,r);i.instances.set(a,{cleanup:r,playback:d});return}if(typeof IntersectionObserver>"u"){c.forEach(function(d){d.classList.add("is-revealed")}),i.instances.set(a,{cleanup:r});return}let f=new IntersectionObserver(function(d){d.forEach(function(u){u.isIntersecting&&(u.target.classList.add("is-revealed"),f.unobserve(u.target))})},{root:null,rootMargin:"0px 0px -10% 0px",threshold:.15});c.forEach(function(d){f.observe(d)}),r.push(function(){f.disconnect()}),i.instances.set(a,{cleanup:r})},destroy:function(a){let r=this.instances.get(a);r&&(r.cleanup.forEach(function(c){c()}),this.instances.delete(a))},destroyAll:function(){this.instances.forEach(function(a,r){i.destroy(r)})}};typeof window.Vanduo<"u"&&window.Vanduo.register("timeline",i),window.VanduoTimeline=i})();(function(){"use strict";let p={instances:new Map,init:function(){document.querySelectorAll(".vd-flow, .vd-carousel").forEach(t=>{this.instances.has(t)||this.initInstance(t)})},initInstance:function(e){let t=e.querySelector(".vd-flow-track");if(!t)return;let n=Array.from(t.querySelectorAll(".vd-flow-slide"));if(n.length===0)return;let s=e.classList.contains("vd-flow-fade"),o=e.hasAttribute("data-vd-autoplay"),i=parseInt(e.getAttribute("data-vd-interval"),10)||5e3,a=e.getAttribute("data-vd-loop")!=="false",r={current:0,total:n.length,autoplayTimer:null,isFade:s,loop:a,isDragging:!1,startX:0,currentX:0,threshold:50},c=[];n.forEach((v,A)=>{v.setAttribute("role","group"),v.setAttribute("aria-roledescription","slide"),v.setAttribute("aria-label","Slide "+(A+1)+" of "+n.length),A===0&&v.classList.add("is-active")}),e.setAttribute("role","region"),e.setAttribute("aria-roledescription","carousel"),e.getAttribute("aria-label")||e.setAttribute("aria-label","Carousel");let l=document.createElement("div");l.setAttribute("aria-live","polite"),l.setAttribute("aria-atomic","true"),l.className="sr-only",l.style.cssText="position:absolute;width:1px;height:1px;overflow:hidden;clip:rect(0,0,0,0);",e.appendChild(l);let h=(v,A)=>{A===void 0&&(A=!0);let D=v;r.loop?D=(v%r.total+r.total)%r.total:D=Math.max(0,Math.min(v,r.total-1));let R=r.current;r.current=D,r.isFade?n.forEach((b,N)=>{b.classList.toggle("is-active",N===D)}):t.style.transform="translateX(-"+D*100+"%)",e.querySelectorAll(".vd-flow-indicator").forEach((b,N)=>{b.classList.toggle("is-active",N===D),b.setAttribute("aria-selected",N===D?"true":"false")}),n.forEach((b,N)=>{b.setAttribute("aria-hidden",N!==D?"true":"false")}),A&&(l.textContent="Slide "+(D+1)+" of "+r.total),e.dispatchEvent(new CustomEvent("flow:change",{detail:{current:D,previous:R,total:r.total}}))},f=()=>h(r.current+1),d=()=>h(r.current-1),u=e.querySelector(".vd-flow-prev"),m=e.querySelector(".vd-flow-next");if(u){let v=()=>d();u.addEventListener("click",v),c.push(()=>u.removeEventListener("click",v))}if(m){let v=()=>f();m.addEventListener("click",v),c.push(()=>m.removeEventListener("click",v))}e.querySelectorAll(".vd-flow-indicator").forEach((v,A)=>{v.setAttribute("role","tab"),v.setAttribute("aria-selected",A===0?"true":"false"),v.setAttribute("aria-label","Go to slide "+(A+1));let D=()=>h(A);v.addEventListener("click",D),c.push(()=>v.removeEventListener("click",D))});let T=v=>{v.key==="ArrowLeft"&&(d(),v.preventDefault()),v.key==="ArrowRight"&&(f(),v.preventDefault())};e.setAttribute("tabindex","0"),e.addEventListener("keydown",T),c.push(()=>e.removeEventListener("keydown",T));let S=v=>{r.isDragging=!0,r.startX=v.clientX||v.touches&&v.touches[0].clientX||0,r.currentX=r.startX,e.classList.add("is-dragging")},w=v=>{r.isDragging&&(r.currentX=v.clientX||v.touches&&v.touches[0].clientX||0)},P=()=>{if(!r.isDragging)return;r.isDragging=!1,e.classList.remove("is-dragging");let v=r.startX-r.currentX;Math.abs(v)>r.threshold&&(v>0?f():d())};e.addEventListener("mousedown",S),e.addEventListener("mousemove",w),e.addEventListener("mouseup",P),e.addEventListener("mouseleave",P),e.addEventListener("touchstart",S,{passive:!0}),e.addEventListener("touchmove",w,{passive:!0}),e.addEventListener("touchend",P),c.push(()=>e.removeEventListener("mousedown",S),()=>e.removeEventListener("mousemove",w),()=>e.removeEventListener("mouseup",P),()=>e.removeEventListener("mouseleave",P),()=>e.removeEventListener("touchstart",S),()=>e.removeEventListener("touchmove",w),()=>e.removeEventListener("touchend",P));let g=()=>{E(),r.autoplayTimer=setInterval(f,i)},E=()=>{r.autoplayTimer&&(clearInterval(r.autoplayTimer),r.autoplayTimer=null)};if(o){g();let v=()=>E(),A=()=>g();e.addEventListener("mouseenter",v),e.addEventListener("mouseleave",A),e.addEventListener("focusin",v),e.addEventListener("focusout",A),c.push(()=>e.removeEventListener("mouseenter",v),()=>e.removeEventListener("mouseleave",A),()=>e.removeEventListener("focusin",v),()=>e.removeEventListener("focusout",A),()=>E())}h(0,!1),this.instances.set(e,{cleanup:c,goTo:h,next:f,prev:d,getState:()=>({...r})})},goTo:function(e,t){let n=this.instances.get(e);n&&n.goTo(t)},next:function(e){let t=this.instances.get(e);t&&t.next()},prev:function(e){let t=this.instances.get(e);t&&t.prev()},destroy:function(e){let t=this.instances.get(e);t&&(t.cleanup.forEach(n=>n()),this.instances.delete(e))},destroyAll:function(){this.instances.forEach((e,t)=>this.destroy(t))}};typeof window.Vanduo<"u"&&window.Vanduo.register("flow",p),window.VanduoFlow=p})();(function(){"use strict";let p={instances:new Map,_globalCleanups:[],init:function(){if(document.querySelectorAll("[data-vd-bubble], [data-vd-popover]").forEach(t=>{this.instances.has(t)||this.initInstance(t)}),this._globalCleanups.length===0){let t=s=>{this.instances.forEach((o,i)=>{!o.popover.contains(s.target)&&!i.contains(s.target)&&this.hide(i)})},n=s=>{s.key==="Escape"&&this.instances.forEach((o,i)=>this.hide(i))};document.addEventListener("click",t,!0),document.addEventListener("keydown",n),this._globalCleanups.push(()=>document.removeEventListener("click",t,!0),()=>document.removeEventListener("keydown",n))}},initInstance:function(e){let t=[],n=e.getAttribute("data-vd-bubble-placement")||e.getAttribute("data-vd-popover-placement")||"bottom",s=document.createElement("div");s.className="vd-bubble-content",s.setAttribute("role","dialog"),s.setAttribute("aria-modal","false"),s.setAttribute("data-placement",n);let o=e.getAttribute("data-vd-bubble-title")||e.getAttribute("data-vd-popover-title"),i=e.getAttribute("data-vd-bubble")||e.getAttribute("data-vd-popover")||"",a=e.getAttribute("data-vd-bubble-html")||e.getAttribute("data-vd-popover-html");if(o){let h=document.createElement("div");h.className="vd-bubble-header";let f=document.createElement("span");f.textContent=o;let d=document.createElement("button");d.className="vd-bubble-close",d.setAttribute("aria-label","Close"),d.innerHTML="&times;",h.appendChild(f),h.appendChild(d),s.appendChild(h);let u=m=>{m.stopPropagation(),this.hide(e)};d.addEventListener("click",u),t.push(()=>d.removeEventListener("click",u))}let r=document.createElement("div");r.className="vd-bubble-body",a?typeof sanitizeHtml=="function"?r.innerHTML=sanitizeHtml(a):r.textContent=a:r.textContent=i,s.appendChild(r),document.body.appendChild(s);let c="vd-bubble-"+Math.random().toString(36).slice(2,9);s.id=c,e.setAttribute("aria-haspopup","dialog"),e.setAttribute("aria-expanded","false"),e.setAttribute("aria-controls",c);let l=h=>{h.stopPropagation(),s.classList.contains("is-visible")?this.hide(e):(this.hideAll(),this.show(e))};e.addEventListener("click",l),t.push(()=>e.removeEventListener("click",l)),this.instances.set(e,{popover:s,cleanup:t,placement:n})},position:function(e,t,n){let s=e.getBoundingClientRect(),o=t.getBoundingClientRect(),i=10,a,r;switch(n){case"top":a=s.top-o.height-i+window.scrollY,r=s.left+(s.width-o.width)/2+window.scrollX;break;case"left":a=s.top+(s.height-o.height)/2+window.scrollY,r=s.left-o.width-i+window.scrollX;break;case"right":a=s.top+(s.height-o.height)/2+window.scrollY,r=s.right+i+window.scrollX;break;default:a=s.bottom+i+window.scrollY,r=s.left+(s.width-o.width)/2+window.scrollX}r=Math.max(8,Math.min(r,window.innerWidth-o.width-8)),a=Math.max(8,a),t.style.top=a+"px",t.style.left=r+"px"},show:function(e){let t=this.instances.get(e);if(!t)return;let{popover:n,placement:s}=t;n.style.display="block",n.classList.add("is-visible"),e.setAttribute("aria-expanded","true"),requestAnimationFrame(()=>{this.position(e,n,s)}),e.dispatchEvent(new CustomEvent("bubble:show",{bubbles:!0}))},hide:function(e){let t=this.instances.get(e);t&&(t.popover.classList.remove("is-visible"),e.setAttribute("aria-expanded","false"),e.dispatchEvent(new CustomEvent("bubble:hide",{bubbles:!0})))},hideAll:function(){this.instances.forEach((e,t)=>this.hide(t))},destroy:function(e){let t=this.instances.get(e);t&&(t.cleanup.forEach(n=>n()),t.popover.parentNode&&t.popover.parentNode.removeChild(t.popover),e.removeAttribute("aria-haspopup"),e.removeAttribute("aria-expanded"),e.removeAttribute("aria-controls"),this.instances.delete(e))},destroyAll:function(){this.instances.forEach((e,t)=>this.destroy(t)),this._globalCleanups.forEach(e=>e()),this._globalCleanups=[]}};typeof window.Vanduo<"u"&&window.Vanduo.register("bubble",p),window.VanduoBubble=p})();(function(){"use strict";let p={instances:new Map,init:function(){document.querySelectorAll("[data-vd-waypoint-nav], [data-vd-scrollspy-nav]").forEach(t=>{this.instances.has(t)||this.initInstance(t)})},initInstance:function(e){let t=Array.from(e.querySelectorAll('a[href^="#"]'));if(t.length===0)return;let n=[],s=parseInt(e.getAttribute("data-vd-waypoint-offset")||"80",10),o=[];if(t.forEach(l=>{let h=l.getAttribute("href").slice(1),f=document.getElementById(h);f&&(f.setAttribute("data-vd-waypoint-section",""),o.push({id:h,link:l,section:f}))}),o.length===0)return;let i=new Set,a=l=>{t.forEach(f=>f.classList.remove("is-active"));let h=t.find(f=>f.getAttribute("href")==="#"+l);h&&(h.classList.add("is-active"),e.dispatchEvent(new CustomEvent("waypoint:change",{detail:{activeId:l,link:h}})))},r="-"+s+"px 0px -40% 0px",c=new IntersectionObserver(l=>{l.forEach(h=>{h.isIntersecting?i.add(h.target.id):i.delete(h.target.id)});for(let h=0;h<o.length;h++)if(i.has(o[h].id)){a(o[h].id);return}},{rootMargin:r,threshold:0});o.forEach(l=>c.observe(l.section)),t.forEach(l=>{let h=f=>{f.preventDefault();let d=l.getAttribute("href").slice(1),u=document.getElementById(d);u&&(u.scrollIntoView({behavior:"smooth"}),a(d))};l.addEventListener("click",h),n.push(()=>l.removeEventListener("click",h))}),n.push(()=>c.disconnect()),this.instances.set(e,{observer:c,cleanup:n,sections:o,setActive:a})},refresh:function(e){this.destroy(e),this.initInstance(e)},destroy:function(e){let t=this.instances.get(e);t&&(t.cleanup.forEach(n=>n()),this.instances.delete(e))},destroyAll:function(){this.instances.forEach((e,t)=>this.destroy(t))}};typeof window.Vanduo<"u"&&window.Vanduo.register("waypoint",p),window.VanduoWaypoint=p})();(function(){"use strict";let p={instances:new Map,init:function(){document.querySelectorAll(".vd-ripple, [data-vd-ripple]").forEach(t=>{this.instances.has(t)||this.initInstance(t)})},initInstance:function(e){let t=[],n=s=>{let o=e.getBoundingClientRect(),i=Math.max(o.width,o.height),a=(s.clientX||s.touches&&s.touches[0].clientX||o.left+o.width/2)-o.left-i/2,r=(s.clientY||s.touches&&s.touches[0].clientY||o.top+o.height/2)-o.top-i/2,c=document.createElement("span");c.className="vd-ripple-wave",c.style.width=i+"px",c.style.height=i+"px",c.style.left=a+"px",c.style.top=r+"px",e.appendChild(c),c.addEventListener("animationend",()=>{c.parentNode&&c.parentNode.removeChild(c)})};e.addEventListener("mousedown",n),e.addEventListener("touchstart",n,{passive:!0}),t.push(()=>e.removeEventListener("mousedown",n),()=>e.removeEventListener("touchstart",n)),this.instances.set(e,{cleanup:t})},destroy:function(e){let t=this.instances.get(e);t&&(t.cleanup.forEach(n=>n()),e.querySelectorAll(".vd-ripple-wave").forEach(n=>n.remove()),this.instances.delete(e))},destroyAll:function(){this.instances.forEach((e,t)=>this.destroy(t))}};typeof window.Vanduo<"u"&&window.Vanduo.register("ripple",p),window.VanduoRipple=p})();(function(){"use strict";function p(n){if(!n||n===document.body)return!1;let s=window.getComputedStyle(n),o=s.overflowY,i=s.overflowX,a=/(auto|scroll|overlay)/.test(o)&&n.scrollHeight>n.clientHeight,r=/(auto|scroll|overlay)/.test(i)&&n.scrollWidth>n.clientWidth;return a||r}function e(n){let s=n.parentElement;for(;s&&s!==document.body&&s!==document.documentElement;){if(p(s))return s;s=s.parentElement}return null}let t={instances:new Map,init:function(){document.querySelectorAll(".vd-affix, .vd-sticky, [data-vd-affix]").forEach(s=>{this.instances.has(s)||this.initInstance(s)})},initInstance:function(n){let s=[],o=parseInt(n.getAttribute("data-vd-affix-offset")||"0",10),i=Number.isNaN(o)?0:o,a=e(n),r=!1,c=document.createElement("div");c.style.cssText="display:block;height:1px;margin-bottom:-1px;visibility:hidden;pointer-events:none;",n.parentNode.insertBefore(c,n),n.style.setProperty("--affix-top-offset",i+"px");function l(){r||(r=!0,n.classList.add("is-stuck"),n.dispatchEvent(new CustomEvent("affix:stuck",{bubbles:!0,detail:{offset:i,root:a||window}})))}function h(){r&&(r=!1,n.classList.remove("is-stuck"),n.dispatchEvent(new CustomEvent("affix:unstuck",{bubbles:!0,detail:{offset:i,root:a||window}})))}let f=new IntersectionObserver(function(d){d.forEach(u=>{u.isIntersecting?h():l()})},{root:a,rootMargin:"-"+i+"px 0px 0px 0px",threshold:0});f.observe(c),s.push(()=>f.disconnect(),()=>{c.parentNode&&c.parentNode.removeChild(c)},()=>{n.classList.remove("is-stuck"),n.style.removeProperty("--affix-top-offset")}),this.instances.set(n,{cleanup:s,observer:f,sentinel:c,scrollParent:a})},destroy:function(n){let s=this.instances.get(n);s&&(s.cleanup.forEach(o=>o()),n.classList.remove("is-stuck"),this.instances.delete(n))},destroyAll:function(){this.instances.forEach((n,s)=>this.destroy(s))}};typeof window.Vanduo<"u"&&window.Vanduo.register("affix",t),window.VanduoAffix=t})();(function(){"use strict";function p(t){let n=document.createElement("div");return n.textContent=t,n.innerHTML}let e={instances:new Map,init:function(){document.querySelectorAll("[data-vd-suggest], [data-vd-autocomplete]").forEach(n=>{this.instances.has(n)||this.initInstance(n)})},initInstance:function(t){let n=[],s=parseInt(t.getAttribute("data-vd-suggest-min-chars")||"1",10),o=t.getAttribute("data-vd-suggest-url")||"",i=t.getAttribute("data-vd-suggest")||t.getAttribute("data-vd-autocomplete")||"",a=[];try{a=JSON.parse(i)}catch{a=i.split(",").map(A=>A.trim()).filter(Boolean)}let r=t.closest(".vd-suggest-wrapper, .vd-autocomplete-wrapper");r||(r=document.createElement("div"),r.className="vd-suggest-wrapper",t.parentNode.insertBefore(r,t),r.appendChild(t));let c=document.createElement("ul");c.className="vd-suggest-list",c.setAttribute("role","listbox");let l="vd-suggest-"+Math.random().toString(36).slice(2,9);c.id=l,r.appendChild(c),t.setAttribute("role","combobox"),t.setAttribute("aria-autocomplete","list"),t.setAttribute("aria-expanded","false"),t.setAttribute("aria-controls",l),t.setAttribute("autocomplete","off");let h=-1,f=[],d=null,u=(v,A)=>{if(c.innerHTML="",f=v,h=-1,v.length===0){let D=document.createElement("li");D.className="vd-suggest-empty",D.textContent="No results",c.appendChild(D);return}v.forEach((D,R)=>{let V=document.createElement("li");V.className="vd-suggest-item",V.setAttribute("role","option"),V.id=l+"-item-"+R;let b=typeof D=="object"&&(D.label||D.text)||String(D);if(A){let N=p(b),O=new RegExp("("+A.replace(/[.*+?^${}()|[\]\\]/g,"\\$&")+")","gi");V.innerHTML=N.replace(O,'<span class="vd-suggest-match">$1</span>')}else V.textContent=b;V.addEventListener("click",()=>T(R)),c.appendChild(V)})},m=()=>{c.classList.add("is-open"),t.setAttribute("aria-expanded","true")},y=()=>{c.classList.remove("is-open"),t.setAttribute("aria-expanded","false"),h=-1,t.removeAttribute("aria-activedescendant")},T=v=>{let A=f[v],D=typeof A=="object"&&(A.value||A.label)||String(A);t.value=D,y(),t.dispatchEvent(new CustomEvent("suggest:select",{detail:{value:D,item:A,index:v},bubbles:!0}))},S=v=>{let A=c.querySelectorAll(".vd-suggest-item");A.forEach(D=>D.classList.remove("is-highlighted")),v>=0&&v<A.length&&(h=v,A[v].classList.add("is-highlighted"),t.setAttribute("aria-activedescendant",A[v].id),A[v].scrollIntoView({block:"nearest"}))},w=async v=>{if(v.length<s){y();return}let A;if(o)try{let D=o.includes("?")?"&":"?";A=await(await window.fetch(o+D+"q="+encodeURIComponent(v))).json()}catch{A=[]}else{let D=v.toLowerCase();A=a.filter(R=>(typeof R=="object"&&(R.label||R.text)||String(R)).toLowerCase().includes(D))}u(A,v),A.length>0,m()},P=()=>{clearTimeout(d),d=setTimeout(()=>w(t.value),200)},g=v=>{if(!c.classList.contains("is-open")){v.key==="ArrowDown"&&(w(t.value),v.preventDefault());return}let A=f.length;switch(v.key){case"ArrowDown":v.preventDefault(),S(h<A-1?h+1:0);break;case"ArrowUp":v.preventDefault(),S(h>0?h-1:A-1);break;case"Enter":v.preventDefault(),h>=0&&T(h);break;case"Escape":y();break}},E=()=>{setTimeout(y,200)};t.addEventListener("input",P),t.addEventListener("keydown",g),t.addEventListener("blur",E),t.addEventListener("focus",()=>{t.value.length>=s&&w(t.value)}),n.push(()=>t.removeEventListener("input",P),()=>t.removeEventListener("keydown",g),()=>t.removeEventListener("blur",E),()=>clearTimeout(d),()=>{c.parentNode&&c.parentNode.removeChild(c)}),this.instances.set(t,{cleanup:n,list:c,close:y})},destroy:function(t){let n=this.instances.get(t);n&&(n.cleanup.forEach(s=>s()),this.instances.delete(t))},destroyAll:function(){this.instances.forEach((t,n)=>this.destroy(n))}};typeof window.Vanduo<"u"&&window.Vanduo.register("suggest",e),window.VanduoSuggest=e})();(function(){"use strict";let p={instances:new Map,rules:{required:e=>e.trim().length>0,email:e=>/^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(e),url:e=>{try{return new URL(e),!0}catch{return!1}},number:e=>!isNaN(parseFloat(e))&&isFinite(e),min:(e,t)=>e.length>=parseInt(t,10),max:(e,t)=>e.length<=parseInt(t,10),minVal:(e,t)=>parseFloat(e)>=parseFloat(t),maxVal:(e,t)=>parseFloat(e)<=parseFloat(t),pattern:(e,t)=>{try{return t.length>100?!1:new RegExp(t).test(e)}catch{return!1}},match:(e,t)=>{try{let n=typeof CSS<"u"&&CSS.escape?CSS.escape(t):t,s=document.querySelector('[name="'+n+'"]');return s?e===s.value:!1}catch{return!1}}},messages:{required:"This field is required",email:"Please enter a valid email address",url:"Please enter a valid URL",number:"Please enter a valid number",min:"Minimum {0} characters required",max:"Maximum {0} characters allowed",minVal:"Value must be at least {0}",maxVal:"Value must be at most {0}",pattern:"Invalid format",match:"Fields do not match"},init:function(){document.querySelectorAll("[data-vd-validate], .vd-validate").forEach(t=>{this.instances.has(t)||this.initInstance(t)})},initInstance:function(e){let t=[],n=e.getAttribute("data-vd-validate-mode")||"blur",s=e.querySelectorAll("[data-vd-rules]"),o=r=>{let l=(r.getAttribute("data-vd-rules")||"").split("|").map(d=>d.trim()).filter(Boolean),h=r.value,f=[];for(let d of l){let[u,...m]=d.split(":"),y=m.join(":"),T=this.rules[u];if(T&&!T(h,y)){let w=r.getAttribute("data-vd-msg-"+u)||this.messages[u]||"Invalid";y&&(w=w.replace("{0}",y)),f.push(w);break}}return this.setFieldState(r,f),f.length===0},i=()=>{let r=!0;return s.forEach(c=>{o(c)||(r=!1)}),r};s.forEach(r=>{if(n==="input"||n==="blur"){let c=n==="input"?"input":"blur",l=()=>o(r);if(r.addEventListener(c,l),t.push(()=>r.removeEventListener(c,l)),n==="blur"){let h=()=>{(r.classList.contains("is-invalid")||r.classList.contains("is-valid"))&&o(r)};r.addEventListener("input",h),t.push(()=>r.removeEventListener("input",h))}}});let a=r=>{let c=i();if(!c){r.preventDefault(),r.stopPropagation();let l=e.querySelector(".is-invalid");l&&l.focus()}e.dispatchEvent(new CustomEvent("validate:submit",{detail:{valid:c},bubbles:!0}))};e.addEventListener("submit",a),t.push(()=>e.removeEventListener("submit",a)),this.instances.set(e,{cleanup:t,validateAll:i,validateField:o})},setFieldState:function(e,t){let n=e.closest(".vd-form-group")||e.parentElement,s=n.querySelector(".vd-validate-error");e.classList.remove("is-valid","is-invalid"),t.length>0?(e.classList.add("is-invalid"),e.setAttribute("aria-invalid","true"),s||(s=document.createElement("div"),s.className="vd-validate-error",s.id="vd-err-"+Math.random().toString(36).slice(2,9),s.setAttribute("role","alert"),n.appendChild(s)),s.textContent=t[0],s.style.display="",e.setAttribute("aria-describedby",s.id)):e.value.trim()?(e.classList.add("is-valid"),e.removeAttribute("aria-invalid"),s&&(s.style.display="none")):(e.removeAttribute("aria-invalid"),s&&(s.style.display="none"))},validateForm:function(e){let t=this.instances.get(e);return t?t.validateAll():!1},addRule:function(e,t,n){this.rules[e]=t,n&&(this.messages[e]=n)},destroy:function(e){let t=this.instances.get(e);t&&(t.cleanup.forEach(n=>n()),this.instances.delete(e))},destroyAll:function(){this.instances.forEach((e,t)=>this.destroy(t))}};typeof window.Vanduo<"u"&&window.Vanduo.register("validate",p),window.VanduoValidate=p})();(function(){"use strict";let p=["Su","Mo","Tu","We","Th","Fr","Sa"],e=["January","February","March","April","May","June","July","August","September","October","November","December"];function t(d){return d.replace(/[.*+?^${}()|[\]\\]/g,"\\$&")}function n(d){let u="^",m=[],y=0;for(;y<d.length;){let T=d.slice(y);T.toLowerCase().startsWith("yyyy")?(u+="(\\d{4})",m.push("y"),y+=4):T.toLowerCase().startsWith("mm")?(u+="(\\d{2})",m.push("m"),y+=2):T.toLowerCase().startsWith("dd")?(u+="(\\d{2})",m.push("d"),y+=2):(u+=t(d[y]),y++)}return u+="$",{regex:new RegExp(u),order:m}}function s(d,u){if(!d||!u)return null;let{regex:m,order:y}=n(u),T=d.trim().match(m);if(!T)return null;let S,w,P,g=1;for(let v=0;v<y.length;v++){let A=y[v],D=parseInt(T[g++],10);if(Number.isNaN(D))return null;A==="y"?S=D:A==="m"?w=D-1:A==="d"&&(P=D)}if(S===void 0||w===void 0||P===void 0)return null;let E=new Date(S,w,P);return E.getFullYear()!==S||E.getMonth()!==w||E.getDate()!==P?null:E}function o(d,u){let m=String(d.getFullYear()),y=String(d.getMonth()+1).padStart(2,"0"),T=String(d.getDate()).padStart(2,"0"),S="",w=0;for(;w<u.length;){let P=u.slice(w);P.toLowerCase().startsWith("yyyy")?(S+=m,w+=4):P.toLowerCase().startsWith("mm")?(S+=y,w+=2):P.toLowerCase().startsWith("dd")?(S+=T,w+=2):(S+=u[w],w++)}return S}function i(d){return d.getFullYear()+"-"+String(d.getMonth()+1).padStart(2,"0")+"-"+String(d.getDate()).padStart(2,"0")}function a(d,u){let m=new Date(d.getFullYear(),d.getMonth(),d.getDate());return m.setDate(m.getDate()+u),m}function r(d,u){return new Date(d.getFullYear(),d.getMonth()+u,d.getDate())}function c(d){if(!d||typeof d!="string")return null;let u=/^(\d{4})-(\d{2})-(\d{2})$/.exec(d.trim());if(!u)return null;let m=+u[1],y=+u[2]-1,T=+u[3],S=new Date(m,y,T);return S.getFullYear()!==m||S.getMonth()!==y||S.getDate()!==T?null:S}function l(d){let u=new Date(d.getFullYear(),d.getMonth(),d.getDate()),m=u.getDay();return u.setDate(u.getDate()-m),u}function h(d){let u=new Date(d.getFullYear(),d.getMonth(),d.getDate()),m=u.getDay();return u.setDate(u.getDate()+(6-m)),u}let f={instances:new Map,init:function(){document.querySelectorAll("[data-vd-datepicker]").forEach(u=>{this.instances.has(u)||this.initInstance(u)})},initInstance:function(d){let u=[],m=d.getAttribute("data-vd-datepicker-format")||"YYYY-MM-DD",y=d.getAttribute("data-vd-datepicker-min"),T=d.getAttribute("data-vd-datepicker-max"),S=y?c(y):null,w=T?c(T):null,P=new Date,g=P.getFullYear(),E=P.getMonth(),v=null,A="days",D=null,R=!1,V=L=>!!(S&&new Date(L.getFullYear(),L.getMonth(),L.getDate()).getTime()<S.getTime()||w&&new Date(L.getFullYear(),L.getMonth(),L.getDate()).getTime()>w.getTime()),b=(L,I)=>{if(!S&&!w)return{y:L,m:I};let C=new Date(L,I,1),k=new Date(L,I+1,0);return S&&k.getTime()<S.getTime()?{y:S.getFullYear(),m:S.getMonth()}:w&&C.getTime()>w.getTime()?{y:w.getFullYear(),m:w.getMonth()}:{y:L,m:I}},N=(L,I)=>{let C=new Date(L,I+1,0).getDate();for(let k=1;k<=C;k++){let q=new Date(L,I,k);if(!V(q))return q}return new Date(L,I,1)};if(d.value){let L=d.value.trim(),I=s(L,m);if(!I){let C=new Date(L);isNaN(C.getTime())||(I=C)}I&&(v=I,g=I.getFullYear(),E=I.getMonth())}let O=b(g,E);g=O.y,E=O.m;let F=document.createElement("div");F.className="vd-datepicker-popup",F.setAttribute("role","dialog"),F.setAttribute("aria-label","Choose date"),F.tabIndex=-1;let G=document.createElement("div");G.className="vd-suggest-wrapper",G.style.position="relative",G.style.display="inline-block",d.parentNode.insertBefore(G,d),G.appendChild(d),G.appendChild(F);let K=(L,I)=>L&&I&&L.getFullYear()===I.getFullYear()&&L.getMonth()===I.getMonth()&&L.getDate()===I.getDate(),ae=L=>{v=L,g=L.getFullYear(),E=L.getMonth(),d.value=o(L,m),R=!0,_(),d.dispatchEvent(new CustomEvent("datepicker:select",{detail:{date:L,formatted:d.value},bubbles:!0})),d.dispatchEvent(new Event("change",{bubbles:!0})),d.focus()},te=()=>{if(A!=="days"||!D)return;let L=i(D),I=F.querySelector('[data-vd-date="'+L+'"]');I&&!I.classList.contains("is-outside")&&I.getAttribute("aria-disabled")!=="true"&&I.focus()},oe=(L,I,C)=>{let k=new Date(L.getFullYear(),L.getMonth(),L.getDate()),q=I>0?1:-1;for(let B=0;B<C;B++){if(!V(k))return k;k=a(k,q)}return L},re=(L,I,C)=>{let k=document.createElement("button");if(k.type="button",k.className="vd-datepicker-day",k.textContent=L,k.setAttribute("role","gridcell"),I)return k.classList.add("is-outside"),k.tabIndex=-1,k.setAttribute("aria-disabled","true"),k;if(k.setAttribute("data-vd-date",i(C)),C&&K(C,P)&&k.classList.add("is-today"),C&&K(C,v)&&k.classList.add("is-selected"),C&&V(C))return k.classList.add("is-disabled"),k.setAttribute("aria-disabled","true"),k.tabIndex=-1,k;if(C){let q=D&&K(C,D);k.tabIndex=q?0:-1,k.addEventListener("click",()=>{v=C,g=C.getFullYear(),E=C.getMonth(),D=new Date(C.getFullYear(),C.getMonth(),C.getDate()),d.value=o(C,m),R=!0,_(),d.dispatchEvent(new CustomEvent("datepicker:select",{detail:{date:C,formatted:d.value},bubbles:!0})),d.dispatchEvent(new Event("change",{bubbles:!0})),d.focus()})}return k},j=()=>{F.innerHTML="";let L=document.createElement("div");L.className="vd-datepicker-header";let I=document.createElement("button");I.type="button",I.className="vd-datepicker-prev",I.innerHTML="&#8249;",I.setAttribute("aria-label","Previous");let C=document.createElement("button");C.type="button",C.className="vd-datepicker-next",C.innerHTML="&#8250;",C.setAttribute("aria-label","Next");let k=document.createElement("span");if(k.className="vd-datepicker-title",A==="days")k.textContent=e[E]+" "+g,k.addEventListener("click",()=>{A="months",j()}),I.addEventListener("click",()=>{E--,E<0&&(E=11,g--),j()}),C.addEventListener("click",()=>{E++,E>11&&(E=0,g++),j()});else if(A==="months")k.textContent=String(g),k.addEventListener("click",()=>{A="years",j()}),I.addEventListener("click",()=>{g--,j()}),C.addEventListener("click",()=>{g++,j()});else{let q=Math.floor(g/10)*10;k.textContent=q+" - "+(q+9),I.addEventListener("click",()=>{g-=10,j()}),C.addEventListener("click",()=>{g+=10,j()})}if(L.appendChild(I),L.appendChild(k),L.appendChild(C),F.appendChild(L),A==="days"){let q=document.createElement("div");q.className="vd-datepicker-grid",q.setAttribute("role","grid"),q.setAttribute("aria-label","Calendar");let B=document.createElement("div");B.className="vd-datepicker-weekdays",B.setAttribute("role","row"),p.forEach(function($){let W=document.createElement("span");W.setAttribute("role","columnheader"),W.setAttribute("aria-label",$),W.textContent=$,B.appendChild(W)}),q.appendChild(B);let U=new Date(g,E,1).getDay(),X=new Date(g,E+1,0).getDate(),Ae=new Date(g,E,0).getDate(),J=[];for(let $=U-1;$>=0;$--){let W=Ae-$,Q=E===0?11:E-1,ee=E===0?g-1:g,ke=new Date(ee,Q,W);J.push({day:W,outside:!0,date:ke})}for(let $=1;$<=X;$++){let W=new Date(g,E,$);J.push({day:$,outside:!1,date:W})}let ue=U+X,xe=ue%7===0?0:7-ue%7;for(let $=1;$<=xe;$++){let W=new Date(g,E+1,$);J.push({day:$,outside:!0,date:W})}for(let $=0;$<J.length;$+=7){let W=document.createElement("div");W.className="vd-datepicker-row",W.setAttribute("role","row");for(let Q=0;Q<7;Q++){let ee=J[$+Q];W.appendChild(re(ee.day,ee.outside,ee.date))}q.appendChild(W)}F.appendChild(q)}else if(A==="months"){let q=document.createElement("div");q.className="vd-datepicker-months",e.forEach((B,U)=>{let X=document.createElement("button");X.type="button",X.className="vd-datepicker-month-btn",X.textContent=B.slice(0,3),v&&v.getFullYear()===g&&v.getMonth()===U&&X.classList.add("is-selected"),X.addEventListener("click",()=>{E=U,A="days",j()}),q.appendChild(X)}),F.appendChild(q)}else{let q=document.createElement("div");q.className="vd-datepicker-years";let B=Math.floor(g/10)*10;for(let U=B-1;U<=B+10;U++){let X=document.createElement("button");X.type="button",X.className="vd-datepicker-year-btn",X.textContent=U,v&&v.getFullYear()===U&&X.classList.add("is-selected"),(U<B||U>B+9)&&(X.style.opacity="0.4"),X.addEventListener("click",()=>{g=U,A="months",j()}),q.appendChild(X)}F.appendChild(q)}},Z=L=>{if(!F.classList.contains("is-open")||A!=="days")return;let I=F.querySelector(".vd-datepicker-grid");if(!I||!I.contains(L.target))return;let C=L.key;if(C!=="ArrowLeft"&&C!=="ArrowRight"&&C!=="ArrowUp"&&C!=="ArrowDown"&&C!=="Home"&&C!=="End"&&C!=="PageUp"&&C!=="PageDown"&&C!=="Enter"&&C!==" "&&C!=="Escape")return;if(C==="Escape"){L.preventDefault(),L.stopPropagation(),R=!0,_(),d.focus();return}if(D||(D=N(g,E)),C==="Enter"||C===" "){L.preventDefault(),D&&!V(D)&&ae(new Date(D.getFullYear(),D.getMonth(),D.getDate()));return}L.preventDefault();let k=new Date(D.getFullYear(),D.getMonth(),D.getDate()),q=1;if(C==="ArrowLeft"?(k=a(k,-1),q=-1):C==="ArrowRight"?(k=a(k,1),q=1):C==="ArrowUp"?(k=a(k,-7),q=-1):C==="ArrowDown"?(k=a(k,7),q=1):C==="Home"?(k=l(k),q=1):C==="End"?(k=h(k),q=-1):C==="PageUp"?(k=r(k,-1),q=-1):C==="PageDown"&&(k=r(k,1),q=1),k=oe(k,q,400),k.getMonth()!==E||k.getFullYear()!==g){g=k.getFullYear(),E=k.getMonth();let B=b(g,E);g=B.y,E=B.m}D=k,j(),requestAnimationFrame(te)},x=()=>{A="days",v&&(g=v.getFullYear(),E=v.getMonth());let L=b(g,E);g=L.y,E=L.m,v?D=new Date(v.getFullYear(),v.getMonth(),v.getDate()):D=N(g,E),j(),F.classList.add("is-open"),d.setAttribute("aria-expanded","true"),requestAnimationFrame(te)},_=()=>{F.classList.remove("is-open"),d.setAttribute("aria-expanded","false"),A="days"},M=()=>{if(R){R=!1;return}x()},H=L=>{G.contains(L.target)||_()},z=L=>{L.key==="Escape"&&F.classList.contains("is-open")&&(R=!0,_(),d.focus())};d.addEventListener("focus",M),document.addEventListener("click",H,!0),document.addEventListener("keydown",z),F.addEventListener("keydown",Z),d.setAttribute("aria-haspopup","dialog"),d.setAttribute("aria-expanded","false"),d.setAttribute("autocomplete","off"),u.push(()=>d.removeEventListener("focus",M),()=>document.removeEventListener("click",H,!0),()=>document.removeEventListener("keydown",z),()=>F.removeEventListener("keydown",Z)),this.instances.set(d,{cleanup:u,open:x,close:_,popup:F})},destroy:function(d){let u=this.instances.get(d);u&&(u.cleanup.forEach(m=>m()),this.instances.delete(d))},destroyAll:function(){this.instances.forEach((d,u)=>this.destroy(u))}};typeof window.Vanduo<"u"&&window.Vanduo.register("datepicker",f),window.VanduoDatepicker=f})();(function(){"use strict";let p={instances:new Map,init:function(){document.querySelectorAll("[data-vd-timepicker]").forEach(t=>{this.instances.has(t)||this.initInstance(t)})},initInstance:function(e){let t=[],n=e.getAttribute("data-vd-timepicker-format")==="24h",s=parseInt(e.getAttribute("data-vd-timepicker-step")||"30",10),o=e.closest(".vd-suggest-wrapper");o||(o=document.createElement("div"),o.style.position="relative",o.style.display="inline-block",e.parentNode.insertBefore(o,e),o.appendChild(e));let i=document.createElement("div");i.className="vd-timepicker-popup",i.setAttribute("role","listbox"),o.appendChild(i);let a=[];for(let u=0;u<24;u++)for(let m=0;m<60;m+=s){let y=String(u).padStart(2,"0"),T=String(m).padStart(2,"0");if(n)a.push({display:y+":"+T,value:y+":"+T});else{let S=u<12?"AM":"PM",P=(u===0?12:u>12?u-12:u)+":"+T+" "+S;a.push({display:P,value:y+":"+T})}}let r=()=>{i.innerHTML="",a.forEach(u=>{let m=document.createElement("div");m.className="vd-timepicker-item",m.setAttribute("role","option"),m.textContent=u.display,(e.value===u.value||e.value===u.display)&&m.classList.add("is-selected"),m.addEventListener("click",()=>{e.value=u.display,i.querySelectorAll(".vd-timepicker-item").forEach(y=>y.classList.remove("is-selected")),m.classList.add("is-selected"),l(),e.dispatchEvent(new CustomEvent("timepicker:select",{detail:{display:u.display,value:u.value},bubbles:!0})),e.dispatchEvent(new Event("change",{bubbles:!0}))}),i.appendChild(m)})},c=()=>{r(),i.classList.add("is-open"),e.setAttribute("aria-expanded","true");let u=i.querySelector(".is-selected");u&&u.scrollIntoView({block:"center"})},l=()=>{i.classList.remove("is-open"),e.setAttribute("aria-expanded","false")},h=()=>c(),f=u=>{o.contains(u.target)||l()},d=u=>{u.key==="Escape"&&l()};e.addEventListener("focus",h),document.addEventListener("click",f,!0),document.addEventListener("keydown",d),e.setAttribute("aria-haspopup","listbox"),e.setAttribute("aria-expanded","false"),e.setAttribute("autocomplete","off"),e.readOnly=!0,t.push(()=>e.removeEventListener("focus",h),()=>document.removeEventListener("click",f,!0),()=>document.removeEventListener("keydown",d)),this.instances.set(e,{cleanup:t,open:c,close:l})},destroy:function(e){let t=this.instances.get(e);t&&(t.cleanup.forEach(n=>n()),this.instances.delete(e))},destroyAll:function(){this.instances.forEach((e,t)=>this.destroy(t))}};typeof window.Vanduo<"u"&&window.Vanduo.register("timepicker",p),window.VanduoTimepicker=p})();(function(){"use strict";let p={instances:new Map,init:function(){document.querySelectorAll(".vd-stepper").forEach(t=>{this.instances.has(t)||this.initInstance(t)})},initInstance:function(e){let t=[],n=Array.from(e.querySelectorAll(".vd-stepper-item")),s=e.classList.contains("vd-stepper-clickable"),o=n.findIndex(a=>a.classList.contains("is-active"));o===-1&&(o=0);let i=a=>{if(a<0||a>=n.length)return;let r=o;o=a,n.forEach((c,l)=>{c.classList.remove("is-active","is-completed"),l<a?c.classList.add("is-completed"):l===a&&c.classList.add("is-active")}),e.dispatchEvent(new CustomEvent("stepper:change",{detail:{current:a,previous:r,total:n.length},bubbles:!0}))};s&&n.forEach((a,r)=>{let c=()=>i(r);a.addEventListener("click",c),t.push(()=>a.removeEventListener("click",c))}),i(o),this.instances.set(e,{cleanup:t,setStep:i,next:()=>i(o+1),prev:()=>i(o-1),getCurrent:()=>o})},setStep:function(e,t){let n=this.instances.get(e);n&&n.setStep(t)},next:function(e){let t=this.instances.get(e);t&&t.next()},prev:function(e){let t=this.instances.get(e);t&&t.prev()},destroy:function(e){let t=this.instances.get(e);t&&(t.cleanup.forEach(n=>n()),this.instances.delete(e))},destroyAll:function(){this.instances.forEach((e,t)=>this.destroy(t))}};typeof window.Vanduo<"u"&&window.Vanduo.register("stepper",p),window.VanduoStepper=p})();(function(){"use strict";let p={instances:new Map,init:function(){document.querySelectorAll("[data-vd-rating]").forEach(t=>{this.instances.has(t)||this.initInstance(t)})},initInstance:function(e){let t=[],n=parseInt(e.getAttribute("data-vd-rating-max")||"5",10),s=parseFloat(e.getAttribute("data-vd-rating-value")||"0"),o=e.classList.contains("vd-rating-readonly")||e.hasAttribute("data-vd-rating-readonly"),i=s;e.classList.add("vd-rating"),e.setAttribute("role","radiogroup"),e.setAttribute("aria-label",e.getAttribute("aria-label")||"Rating"),e.innerHTML="";let a=[];for(let l=1;l<=n;l++){let h=document.createElement("button");h.type="button",h.className="vd-rating-star",h.setAttribute("role","radio"),h.setAttribute("aria-label",l+" star"+(l>1?"s":"")),h.setAttribute("aria-checked",l<=i?"true":"false"),o&&(h.tabIndex=-1),a.push(h),e.appendChild(h)}let r=document.createElement("span");r.className="vd-rating-value",r.textContent=i>0?i.toString():"",e.appendChild(r);let c=l=>{a.forEach((h,f)=>{h.classList.remove("is-active","is-half");let d=f+1;d<=Math.floor(l)?h.classList.add("is-active"):d-.5<=l&&h.classList.add("is-half"),h.setAttribute("aria-checked",d<=l?"true":"false")}),r.textContent=l>0?l.toString():""};if(c(i),!o){a.forEach((h,f)=>{let d=()=>{a.forEach((y,T)=>{y.classList.toggle("is-hovered",T<=f)})},u=()=>{a.forEach(y=>y.classList.remove("is-hovered"))},m=()=>{i=f+1,e.setAttribute("data-vd-rating-value",i),c(i),e.dispatchEvent(new CustomEvent("rating:change",{detail:{value:i,max:n},bubbles:!0}))};h.addEventListener("mouseenter",d),h.addEventListener("mouseleave",u),h.addEventListener("click",m),t.push(()=>h.removeEventListener("mouseenter",d),()=>h.removeEventListener("mouseleave",u),()=>h.removeEventListener("click",m))});let l=h=>{h.key==="ArrowRight"||h.key==="ArrowUp"?(h.preventDefault(),i<n&&(i++,c(i),a[i-1].focus(),e.dispatchEvent(new CustomEvent("rating:change",{detail:{value:i,max:n},bubbles:!0})))):(h.key==="ArrowLeft"||h.key==="ArrowDown")&&(h.preventDefault(),i>1&&(i--,c(i),a[i-1].focus(),e.dispatchEvent(new CustomEvent("rating:change",{detail:{value:i,max:n},bubbles:!0}))))};e.addEventListener("keydown",l),t.push(()=>e.removeEventListener("keydown",l))}this.instances.set(e,{cleanup:t,getValue:()=>i,setValue:l=>{i=l,c(l)}})},getValue:function(e){let t=this.instances.get(e);return t?t.getValue():0},setValue:function(e,t){let n=this.instances.get(e);n&&n.setValue(t)},destroy:function(e){let t=this.instances.get(e);t&&(t.cleanup.forEach(n=>n()),this.instances.delete(e))},destroyAll:function(){this.instances.forEach((e,t)=>this.destroy(t))}};typeof window.Vanduo<"u"&&window.Vanduo.register("rating",p),window.VanduoRating=p})();(function(){"use strict";let p={instances:new Map,init:function(){document.querySelectorAll("[data-vd-transfer]").forEach(t=>{this.instances.has(t)||this.initInstance(t)})},initInstance:function(e){let t=[];e.classList.add("vd-transfer");let n,s;try{n=JSON.parse(e.getAttribute("data-vd-transfer")||"[]").map((d,u)=>({id:d.id||"item-"+u,label:d.label||d.text||String(d),selected:!1}))}catch{n=[]}s=[];let o=new Set,i=new Set,a=()=>{e.innerHTML="";let f=r("Source",n,o,"source"),d=document.createElement("div");d.className="vd-transfer-actions";let u=document.createElement("button");u.type="button",u.className="vd-transfer-btn",u.innerHTML="&#8250;",u.setAttribute("aria-label","Move to target"),u.disabled=o.size===0,u.addEventListener("click",()=>c());let m=document.createElement("button");m.type="button",m.className="vd-transfer-btn",m.innerHTML="&#8249;",m.setAttribute("aria-label","Move to source"),m.disabled=i.size===0,m.addEventListener("click",()=>l()),d.appendChild(u),d.appendChild(m);let y=r("Target",s,i,"target");e.appendChild(f),e.appendChild(d),e.appendChild(y)},r=(f,d,u,m)=>{let y=document.createElement("div");y.className="vd-transfer-panel";let T=document.createElement("div");T.className="vd-transfer-header";let S=document.createElement("span");S.textContent=f;let w=document.createElement("span");w.className="vd-transfer-count",w.textContent=u.size+"/"+d.length,T.appendChild(S),T.appendChild(w),y.appendChild(T);let P=document.createElement("div");P.className="vd-transfer-search";let g=document.createElement("input");g.type="text",g.placeholder="Search...",g.setAttribute("aria-label","Search "+f.toLowerCase()),P.appendChild(g),y.appendChild(P);let E=document.createElement("ul");E.className="vd-transfer-list",E.setAttribute("role","listbox");let v=A=>{E.innerHTML="",(A?d.filter(R=>(R.label||R.text||String(R)).toLowerCase().includes(A.toLowerCase())):d).forEach(R=>{let V=document.createElement("li");V.className="vd-transfer-item",V.setAttribute("role","option"),u.has(R.id)&&V.classList.add("is-selected");let b=document.createElement("input");b.type="checkbox",b.checked=u.has(R.id),b.setAttribute("aria-label",R.label);let N=document.createElement("span");N.textContent=R.label,V.addEventListener("click",()=>{u.has(R.id)?u.delete(R.id):u.add(R.id),a()}),V.appendChild(b),V.appendChild(N),E.appendChild(V)})};return g.addEventListener("input",()=>v(g.value)),v(""),y.appendChild(E),y},c=()=>{let f=n.filter(d=>o.has(d.id));n=n.filter(d=>!o.has(d.id)),s=s.concat(f),o.clear(),a(),h()},l=()=>{let f=s.filter(d=>i.has(d.id));s=s.filter(d=>!i.has(d.id)),n=n.concat(f),i.clear(),a(),h()},h=()=>{e.dispatchEvent(new CustomEvent("transfer:change",{detail:{source:n.map(f=>f.id),target:s.map(f=>f.id)},bubbles:!0}))};a(),this.instances.set(e,{cleanup:t,getTarget:()=>s.map(f=>f.id),getSource:()=>n.map(f=>f.id)})},getSelected:function(e){let t=this.instances.get(e);return t?t.getTarget():[]},destroy:function(e){let t=this.instances.get(e);t&&(t.cleanup.forEach(n=>n()),e.innerHTML="",this.instances.delete(e))},destroyAll:function(){this.instances.forEach((e,t)=>this.destroy(t))}};typeof window.Vanduo<"u"&&window.Vanduo.register("transfer",p),window.VanduoTransfer=p})();(function(){"use strict";let p={instances:new Map,init:function(){document.querySelectorAll("[data-vd-tree]").forEach(t=>{this.instances.has(t)||this.initInstance(t)})},initInstance:function(e){let t=[],n=e.getAttribute("data-vd-tree-cascade")!=="false",s;try{s=JSON.parse(e.getAttribute("data-vd-tree")||"[]")}catch{s=[]}e.classList.add("vd-tree"),e.setAttribute("role","tree");let o=(r,c)=>{c.innerHTML="",r.forEach(l=>{let h=document.createElement("li");h.className="vd-tree-node",h.setAttribute("role","treeitem"),h.setAttribute("aria-expanded",l.open?"true":"false"),l.open&&h.classList.add("is-open");let f=document.createElement("div");if(f.className="vd-tree-node-content",l.children&&l.children.length>0){let u=document.createElement("button");u.type="button",u.className="vd-tree-toggle",u.setAttribute("aria-label","Toggle"),u.addEventListener("click",m=>{m.stopPropagation(),l.open=!l.open,h.classList.toggle("is-open"),h.setAttribute("aria-expanded",l.open?"true":"false")}),f.appendChild(u)}else{let u=document.createElement("span");u.className="vd-tree-toggle-placeholder",f.appendChild(u)}if(e.hasAttribute("data-vd-tree-checkbox")){let u=document.createElement("input");u.type="checkbox",u.className="vd-tree-checkbox",u.checked=!!l.checked,u.setAttribute("aria-label",l.label),u.addEventListener("change",m=>{m.stopPropagation(),l.checked=u.checked,n&&l.children&&(i(l.children,u.checked),o(s,e)),e.dispatchEvent(new CustomEvent("tree:check",{detail:{id:l.id,checked:u.checked,label:l.label},bubbles:!0}))}),f.appendChild(u)}if(l.icon){let u=document.createElement("span");u.className="vd-tree-icon "+l.icon,f.appendChild(u)}let d=document.createElement("span");if(d.className="vd-tree-label",d.textContent=l.label||"",f.appendChild(d),h.appendChild(f),l.children&&l.children.length>0){let u=document.createElement("ul");u.className="vd-tree-children",u.setAttribute("role","group"),o(l.children,u),h.appendChild(u)}c.appendChild(h)})},i=(r,c)=>{r.forEach(l=>{l.checked=c,l.children&&i(l.children,c)})},a=r=>{let c=document.activeElement;if(!e.contains(c))return;let l=Array.from(e.querySelectorAll(".vd-tree-node-content")),h=l.indexOf(c.closest(".vd-tree-node-content"));if(h!==-1)switch(r.key){case"ArrowDown":if(r.preventDefault(),h<l.length-1){let f=l[h+1].querySelector(".vd-tree-toggle, .vd-tree-label");f&&f.focus()}break;case"ArrowUp":if(r.preventDefault(),h>0){let f=l[h-1].querySelector(".vd-tree-toggle, .vd-tree-label");f&&f.focus()}break}};e.addEventListener("keydown",a),t.push(()=>e.removeEventListener("keydown",a)),o(s,e),this.instances.set(e,{cleanup:t,getData:()=>s,getChecked:()=>{let r=[],c=l=>{l.forEach(h=>{h.checked&&r.push(h.id||h.label),h.children&&c(h.children)})};return c(s),r}})},getChecked:function(e){let t=this.instances.get(e);return t?t.getChecked():[]},destroy:function(e){let t=this.instances.get(e);t&&(t.cleanup.forEach(n=>n()),e.innerHTML="",this.instances.delete(e))},destroyAll:function(){this.instances.forEach((e,t)=>this.destroy(t))}};typeof window.Vanduo<"u"&&window.Vanduo.register("tree",p),window.VanduoTree=p})();(function(){"use strict";let p={_active:!1,_steps:[],_currentStep:0,_elements:{},_cleanup:[],_boundTriggers:new WeakMap,_triggerElement:null,init:function(){document.querySelectorAll("[data-vd-spotlight]").forEach(t=>{if(this._boundTriggers.has(t))return;let n=s=>{s.preventDefault();let o=this._parseSteps(t.getAttribute("data-vd-spotlight"));o.length!==0&&this.start(o,{trigger:t})};t.addEventListener("click",n),this._boundTriggers.set(t,n)})},_parseSteps:function(e){if(typeof e!="string"||e.trim()==="")return[];try{let t=JSON.parse(e);return this._normalizeSteps(t)}catch(t){return console.error("VanduoSpotlight: invalid data-vd-spotlight payload.",t),[]}},_normalizeStep:function(e){if(!e||typeof e!="object")return null;let t=e.target,n=typeof t=="string"&&t.trim()!=="",s=typeof Element<"u"&&t instanceof Element;if(!n&&!s)return null;let o=typeof e.title=="string"?e.title:"",i=typeof e.description=="string"?e.description:typeof e.content=="string"?e.content:"";return{target:t,title:o,description:i}},_normalizeSteps:function(e){return Array.isArray(e)?e.map(t=>this._normalizeStep(t)).filter(Boolean):[]},start:function(e,t){this._active&&this.stop();let n=this._normalizeSteps(e);if(n.length===0)return;let s=t||{};this._steps=n,this._currentStep=0,this._active=!0,this._triggerElement=s.trigger||(document.activeElement instanceof HTMLElement?document.activeElement:null);let o=document.createElement("div");o.className="vd-spotlight-overlay",o.setAttribute("aria-hidden","true"),document.body.appendChild(o);let i=document.createElement("div");i.className="vd-spotlight-tooltip",i.setAttribute("role","dialog"),i.setAttribute("aria-modal","true"),i.tabIndex=-1,document.body.appendChild(i),this._elements={overlay:o,tooltip:i};let a=r=>{r.key==="Escape"&&this.stop()};document.addEventListener("keydown",a),this._cleanup.push(()=>document.removeEventListener("keydown",a)),o.addEventListener("click",()=>this.stop()),this._showStep(this._currentStep)},_showStep:function(e){let t=this._steps[e];if(!t)return;let n=typeof t.target=="string"?document.querySelector(t.target):t.target,{tooltip:s}=this._elements;document.querySelectorAll(".vd-spotlight-target").forEach(l=>{l.classList.remove("vd-spotlight-target")}),n&&(n.classList.add("vd-spotlight-target"),n.scrollIntoView({behavior:"smooth",block:"center"}));let o=this._steps.length;if(s.innerHTML="",s.removeAttribute("aria-labelledby"),s.removeAttribute("aria-describedby"),t.title){let l=document.createElement("h4");l.className="vd-spotlight-title",l.id="vd-spotlight-title-"+e+"-"+Date.now(),l.textContent=t.title,s.appendChild(l),s.setAttribute("aria-labelledby",l.id)}if(t.description){let l=document.createElement("p");l.className="vd-spotlight-description",l.id="vd-spotlight-description-"+e+"-"+Date.now(),l.textContent=t.description,s.appendChild(l),s.setAttribute("aria-describedby",l.id)}let i=document.createElement("div");i.className="vd-spotlight-footer",i.setAttribute("aria-label","Step "+(e+1)+" of "+o);let a=document.createElement("span");a.className="vd-spotlight-counter",a.textContent=e+1+" / "+o;let r=document.createElement("div");if(r.className="vd-spotlight-actions",e>0){let l=document.createElement("button");l.type="button",l.className="vd-spotlight-btn",l.textContent="Back",l.addEventListener("click",()=>this.prev()),r.appendChild(l)}let c=document.createElement("button");if(c.type="button",c.className="vd-spotlight-btn",c.textContent="Skip",c.addEventListener("click",()=>this.stop()),r.appendChild(c),e<o-1){let l=document.createElement("button");l.type="button",l.className="vd-spotlight-btn vd-spotlight-btn-primary",l.textContent="Next",l.addEventListener("click",()=>this.next()),r.appendChild(l)}else{let l=document.createElement("button");l.type="button",l.className="vd-spotlight-btn vd-spotlight-btn-primary",l.textContent="Done",l.addEventListener("click",()=>this.stop()),r.appendChild(l)}i.appendChild(a),i.appendChild(r),s.appendChild(i),n&&requestAnimationFrame(()=>{let l=n.getBoundingClientRect(),h=s.getBoundingClientRect(),f=l.bottom+12+window.scrollY,d=l.left+(l.width-h.width)/2+window.scrollX;d=Math.max(8,Math.min(d,window.innerWidth-h.width-8)),f+h.height>window.innerHeight+window.scrollY&&(f=l.top-h.height-12+window.scrollY),s.style.top=f+"px",s.style.left=d+"px"}),document.dispatchEvent(new CustomEvent("spotlight:step",{detail:{index:e,step:e,total:o,data:t}}))},next:function(){this._currentStep<this._steps.length-1&&(this._currentStep++,this._showStep(this._currentStep))},prev:function(){this._currentStep>0&&(this._currentStep--,this._showStep(this._currentStep))},stop:function(){if(!this._active)return;let e=this._steps.length,t={completedSteps:e===0?0:Math.min(this._currentStep+1,e),total:e,completed:e>0&&this._currentStep>=e-1};this._active=!1,document.querySelectorAll(".vd-spotlight-target").forEach(n=>{n.classList.remove("vd-spotlight-target")}),this._elements.overlay&&this._elements.overlay.parentNode&&this._elements.overlay.parentNode.removeChild(this._elements.overlay),this._elements.tooltip&&this._elements.tooltip.parentNode&&this._elements.tooltip.parentNode.removeChild(this._elements.tooltip),this._cleanup.forEach(n=>n()),this._cleanup=[],this._elements={},this._steps=[],this._currentStep=0,this._triggerElement&&this._triggerElement.isConnected&&typeof this._triggerElement.focus=="function"&&this._triggerElement.focus(),this._triggerElement=null,document.dispatchEvent(new CustomEvent("spotlight:end",{detail:t}))},destroyAll:function(){this.stop()}};typeof window.Vanduo<"u"&&window.Vanduo.register("spotlight",p),window.VanduoSpotlight=p})();(function(){"use strict";function p(i){let a=i.slice();for(let r=a.length-1;r>0;r--){let c=Math.floor(Math.random()*(r+1)),l=a[r];a[r]=a[c],a[c]=l}return a}function e(i){if(!isFinite(i)||i<0)return"0:00";let a=Math.floor(i/60),r=Math.floor(i%60);return a+":"+(r<10?"0":"")+r}function t(i){return"vanduo:music-player:"+(i&&i.trim()?i.trim():"default")+":pos"}function n(i){let a=parseFloat(i.min)||0,r=parseFloat(i.max)||1,l=((parseFloat(i.value)||0)-a)/(r-a)*100;i.style.setProperty("--fill",l+"%"),i.style.backgroundImage="linear-gradient(to right, var(--music-player-track-fill, currentColor) 0%, var(--music-player-track-fill, currentColor) "+l+"%, var(--music-player-track-bg, #ccc) "+l+"%, var(--music-player-track-bg, #ccc) 100%)"}function s(i){let a=document.createElement("i");return a.className="ph ph-"+i,a.setAttribute("aria-hidden","true"),a}let o={instances:new Map,defaults:{tracks:[],volume:.5,shuffle:!1,showProgress:!1,showPlaylist:!1,autoAdvance:!0,glass:!1,detachable:!1,floatingPosition:null,draggable:!1,minimizable:!1,startMinimized:!1,persistPosition:!1,persistKey:""},init:function(){document.querySelectorAll(".vd-music-player, [data-music-player]").forEach(i=>{if(this.instances.has(i))return;let a={},r=i.getAttribute("data-music-player-options");if(r)try{a=JSON.parse(r)}catch{}this.initPlayer(i,a)})},initPlayer:function(i,a){let r=Object.assign({},this.defaults,a||{}),l=(Array.isArray(r.tracks)?r.tracks:[]).filter(b=>b&&typeof b.url=="string"&&b.url.trim()),f={tracks:r.shuffle?p(l):l.slice(),originalTracks:l.slice(),currentIndex:0,isPlaying:!1,volume:Math.max(0,Math.min(1,r.volume)),shuffle:r.shuffle,showProgress:r.showProgress,showPlaylist:r.showPlaylist,autoAdvance:r.autoAdvance,audio:null,glass:!!r.glass,detachable:!!r.detachable,floatingPosition:r.floatingPosition||"bottom-right",draggable:!!r.draggable&&!!r.detachable,minimizable:!!r.minimizable,startMinimized:!!r.startMinimized,persistPosition:!!r.persistPosition,persistKey:typeof r.persistKey=="string"?r.persistKey:"",isDetached:!1,isMinimized:!1,_startMinimizeApplied:!1},d=new Audio;d.volume=f.volume,d.preload="metadata",f.audio=d,this._buildDOM(i,f);let u={btnPlay:i.querySelector(".vd-music-player-btn-play"),btnPrev:i.querySelector(".vd-music-player-btn-prev"),btnNext:i.querySelector(".vd-music-player-btn-next"),btnShuffle:i.querySelector(".vd-music-player-btn-shuffle"),btnPlaylist:i.querySelector(".vd-music-player-btn-playlist"),btnDetach:i.querySelector(".vd-music-player-btn-detach"),btnAttach:i.querySelector(".vd-music-player-btn-attach"),btnMinimize:i.querySelector(".vd-music-player-btn-minimize"),dragHandle:i.querySelector(".vd-music-player-drag-handle"),trackName:i.querySelector(".vd-music-player-track-name"),volumeSlider:i.querySelector(".vd-music-player-volume-slider"),volumeIcon:i.querySelector(".vd-music-player-volume-icon"),progressBar:i.querySelector(".vd-music-player-progress-bar"),timeElapsed:i.querySelector(".vd-music-player-time-elapsed"),timeDuration:i.querySelector(".vd-music-player-time-duration"),playlistPanel:i.querySelector(".vd-music-player-playlist")},m=()=>{let b=u.btnPlay;b&&(b.innerHTML="",b.appendChild(s(f.isPlaying?"pause":"play")),b.setAttribute("aria-label",f.isPlaying?"Pause":"Play"),b.classList.toggle("is-active",f.isPlaying))},y=()=>{let b=u.trackName;if(!b)return;let N=f.tracks[f.currentIndex];N?(b.textContent=N.name||"Unknown Track",b.classList.remove("is-idle")):(b.textContent="No tracks loaded",b.classList.add("is-idle"))},T=()=>{let b=u.volumeIcon;if(!b)return;b.innerHTML="";let N=f.volume,O=N===0?"speaker-none":N<.5?"speaker-low":"speaker-high";b.appendChild(s(O))},S=()=>{let b=u.btnShuffle;b&&(b.classList.toggle("is-active",f.shuffle),b.setAttribute("aria-pressed",f.shuffle?"true":"false"))},w=()=>{let b=u.playlistPanel;b&&(b.innerHTML="",f.tracks.forEach((N,O)=>{let F=document.createElement("button");F.className="vd-music-player-playlist-item"+(O===f.currentIndex?" is-active":""),F.type="button",F.setAttribute("data-index",String(O)),F.setAttribute("aria-current",O===f.currentIndex?"true":"false");let G=document.createElement("span");G.className="vd-music-player-playlist-num",G.textContent=String(O+1);let K=document.createElement("span");K.className="vd-music-player-playlist-name",K.textContent=N.name||"Track "+(O+1),F.appendChild(G),F.appendChild(K),b.appendChild(F)}))},P=()=>{let b=u.progressBar;if(!b||!d.duration)return;let N=d.currentTime/d.duration*100;b.value=String(N),n(b),u.timeElapsed&&(u.timeElapsed.textContent=e(d.currentTime)),u.timeDuration&&(u.timeDuration.textContent=e(d.duration))},g=(b,N)=>{let O=f.tracks[b];O&&(f.currentIndex=b,d.src=O.url,y(),w(),u.progressBar&&(u.progressBar.value="0",n(u.progressBar)),u.timeElapsed&&(u.timeElapsed.textContent="0:00"),u.timeDuration&&(u.timeDuration.textContent="0:00"),i.dispatchEvent(new CustomEvent("musicplayer:trackchange",{bubbles:!0,detail:{index:b,name:O.name,url:O.url}})),N&&d.play().catch(()=>{}))},E=[],v=()=>{f.isPlaying=!0,m(),i.dispatchEvent(new CustomEvent("musicplayer:play",{bubbles:!0}))},A=()=>{f.isPlaying=!1,m(),i.dispatchEvent(new CustomEvent("musicplayer:pause",{bubbles:!0}))},D=()=>{if(f.autoAdvance&&f.tracks.length>1){let b=(f.currentIndex+1)%f.tracks.length;g(b,!0)}else f.isPlaying=!1,m(),i.dispatchEvent(new CustomEvent("musicplayer:ended",{bubbles:!0}))},R=()=>{f.showProgress&&P()},V=()=>{u.timeDuration&&(u.timeDuration.textContent=e(d.duration)),u.progressBar&&(u.progressBar.max="100",n(u.progressBar))};if(d.addEventListener("play",v),d.addEventListener("pause",A),d.addEventListener("ended",D),d.addEventListener("timeupdate",R),d.addEventListener("loadedmetadata",V),E.push(()=>{d.removeEventListener("play",v),d.removeEventListener("pause",A),d.removeEventListener("ended",D),d.removeEventListener("timeupdate",R),d.removeEventListener("loadedmetadata",V),d.pause(),d.src=""}),u.btnPlay){let b=()=>{!d.src&&f.tracks.length&&g(f.currentIndex,!1),f.isPlaying?d.pause():d.play().catch(()=>{})};u.btnPlay.addEventListener("click",b),E.push(()=>u.btnPlay.removeEventListener("click",b));let N=O=>{(O.key===" "||O.key==="Enter")&&(O.preventDefault(),b())};u.btnPlay.addEventListener("keydown",N),E.push(()=>u.btnPlay.removeEventListener("keydown",N))}if(u.btnPrev){let b=()=>{if(f.tracks.length)if(d.currentTime>3)d.currentTime=0;else{let N=f.currentIndex===0?f.tracks.length-1:f.currentIndex-1;g(N,f.isPlaying)}};u.btnPrev.addEventListener("click",b),E.push(()=>u.btnPrev.removeEventListener("click",b))}if(u.btnNext){let b=()=>{if(!f.tracks.length)return;let N=(f.currentIndex+1)%f.tracks.length;g(N,f.isPlaying)};u.btnNext.addEventListener("click",b),E.push(()=>u.btnNext.removeEventListener("click",b))}if(u.btnShuffle){let b=()=>{if(f.shuffle=!f.shuffle,f.shuffle){let N=f.tracks[f.currentIndex];f.tracks=p(f.tracks);let O=f.tracks.findIndex(F=>F===N);O>0&&(f.tracks.splice(O,1),f.tracks.unshift(N)),f.currentIndex=0}else{let N=f.tracks[f.currentIndex];f.tracks=f.originalTracks.slice(),f.currentIndex=f.tracks.findIndex(O=>O===N),f.currentIndex<0&&(f.currentIndex=0)}S(),w()};u.btnShuffle.addEventListener("click",b),E.push(()=>u.btnShuffle.removeEventListener("click",b))}if(u.btnPlaylist){let b=()=>{let N=u.playlistPanel;if(!N)return;let O=N.classList.toggle("is-open");u.btnPlaylist.classList.toggle("is-active",O),u.btnPlaylist.setAttribute("aria-expanded",O?"true":"false")};u.btnPlaylist.addEventListener("click",b),E.push(()=>u.btnPlaylist.removeEventListener("click",b))}if(u.volumeSlider){let b=N=>{let O=parseFloat(N.target.value);f.volume=O,d.volume=O,T(),n(u.volumeSlider),i.dispatchEvent(new CustomEvent("musicplayer:volumechange",{bubbles:!0,detail:{volume:O}}))};u.volumeSlider.addEventListener("input",b),E.push(()=>u.volumeSlider.removeEventListener("input",b)),n(u.volumeSlider)}if(u.progressBar){let b=N=>{if(!d.duration)return;let O=parseFloat(N.target.value);d.currentTime=O/100*d.duration,n(u.progressBar)};u.progressBar.addEventListener("input",b),E.push(()=>u.progressBar.removeEventListener("input",b))}if(u.playlistPanel){let b=N=>{let O=N.target.closest(".vd-music-player-playlist-item");if(!O)return;let F=parseInt(O.getAttribute("data-index"),10);isNaN(F)||g(F,!0)};u.playlistPanel.addEventListener("click",b),E.push(()=>u.playlistPanel.removeEventListener("click",b))}if(u.btnDetach){let b=()=>{this.detach(i)};u.btnDetach.addEventListener("click",b),E.push(()=>u.btnDetach.removeEventListener("click",b))}if(u.btnAttach){let b=()=>{this.attach(i)};u.btnAttach.addEventListener("click",b),E.push(()=>u.btnAttach.removeEventListener("click",b))}if(u.btnMinimize){let b=()=>{this.toggleMinimize(i)};u.btnMinimize.addEventListener("click",b),E.push(()=>u.btnMinimize.removeEventListener("click",b))}m(),y(),T(),r.showPlaylist&&w(),this.instances.set(i,{state:f,audio:d,refs:u,cleanup:E,ui:{restore:null,unbindDrag:null}}),i.setAttribute("data-music-player-initialized","true")},_buildDOM:function(i,a){if(i.querySelector(".vd-music-player-controls"))return;if(i.setAttribute("role","region"),i.setAttribute("aria-label","Music Player"),a.showProgress&&i.classList.add("has-progress"),a.showPlaylist&&i.classList.add("has-playlist"),a.glass&&i.classList.add("vd-music-player-glass"),a.draggable&&i.classList.add("vd-music-player-draggable"),a.detachable||a.minimizable){let w=document.createElement("div");if(w.className="vd-music-player-toolbar",w.setAttribute("role","toolbar"),w.setAttribute("aria-label","Player window"),a.draggable){let g=document.createElement("button");g.type="button",g.className="vd-music-player-drag-handle",g.setAttribute("aria-label","Drag to move player"),g.appendChild(s("dots-six-vertical")),w.appendChild(g)}let P=document.createElement("span");if(P.className="vd-music-player-toolbar-spacer",P.setAttribute("aria-hidden","true"),w.appendChild(P),a.minimizable){let g=document.createElement("button");g.type="button",g.className="vd-music-player-btn vd-music-player-btn-minimize",g.setAttribute("aria-label","Minimize player"),g.setAttribute("aria-expanded","true"),g.appendChild(s("minus")),w.appendChild(g)}if(a.detachable){let g=document.createElement("button");g.type="button",g.className="vd-music-player-btn vd-music-player-btn-detach",g.setAttribute("aria-label","Detach player"),g.appendChild(s("arrows-out")),w.appendChild(g);let E=document.createElement("button");E.type="button",E.className="vd-music-player-btn vd-music-player-btn-attach",E.setAttribute("aria-label","Attach player"),E.appendChild(s("arrows-in")),w.appendChild(E)}i.classList.add("vd-music-player-has-chrome"),i.appendChild(w)}let r=document.createElement("div");r.className="vd-music-player-info";let c=document.createElement("span");c.className="vd-music-player-icon",c.setAttribute("aria-hidden","true"),c.appendChild(s("music-note"));let l=document.createElement("span");l.className="vd-music-player-track-name",l.setAttribute("aria-live","polite"),l.setAttribute("aria-atomic","true"),r.appendChild(c),r.appendChild(l),i.appendChild(r);let h=document.createElement("div");h.className="vd-music-player-controls",h.setAttribute("role","group"),h.setAttribute("aria-label","Playback controls");let f=document.createElement("button");f.type="button",f.className="vd-music-player-btn vd-music-player-btn-prev",f.setAttribute("aria-label","Previous track"),f.appendChild(s("skip-back"));let d=document.createElement("button");d.type="button",d.className="vd-music-player-btn vd-music-player-btn-play",d.setAttribute("aria-label","Play"),d.appendChild(s("play"));let u=document.createElement("button");if(u.type="button",u.className="vd-music-player-btn vd-music-player-btn-next",u.setAttribute("aria-label","Next track"),u.appendChild(s("skip-forward")),h.appendChild(f),h.appendChild(d),h.appendChild(u),a.showPlaylist||a.shuffle!==void 0){let w=document.createElement("button");w.type="button",w.className="vd-music-player-btn vd-music-player-btn-shuffle",w.setAttribute("aria-label","Shuffle"),w.setAttribute("aria-pressed",a.shuffle?"true":"false"),w.appendChild(s("shuffle")),h.appendChild(w)}let m=document.createElement("span");m.className="vd-music-player-spacer",m.setAttribute("aria-hidden","true"),h.appendChild(m);let y=document.createElement("div");y.className="vd-music-player-volume";let T=document.createElement("span");T.className="vd-music-player-volume-icon",T.setAttribute("aria-hidden","true");let S=document.createElement("input");if(S.type="range",S.className="vd-music-player-volume-slider",S.min="0",S.max="1",S.step="0.01",S.value=String(a.volume),S.setAttribute("aria-label","Volume"),y.appendChild(T),y.appendChild(S),h.appendChild(y),a.showPlaylist){let w=document.createElement("button");w.type="button",w.className="vd-music-player-btn vd-music-player-btn-playlist",w.setAttribute("aria-label","Show playlist"),w.setAttribute("aria-expanded","false"),w.appendChild(s("playlist")),h.appendChild(w)}if(i.appendChild(h),a.showProgress){let w=document.createElement("div");w.className="vd-music-player-progress";let P=document.createElement("span");P.className="vd-music-player-time vd-music-player-time-elapsed",P.textContent="0:00",P.setAttribute("aria-hidden","true");let g=document.createElement("input");g.type="range",g.className="vd-music-player-progress-bar",g.min="0",g.max="100",g.step="0.1",g.value="0",g.setAttribute("aria-label","Seek");let E=document.createElement("span");E.className="vd-music-player-time vd-music-player-time-duration",E.textContent="0:00",E.setAttribute("aria-hidden","true"),w.appendChild(P),w.appendChild(g),w.appendChild(E),i.appendChild(w)}if(a.showPlaylist){let w=document.createElement("div");w.className="vd-music-player-playlist",w.setAttribute("aria-label","Playlist"),i.appendChild(w)}},play:function(i){let a=this.instances.get(i);a&&(!a.audio.src&&a.state.tracks.length&&(a.audio.src=a.state.tracks[a.state.currentIndex].url),a.audio.play().catch(()=>{}))},pause:function(i){let a=this.instances.get(i);a&&a.audio.pause()},toggle:function(i){let a=this.instances.get(i);a&&(a.state.isPlaying?this.pause(i):this.play(i))},next:function(i){let a=this.instances.get(i);if(!a||!a.state.tracks.length)return;let r=(a.state.currentIndex+1)%a.state.tracks.length;this._loadTrack(a,r,a.state.isPlaying)},previous:function(i){let a=this.instances.get(i);if(!a||!a.state.tracks.length)return;let r=a.state.tracks.length,c=(a.state.currentIndex-1+r)%r;this._loadTrack(a,c,a.state.isPlaying)},setVolume:function(i,a){let r=this.instances.get(i);if(!r)return;let c=Math.max(0,Math.min(1,a));r.state.volume=c,r.audio.volume=c,r.refs.volumeSlider&&(r.refs.volumeSlider.value=String(c),n(r.refs.volumeSlider)),i.dispatchEvent(new CustomEvent("musicplayer:volumechange",{bubbles:!0,detail:{volume:c}}))},setTrack:function(i,a){let r=this.instances.get(i);r&&this._loadTrack(r,a,r.state.isPlaying)},shuffle:function(i){let a=this.instances.get(i);!a||!a.refs.btnShuffle||a.refs.btnShuffle.click()},detach:function(i,a){let r=this.instances.get(i);if(!r||!r.state.detachable||r.state.isDetached)return;let c=r.state;r.ui=r.ui||{restore:null,unbindDrag:null},c.isDetached=!0,r.ui.restore={parent:i.parentNode,next:i.nextSibling},document.body.appendChild(i),i.classList.add("vd-music-player-floating","vd-music-player-detached");let l=a!=null&&a!==void 0?a:c.floatingPosition;this._setCornerPosition(i,l==="bottom-left"||l==="bottom-right"?l:"bottom-right"),this._loadPersistedPosition(i,r),c.startMinimized&&!c._startMinimizeApplied&&(c._startMinimizeApplied=!0,this.minimize(i)),this._bindFloatingDrag(r),i.dispatchEvent(new CustomEvent("musicplayer:detach",{bubbles:!0}))},attach:function(i){let a=this.instances.get(i);if(!a||!a.state.isDetached)return;this._unbindFloatingDrag(a),a.state.isDetached=!1;let r=a.ui&&a.ui.restore;i.classList.remove("vd-music-player-floating","vd-music-player-detached","vd-music-player-floating-bottom-left","vd-music-player-floating-bottom-right","is-position-custom"),i.style.removeProperty("--music-player-floating-top"),i.style.removeProperty("--music-player-floating-left"),r&&r.parent&&r.parent.isConnected&&r.parent.insertBefore(i,r.next),a.ui&&(a.ui.restore=null,a.ui.unbindDrag=null),i.dispatchEvent(new CustomEvent("musicplayer:attach",{bubbles:!0}))},minimize:function(i){let a=this.instances.get(i);if(!a||!a.state.minimizable||a.state.isMinimized)return;let r=a.state;r.isMinimized=!0,i.classList.add("vd-music-player-minimized"),this._setMinimizeButtonState(a,!0),a.refs.playlistPanel&&a.refs.playlistPanel.classList.contains("is-open")&&a.refs.btnPlaylist&&(a.refs.playlistPanel.classList.remove("is-open"),a.refs.btnPlaylist.classList.remove("is-active"),a.refs.btnPlaylist.setAttribute("aria-expanded","false")),i.dispatchEvent(new CustomEvent("musicplayer:minimize",{bubbles:!0}))},expand:function(i){let a=this.instances.get(i);!a||!a.state.minimizable||!a.state.isMinimized||(a.state.isMinimized=!1,i.classList.remove("vd-music-player-minimized"),this._setMinimizeButtonState(a,!1),i.dispatchEvent(new CustomEvent("musicplayer:expand",{bubbles:!0})))},toggleMinimize:function(i){let a=this.instances.get(i);!a||!a.state.minimizable||(a.state.isMinimized?this.expand(i):this.minimize(i))},setPosition:function(i,a){let r=this.instances.get(i);if(!(!r||!r.state.isDetached)&&(typeof a=="string"?this._setCornerPosition(i,a==="bottom-left"||a==="bottom-right"?a:"bottom-right"):a&&typeof a.x=="number"&&typeof a.y=="number"&&this._setCustomPositionFromRect(i,a.x,a.y),r.state.persistPosition)){let c=i.getBoundingClientRect();this._savePositionPixels(r,c.left,c.top)}},_setMinimizeButtonState:function(i,a){let r=i.refs&&i.refs.btnMinimize;r&&(r.innerHTML="",r.appendChild(s(a?"plus":"minus")),r.setAttribute("aria-label",a?"Expand player":"Minimize player"),r.setAttribute("aria-expanded",a?"false":"true"))},_setCornerPosition:function(i,a){i.classList.remove("is-position-custom","vd-music-player-floating-bottom-left","vd-music-player-floating-bottom-right"),i.style.removeProperty("--music-player-floating-top"),i.style.removeProperty("--music-player-floating-left"),a==="bottom-left"?i.classList.add("vd-music-player-floating-bottom-left"):i.classList.add("vd-music-player-floating-bottom-right")},_setCustomPositionFromRect:function(i,a,r){i.classList.remove("vd-music-player-floating-bottom-left","vd-music-player-floating-bottom-right"),i.classList.add("is-position-custom"),i.style.setProperty("--music-player-floating-left",a+"px"),i.style.setProperty("--music-player-floating-top",r+"px")},_loadPersistedPosition:function(i,a){if(!a.state.persistPosition)return;let r=this._persistKeyForInstance(a,i),c=null;if(typeof window.safeStorageGet=="function")c=window.safeStorageGet(r,null);else try{c=localStorage.getItem(r)}catch{c=null}if(c)try{let l=JSON.parse(c);l&&typeof l.x=="number"&&typeof l.y=="number"&&this._setCustomPositionFromRect(i,l.x,l.y)}catch{}},_savePositionPixels:function(i,a,r){if(!i.state.persistPosition)return;let c=this._containerOf(i);if(!c)return;let l=this._persistKeyForInstance(i,c),h=JSON.stringify({x:a,y:r});if(typeof window.safeStorageSet=="function")window.safeStorageSet(l,h);else try{localStorage.setItem(l,h)}catch{}},_persistKeyForInstance:function(i,a){let r=i.state.persistKey;return r&&String(r).trim()?t(String(r).trim()):t(a.id||"")},_unbindFloatingDrag:function(i){i.ui&&typeof i.ui.unbindDrag=="function"&&(i.ui.unbindDrag(),i.ui.unbindDrag=null)},_bindFloatingDrag:function(i){this._unbindFloatingDrag(i);let a=i.refs&&i.refs.dragHandle;if(!a||!i.state||!i.state.draggable)return;let r=this,c=this._containerOf(i);if(!c)return;let l=0,h=0,f=0,d=0,u=!1,m=function(S){if(S.pointerType==="mouse"&&S.button!==0)return;S.preventDefault(),u=!0;let w=c.getBoundingClientRect();f=w.left,d=w.top,l=S.clientX,h=S.clientY,r._setCustomPositionFromRect(c,f,d);try{a.setPointerCapture(S.pointerId)}catch{}},y=function(S){if(!u)return;let w=S.clientX-l,P=S.clientY-h,g=f+w,E=d+P,v=c.getBoundingClientRect(),A=v.width,D=v.height,R=window.innerWidth,V=window.innerHeight,b=8;g=Math.max(b,Math.min(g,R-A-b)),E=Math.max(b,Math.min(E,V-D-b)),r._setCustomPositionFromRect(c,g,E)},T=function(S){if(u){if(u=!1,typeof a.hasPointerCapture=="function"&&a.hasPointerCapture(S.pointerId))try{a.releasePointerCapture(S.pointerId)}catch{}if(i.state.persistPosition){let w=c.getBoundingClientRect();r._savePositionPixels(i,w.left,w.top)}}};a.addEventListener("pointerdown",m),a.addEventListener("pointermove",y),a.addEventListener("pointerup",T),a.addEventListener("pointercancel",T),i.ui=i.ui||{restore:null,unbindDrag:null},i.ui.unbindDrag=function(){a.removeEventListener("pointerdown",m),a.removeEventListener("pointermove",y),a.removeEventListener("pointerup",T),a.removeEventListener("pointercancel",T)}},getState:function(i){let a=this.instances.get(i);if(!a)return null;let r=a.state;return{isPlaying:r.isPlaying,currentIndex:r.currentIndex,currentTrack:r.tracks[r.currentIndex]||null,volume:r.volume,shuffle:r.shuffle,tracks:r.tracks.slice(),isDetached:!!r.isDetached,isMinimized:!!r.isMinimized}},destroy:function(i){let a=this.instances.get(i);if(a){if(this._unbindFloatingDrag(a),a.state&&a.state.isDetached)try{this.attach(i)}catch{}a.cleanup.forEach(r=>r()),this.instances.delete(i),i.removeAttribute("data-music-player-initialized")}},destroyAll:function(){this.instances.forEach((i,a)=>this.destroy(a))},_loadTrack:function(i,a,r){let c=i.state.tracks[a];if(!c)return;let l=this._containerOf(i);i.state.currentIndex=a,i.audio.src=c.url,i.refs.trackName&&(i.refs.trackName.textContent=c.name||"Unknown Track",i.refs.trackName.classList.remove("is-idle")),i.refs.playlistPanel&&i.refs.playlistPanel.querySelectorAll(".vd-music-player-playlist-item").forEach((h,f)=>{let d=f===a;h.classList.toggle("is-active",d),h.setAttribute("aria-current",d?"true":"false")}),i.refs.progressBar&&(i.refs.progressBar.value="0",n(i.refs.progressBar)),i.refs.timeElapsed&&(i.refs.timeElapsed.textContent="0:00"),i.refs.timeDuration&&(i.refs.timeDuration.textContent="0:00"),l&&l.dispatchEvent(new CustomEvent("musicplayer:trackchange",{bubbles:!0,detail:{index:a,name:c.name,url:c.url}})),r&&i.audio.play().catch(()=>{})},_containerOf:function(i){for(let[a,r]of this.instances)if(r===i)return a;return null}};typeof window.Vanduo<"u"&&window.Vanduo.register("musicPlayer",o),window.VanduoMusicPlayer=o})();function he(p,e,t=0){if(!t)return{x:p,y:e};let n=Math.cos(t),s=Math.sin(t);return{x:p*n-e*s,y:p*s+e*n}}function Pe(p,e,t=0){return he(p,e,-t)}function fe(p,e,t,n=0){let s=t*1.5*p,o=t*Math.sqrt(3)*(e+p*.5);return he(s,o,n)}function pe(p,e,t,n=0){let s=Pe(p,e,n),o=2/3*s.x/t,i=(-1/3*s.x+Math.sqrt(3)/3*s.y)/t;return Ne(o,i)}function Ne(p,e){let t=-p-e,n=Math.round(p),s=Math.round(e),o=Math.round(t),i=Math.abs(n-p),a=Math.abs(s-e),r=Math.abs(o-t);return i>a&&i>r?n=-s-o:a>r&&(s=-n-o),{q:n,r:s}}function me(p,e,t,n=0){let s=[];for(let o=0;o<6;o++){let i=Math.PI/180*(60*o)+n;s.push({x:p+t*Math.cos(i),y:e+t*Math.sin(i)})}return s}function ne(p,e){return[{q:p+1,r:e},{q:p+1,r:e-1},{q:p,r:e-1},{q:p-1,r:e},{q:p-1,r:e+1},{q:p,r:e+1}]}function ve(p,e,t,n){return(Math.abs(p-t)+Math.abs(p+e-t-n)+Math.abs(e-n))/2}var Y=Object.freeze({GRASSLAND:"Grassland",PLAINS:"Plains",DESERT:"Desert",TUNDRA:"Tundra",SNOW:"Snow",MOUNTAIN:"Mountain",OCEAN:"Ocean",COAST:"Coast"}),qe=Object.freeze({[Y.GRASSLAND]:"#47602f",[Y.PLAINS]:"#6e6838",[Y.DESERT]:"#bd9a60",[Y.TUNDRA]:"#75787b",[Y.SNOW]:"#cfdce4",[Y.MOUNTAIN]:"#464543",[Y.OCEAN]:"#1d354c",[Y.COAST]:"#295170"}),He="#FF00FF",Oe=Object.freeze({[Y.GRASSLAND]:{food:2,production:0,gold:0},[Y.PLAINS]:{food:1,production:1,gold:0},[Y.DESERT]:{food:0,production:1,gold:0},[Y.TUNDRA]:{food:1,production:0,gold:0},[Y.SNOW]:{food:0,production:0,gold:0},[Y.COAST]:{food:1,production:0,gold:0},[Y.OCEAN]:{food:0,production:0,gold:0},[Y.MOUNTAIN]:{food:0,production:0,gold:0}}),ge=Object.freeze({[Y.GRASSLAND]:1,[Y.PLAINS]:1,[Y.DESERT]:1,[Y.TUNDRA]:1,[Y.SNOW]:2,[Y.COAST]:1,[Y.OCEAN]:999,[Y.MOUNTAIN]:999});function be(p){let e=ge[p];return e!==void 0&&e<999}function ye(p){return ge[p]??999}function Ee(p){return Oe[p]||{food:0,production:0,gold:0}}function we(p){return qe[p]||He}var le=.3,de=3,se=.1,Le=2,ie=class{constructor({element:e,canvas:t,size:n=30,width:s=10,height:o=10,rotation:i=0}){this.element=e,this.canvas=t,this.size=n,this.width=s,this.height=o,this.rotation=i,this.hexes=new Map,this.selectedHex=null,this.listeners={},this.transform={x:0,y:0,scale:1},this.dragging=!1,this.lastPos=null,this.hasMoved=!1,this.themeColors=this._getThemeColors(),this.customRenderCallback=null,this.canvas||(this.canvas=e.querySelector("canvas")||document.createElement("canvas"),e.contains(this.canvas)||e.appendChild(this.canvas)),this.ctx=this.canvas.getContext("2d"),this._generateGrid(),this._render(),this._setupEvents(),this._observeThemeChanges()}_getThemeColors(){let e=document.documentElement,t=getComputedStyle(e);return{bgPrimary:t.getPropertyValue("--bg-primary").trim()||"#ffffff",bgSecondary:t.getPropertyValue("--bg-secondary").trim()||"#f5f5f5",borderColor:t.getPropertyValue("--border-color").trim()||"#e0e0e0",colorPrimary:t.getPropertyValue("--color-primary").trim()||"#3b82f6",textColor:t.getPropertyValue("--text-primary").trim()||"#1f2937",textMuted:t.getPropertyValue("--text-muted").trim()||"#6b7280"}}_observeThemeChanges(){this._themeObserver=new MutationObserver(()=>{this.themeColors=this._getThemeColors(),this._render()}),this._themeObserver.observe(document.documentElement,{attributes:!0,attributeFilter:["data-theme"]})}destroy(){this._themeObserver&&(this._themeObserver.disconnect(),this._themeObserver=null)}_screenToWorld(e,t){let n=this.canvas.getBoundingClientRect(),s=e-n.left,o=t-n.top;return{x:(s-this.transform.x)/this.transform.scale,y:(o-this.transform.y)/this.transform.scale}}_clientToCanvas(e,t){let n=this.canvas.getBoundingClientRect();return{x:e-n.left,y:t-n.top}}_generateGrid(){this.hexes.clear();for(let e=0;e<this.height;e++){let t=Math.floor(e/2);for(let n=-t;n<this.width-t;n++){let s=fe(n,e,this.size,this.rotation),o={q:n,r:e,x:s.x,y:s.y,fill:this.themeColors.bgSecondary,stroke:this.themeColors.borderColor,adjacent:ne(n,e),terrain:null,data:{}};this.hexes.set(`${n},${e}`,o)}}}_resyncSelectedHex(){this.selectedHex&&(this.selectedHex=this.hexes.get(`${this.selectedHex.q},${this.selectedHex.r}`)??null)}_render(){let e=this.canvas.getBoundingClientRect(),t=e.width||800,n=e.height||400;this.canvas.width=t,this.canvas.height=n,this.ctx.fillStyle=this.themeColors.bgPrimary,this.ctx.fillRect(0,0,this.canvas.width,this.canvas.height),this.ctx.save(),this.ctx.translate(this.transform.x,this.transform.y),this.ctx.scale(this.transform.scale,this.transform.scale),this.hexes.forEach(s=>{this._drawHex(s),this.customRenderCallback&&this.customRenderCallback(this.ctx,s,this.size)}),this.selectedHex&&this._drawHex(this.selectedHex,!0),this.ctx.restore()}_drawHex(e,t=!1){let n=me(e.x,e.y,this.size,this.rotation);this.ctx.beginPath(),this.ctx.moveTo(n[0].x,n[0].y);for(let i=1;i<n.length;i++)this.ctx.lineTo(n[i].x,n[i].y);this.ctx.closePath();let s;t?s=this.themeColors.colorPrimary:e.terrain?s=we(e.terrain):e.fill?s=e.fill:s=this.themeColors.bgSecondary,this.ctx.fillStyle=s,this.ctx.fill();let o=t?this.themeColors.colorPrimary:e.stroke||this.themeColors.borderColor;this.ctx.strokeStyle=o,this.ctx.lineWidth=t?3:1,this.ctx.stroke(),t&&(this.ctx.fillStyle="#ffffff",this.ctx.font="10px monospace",this.ctx.textAlign="center",this.ctx.textBaseline="middle",this.ctx.fillText(`${e.q},${e.r}`,e.x,e.y))}_setupEvents(){this.touchState={initialDistance:0,initialScale:1,touches:[]},this.canvas.addEventListener("pointerdown",t=>{this.dragging=!0,this.hasMoved=!1,this.lastPos={x:t.clientX,y:t.clientY},this.canvas.style.cursor="grabbing"}),this.canvas.addEventListener("pointermove",t=>{if(!this.dragging)return;let n={x:t.clientX,y:t.clientY},s=n.x-this.lastPos.x,o=n.y-this.lastPos.y;(Math.abs(s)>Le||Math.abs(o)>Le)&&(this.hasMoved=!0),this.transform.x+=s,this.transform.y+=o,this.lastPos=n,this._render()});let e=()=>{this.dragging=!1,this.hasMoved||(this.canvas.style.cursor="pointer")};this.canvas.addEventListener("pointerup",e),this.canvas.addEventListener("pointerleave",e),this.canvas.addEventListener("click",t=>{if(this.hasMoved)return;let n=this._screenToWorld(t.clientX,t.clientY),s=pe(n.x,n.y,this.size,this.rotation),o=this.hexes.get(`${s.q},${s.r}`);o&&(this.selectedHex=o,this._render(),this._emit("select",o))}),this.canvas.addEventListener("wheel",t=>{t.preventDefault();let n=t.deltaY>0?1-se:1+se,s=Math.max(le,Math.min(this.transform.scale*n,de)),o=this._clientToCanvas(t.clientX,t.clientY),i=s/this.transform.scale;this.transform.x=o.x-(o.x-this.transform.x)*i,this.transform.y=o.y-(o.y-this.transform.y)*i,this.transform.scale=s,this._render(),this._emit("zoom",{scale:this.transform.scale})},{passive:!1}),this.canvas.addEventListener("touchstart",t=>{t.touches.length===2&&(t.preventDefault(),this.touchState.touches=Array.from(t.touches),this.touchState.initialDistance=this._getTouchDistance(t.touches),this.touchState.initialScale=this.transform.scale)},{passive:!1}),this.canvas.addEventListener("touchmove",t=>{if(t.touches.length===2){t.preventDefault();let s=this._getTouchDistance(t.touches)/this.touchState.initialDistance*this.touchState.initialScale,o=Math.max(le,Math.min(s,de)),i=(t.touches[0].clientX+t.touches[1].clientX)/2,a=(t.touches[0].clientY+t.touches[1].clientY)/2,r=this._clientToCanvas(i,a),c=o/this.transform.scale;this.transform.x=r.x-(r.x-this.transform.x)*c,this.transform.y=r.y-(r.y-this.transform.y)*c,this.transform.scale=o,this._render(),this._emit("zoom",{scale:this.transform.scale})}},{passive:!1}),this.canvas.addEventListener("touchend",()=>{this.touchState.touches=[]}),this.canvas.addEventListener("mouseenter",()=>{this.canvas.style.cursor="grab"}),this.canvas.addEventListener("mouseleave",()=>{this.canvas.style.cursor="default"})}_getTouchDistance(e){if(e.length<2)return 0;let t=e[0].clientX-e[1].clientX,n=e[0].clientY-e[1].clientY;return Math.sqrt(t*t+n*n)}setSize(e){this.size=e,this._generateGrid(),this._resyncSelectedHex(),this._render()}setDimensions(e,t){this.width=e,this.height=t,this._generateGrid(),this._resyncSelectedHex(),this._render()}reset(){this.size=30,this.width=15,this.height=10,this.rotation=0,this.selectedHex=null,this.transform={x:0,y:0,scale:1},this._generateGrid(),this._render()}fillRandom(){let e=["#f0f0f0","#d4e5d4","#e5d4d4","#d4d4e5","#e5e5d4","#d4e5e5","#e8e8e8","#d0d0d0"];this.hexes.forEach(t=>{t.fill=e[Math.floor(Math.random()*e.length)]}),this._render()}getHex(e,t){return this.hexes.get(`${e},${t}`)}getAllHexes(){return Array.from(this.hexes.values())}setHexFill(e,t,n){let s=this.hexes.get(`${e},${t}`);s&&(s.fill=n,this._render())}resetView(){this.transform={x:0,y:0,scale:1},this._render(),this._emit("pan",{x:0,y:0}),this._emit("zoom",{scale:1})}zoomIn(){let e=Math.min(this.transform.scale*(1+se),de);this.transform.scale=e,this._render(),this._emit("zoom",{scale:this.transform.scale})}zoomOut(){let e=Math.max(this.transform.scale*(1-se),le);this.transform.scale=e,this._render(),this._emit("zoom",{scale:this.transform.scale})}getTransform(){return{...this.transform}}on(e,t){this.listeners[e]||(this.listeners[e]=[]),this.listeners[e].push(t)}_emit(e,t){this.listeners[e]&&this.listeners[e].forEach(n=>n(t))}setHexTerrain(e,t,n){let s=this.hexes.get(`${e},${t}`);s&&(s.terrain=n,this._render())}getHexTerrain(e,t){let n=this.hexes.get(`${e},${t}`);return n?n.terrain:null}generateRandomTerrain(){let e=Object.values(Y);this.hexes.forEach(t=>{t.terrain=e[Math.floor(Math.random()*e.length)]}),this._render()}getHexYields(e,t){let n=this.getHexTerrain(e,t);return n?Ee(n):{food:0,production:0,gold:0}}getHexMovementCost(e,t){let n=this.getHexTerrain(e,t);return n?ye(n):999}isHexPassable(e,t){let n=this.getHexTerrain(e,t);return n?be(n):!1}setHexData(e,t,n){let s=this.hexes.get(`${e},${t}`);s&&(s.data={...s.data,...n})}getHexData(e,t){let n=this.hexes.get(`${e},${t}`);return n?n.data:{}}clearHexData(e,t){let n=this.hexes.get(`${e},${t}`);n&&(n.data={})}hexDistance(e,t,n,s){return ve(e,t,n,s)}getValidMoves(e,t,n){let s=[],o=ne(e,t);for(let i of o){if(!this.hexes.has(`${i.q},${i.r}`))continue;let a=this.getHexMovementCost(i.q,i.r);a<999&&n>=a&&s.push(i)}return s}getPath(e,t,n,s){let o=`${e},${t}`,i=`${n},${s}`;if(!this.hexes.has(o)||!this.hexes.has(i))return[];let a=[[e,t]],r=new Set([o]),c=new Map;for(;a.length>0;){let[l,h]=a.shift(),f=`${l},${h}`;if(f===i){let u=[],m=i;for(;m;){let[y,T]=m.split(",").map(Number);u.unshift({q:y,r:T}),m=c.get(m)}return u}let d=ne(l,h);for(let u of d){let m=`${u.q},${u.r}`;this.hexes.has(m)&&!r.has(m)&&this.isHexPassable(u.q,u.r)&&(r.add(m),c.set(m,f),a.push([u.q,u.r]))}}return[]}setRotation(e){this.rotation=e,this._generateGrid(),this._resyncSelectedHex(),this._render()}getRotation(){return this.rotation}setCustomRender(e){this.customRenderCallback=e,this._render()}clearCustomRender(){this.customRenderCallback=null,this._render()}hasHex(e,t){return this.hexes.has(`${e},${t}`)}getHexCount(){return this.hexes.size}exportTerrainData(){let e={};return this.hexes.forEach((t,n)=>{t.terrain&&(e[n]=t.terrain)}),e}importTerrainData(e){Object.entries(e).forEach(([t,n])=>{let s=this.hexes.get(t);s&&(s.terrain=n)}),this._render()}};var Se=window.Vanduo;var Re=Se;
